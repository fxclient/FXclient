...
function dB() {
	this.dl = 1092, this.n = 2038, this.rVersion = 7, this.dW = function() {
		di = 2;
		var dm = bJ.dn(this.n, 10) % 100;
		dj = "14 Feb 2025 [" + bJ.dn(this.n, 1e3) + "." + (dm < 10 ? "0" : "") + dm + "." + this.n % 10 + "]", a8 = true, a9 = function() {
			try {
...
function cY() {
	...
	this.dW = function() {
		aHv =
			...
			.split(";"), aHw = "Infected Territory;Necromancer".split(";");
		...
		if (9 === aC.k7) {
			...
			for (aA = kY; aA < aC.eX; aA++) zL[aA] = zP[aA] = aI4[hF[aA] ? 1 : 0]
...
function cZ() {
	...
	this.kG = null, this.kF = 0, this.dW = function() {
		...
		this.kG = [0, 0, 0, 0, 0, 0], this.kF = 0, aC.jq <= aIG[0] ? (this.kF = 256 - bJ.dn(256 * aC.jq, aIG[0]), this.kG[5] = bJ.dn(Math.max(aC.jq - 4, 0), 5) + aC.xG, this.kG[0] = aC.eX - aC.jq - this.kF - this.kG[5]) : (this.kG[5] = 11 + bJ
			.dn(100 * (aC.jq - 59), 163), this.kG[0] = 512 - aC.jq - this.kG[5]), aC.kB = aC.eX - aC.jq, aC.data.numberTeams = (0 < aC.jq) + (0 < aC.kB), aC.data.playerCount = aC.w0 = aC.jq + aC.kB, aC.data.teamPlayerCount = new Uint16Array([
			0, 0, 0, 0, 0, 0, 0, aC.jq + this.kF, aC.kB - this.kF
		]), aC.a3H.a3L()
