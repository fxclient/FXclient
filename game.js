...
function dB() {
	this.dl = 1092, this.n = 2042, this.rVersion = 7, this.dW = function() {
		di = 2;
		var dm = bJ.dn(this.n, 10) % 100;
		dj = "19 Feb 2025 [" + bJ.dn(this.n, 1e3) + "." + (dm < 10 ? "0" : "") + dm + "." + this.n % 10 + "]", a8 = true, a9 = function() {
			try {
		...
		if (b8.fw.gn(aC.eK) && zC(), 0 !== bP.result.zD && 0 !== bP.result.yb.length && (function() {
			...
			if (0 !== zQ.length) {
				...
				var g = zQ[0].g,
					...
					v3 = zQ[0].dm,
					zW = 1e4 * zV;
				for (aA = 0; aA < kY; aA++) pG += zL[g[aA].g8] + ": " + (g[aA].dm * sB / (200 * dm)).toFixed(2) + " | " + (zW * g[aA].dm / (10 * v3)).toFixed(2) + "   ";
...
function yR() {
	this.dW = function() {
		...
		aC.k9 || (rB = this, 2 === aC.yj ? rB.yb = bP.h4.yZ() : aC.hQ ? rB.yb = bP.h4.yd() : rB.yb = bP.h4.yf(), rB.zZ = bg.zb.zc(), rB.zM = Math.max(1, bP.h4.yg(rB.yb)), b6.fw.oY(), 8 === aC.k7 ? (bP.result.zD = 0, 1 !== aC.yr || 0 === bh.dr
			.data[107].value || 100 <= (ze = bh.dr.data[108].value) || (bP.result.zD = (1 + aC.xG) * (100 - ze) * 10)) : rB.zD = 100 * bP.result.zZ * (1 + aC.xG))
	}
}
...
function aB3() {
	...
	this.ql = function(aBj) {
		var aBk, zT;
		return aBj.id < 5 && (aBk = "@" + bD.rp.y4(aBj.rk, 5)), 0 === aBj.id ? aBk + ": " + aBj.p : 1 === aBj.id ? (zT = "@" + bD.rp.y4(aBj.target, 5), 0 === aBj.aBl ? 32768 <= aBj.value ? aBk + " voted with " + (aBj.value - 32768 + 1) +
				" gold against " + zT + " to weaken the latter's admin position." : aBk + " voted with " + (aBj.value + 1) + " gold for " + zT + " to strengthen the latter's admin position." : 1 === aBj.aBl ? aBk + " sent " + Math.floor(aBj
					.value / 100) + " Gold to " + zT + "." : aBk + " voted with " + aBj.value + " points for " + zT + " to acknowledge the latter as clan leader.") : 2 === aBj.id ? 0 === aBj.aBl ? aBk + " was muted. Duration: 1 Hour" : 1 === aBj
			.aBl ? "The username of " + aBk + " was redacted. Duration: 1 Day" : aBk + " was kicked." : 3 === aBj.id ? aBk + bn.e5(aBj.aBl, bn.dz[aBj.aBl][aBj.value]) + "@" + bD.rp.y4(aBj.target, 5) + bn.e7(aBj.aBl, bn.dz[aBj.aBl][aBj.value]) :
			4 === aBj.id ? aBk + bn.e5(5, bn.dz[5][aBj.aBl]) + "@" + bD.rp.y4(aBj.target, 5) + bn.e7(5, bn.dz[5][aBj.aBl]) : 5 === aBj.id ? aBi[aBj.aBl] : 6 === aBj.id ? "You are about to mention " + aBj.value + " player" + (1 === aBj.value ?
		...
		return {
			...
			fontSize: 1,
			qo: 0,
			aBn: aBj.id ? b9.nO : b9.mh
		}
	}, this.sx = function(player, qb, aBo) {
		return (2 === qb ? "(" + (player.elo / 10).toFixed(1) + ") " : "") + player.username + (aBo && player.aBL ? " (" + player.aBL + ")" : "")
	}, this.sy = function(sz) {
		return aBg[sz]
	}, this.aBp = function(sz, ze) {
		return sz < 3 || 7 === sz ? aBh[sz][0] : 4 === sz ? aBh[sz][ze < 1 ? 0 : ze < 10 ? 1 : 2] : aBh[sz][ze < 10 ? 0 : 1]
	}, this.aBq = function(ze) {
		return 0 === ze
...
function aB6() {
	...
	function aC1(pR, aC2, aC3) {
		var pG = pR.username;
		return (pG += "   " + bm.qj.aBu(pR.sz, pR.ze, pR.aBC)) + function(pR) {
			pR = pR.uh;
			if (pR < 1e3) return "   Gold: " + pR;
			if ((pR %= 1024) < 1e3) return "   Gold: " + pR + "k";
			return "   Gold: " + (pR - 999) + "M"
		}(pR) + ("   IP: " + bD.rp.y4(pR.aBD, 2)) + ("   " + ["🟥 Offline", "🟩 Online"][aC3 ? aBv : aC0(pR, aC2)])
	}

	function aC0(pR, aC2) {
		return aBv = aC2 || bm.ss.aBU(pR.rk) ? 1 : 0
	}
	this.aBz = function() {
		!rH || aBv === aC0(aBy) && aBw === aBy.uh || (aBw = aBy.uh, aBx.show(-1, -1, aC1(aBy, 0, 1), 1, 1))
	}, this.t1 = function(e, pR, aC2) {
		var a6z = e.target.getBoundingClientRect();
		this.show(a6z.left, a6z.top, pR, 0, aC2), e.target.addEventListener("mouseleave", function remove() {
			e.target.removeEventListener("mouseleave", remove), bm.sq && bm.sq.qq(1)
		})
	}, this.show = function(eh, ej, pR, rL, aC2) {
		aBx = aBx || new rF, aBw = (aBy = pR).uh, aBx.show(eh, ej, aC1(pR, aC2), rL), rH = 1
	}, this.qq = function(rP) {
		aBx && aBx.qq(rP) && (rH = 0, aBy = null)
	}
}

function aB4() {
	function aC8(aCB) {
		bm.x.aBF && 1 === bm.x.qc[2] && s.aCC(29).aCD(), bm.x.aBF = 0, s.aCC(29).aCE(), 0 !== bm.x.qe[bm.x.qc[0]].sd && !aCB || s.aCC(29).aCF(), bm.sq.aBz()
	}
	this.qe = new Array(4), this.qc = [0, 0, 1, 0], this.aBF = 0, this.aC5 = [0, 0], this.dW = function() {
		for (var aA = 0; aA < this.qe.length; aA++) this.qe[aA] = new aC6;
		...
		for (var aA = 0; aA < bm.x.qe.length; aA++) {
			var qd = bm.x.qe[aA];
			0 === qd.sd ? qd.aCG = 0 : (qd.aCH = Math.max(qd.aCH - qd.aCG % 2, 0), qd.aCG++)
		}
		aC8(!1)
	}, this.aCI = function(qb) {
		this.qc[0] !== qb || this.qc[2] || s.aCC(29).aCJ()
	}
}
...
function aB8() {
	...
	this.yq = function(p) {
		var aCP, g, aCV;
		if (aCK) return aCK = 0, "yes" === (aCP = p.toLowerCase()) || "y" === aCP ? void aCQ(aCL) : void bm.message.aCd({
			id: 5,
			aBl: 7
		});
		!(p.indexOf("@") < 0) && (aCP = aCT(p)) ? (aCL = p, g = function(aCS) {
			for (var ea = aCS.length, aCe = [0, 0, 0, 0], aA = 0; aA < ea; aA++)
				for (var i = aCS[aA], et = 0; et < 4; et++) i === "@room" + (et + 1) && (aCe[et] = 1);
			if ((aCN = b8.pi.a1I(aCe)) % 4 == 0) return b8.pi.a1a(bm.ss.st);
			for (et = 0; et < 4; et++) aCe[et] = aCe[et] ? bm.ss.st[et] : [];
			return b8.pi.a1a(aCe)
		}(aCP), function(aCS, aCV, p) {
			if (!aCM) return;
			for (var ea = aCV.length, aA = 0; aA < ea; aA++) 2 === aCV[aA].id && (p = p.replace(aCS[aCV[aA].e2], "@" + aCV[aA].f2));
			return aCK = 1, aCQ((aCL = p).slice(0, 126) + "|"), 1
		}(aCP, aCV = function(aCS) {
			for (var aCV = [], ea = (aCO = aCM = 0, aCS.length), aA = 0; aA < ea; aA++) {
				var i = aCS[aA],
					kY = i.length;
				b8.zN.startsWith(i, "@[") ? kY <= 9 && b8.zN.a29(i, "]") && aCV.push({
					id: 0,
					f2: i.substring(2, kY - 1).toUpperCase()
				}) : 6 === kY ? b8.zN.startsWith(i, "@room") || (aCO++, aCV.push({
					id: 1,
					f2: bE.rp.v9(i.substring(1))
				})) : 1 < kY && kY < 5 && 0 <= (kY = b5.data.aAb(i.substring(1))) && (aCV.push({
					id: 2,
					f2: kY,
					e2: aA
				}), aCM = 1)
			...
			for (var ea = aCS.length, aA = 0; aA < ea; aA++) {
				var i = aCS[aA];
			...
			loop: for (var aA = ea - 1; 0 <= aA; aA--) {
				for (var et = 0; et < kY; et++)
					if (0 === aCV[et].id) {
						if (aCV[et].f2 === b8.zN.zS(g[aA].username)) continue loop
					} else if (1 === aCV[et].id && aCV[et].f2 === g[aA].rk) continue loop;
				g[aA] = g[--ea], g.pop()
			}
		...
		var aCS = aCT(p);
		if (aCS)
			for (var a4 = new RegExp("^[0-9]+$"), ea = aCS.length, aA = 0; aA < ea; aA++) {
				var i = aCS[aA].substring(1),
					kY = i.length;
				1 <= kY && kY <= 3 && a4.test(i) && (kY = parseInt(i, 10), !isNaN(kY)) && 0 <= kY && kY < b5.data.g.length && (p = p.replace("@" + i, "@" + b5.data.g[kY]))
			}
		return p
	}
}
...
function aB7() {
	...
	function aCq() {
		aCl = bd.lx, (3 === this.t5 ? (aCm = 1, aCp) : (aCk = (aCj.length + aCk + 2 * this.t5 - 1) % aCj.length, aCo))()
	}

	function aCo() {
		0 !== aCj.length && (aCm = 0, aCi && aCi.t8(), (aCi = new t2(aCq)).r2(aCk, aCj.length), aCi.show(aCj[aCk]), bm.message.resize())
	}

	function aCp() {
		aCi && aCi.t8(), (aCi = new t9(aCo)).r2(aCj.length), aCi.show(), bm.message.resize()
	}
	this.aCd = function(aBj) {
		var eu, aBj = bm.qj.qk(aBj, bm.qj.ql(aBj));
		5 === aBj.id || 6 === aBj.id ? s.aCC(29).aCn().qn(aBj) : (eu = bd.lx < aCl + 2e4, aCk !== aCj.length - 1 && eu || (aCk = aCj.length), aCj.push(aBj), bo.play(), aCi && (aCm && eu ? aCi.r2(aCj.length) : aCo()))
	}, this.show = function() {
		aCp()
	}, this.qq = function() {
...
function aB5() {
	...
	function aCx() {
		0 !== aCs.sz && (bm.tE.qq(), s.t(8, 29, new rn(25, {
			ro: 0,
			rk: bD.rp.y4(aCs.rk, 5),
			rl: 0
		}, 29)))
	}
	...
	function aCy() {
		var eh = aCr.eh,
			ej = aCr.ej;
		bm.tE.qq(), aCr = new tA([new v("Kick User", function() {
			aD4(0, 0)
		}, aD9(0, 0)), new v("Block Chat", aD5, aDA(1)), new v("Censor Username", aD6, aDA(2)), new v("Elo Deduction", aD7, aDA(3)), new v("Gold Seizure", aD8, aDA(4))]), aD3(eh, ej), aCt = 2, aCu = 1
	}

	function aDA(id) {
		return !bm.aAy || bm.qj.t0(aCs) ? 1 : 4 === id && 9 === bm.aAy.sz && bm.aAy.ze < aCs.ze ? 0 : bm.aAy.aBC >= aCs.ze || 0 === id && aCs.ze < 200 ? 1 : 1 - bn.e0(id, bm.aAy.aBC, 0)
	}

	function aD1() {
		return !bm.aAy || bm.qj.t0(aCs) ? 1 : 0
	}

	function aD9(id, e2) {
		var ze;
		return !bm.aAy || bm.qj.t0(aCs) || (ze = bm.aAy.aBC, (ze = 4 === id && 9 === bm.aAy.sz ? Math.min(bm.aAy.ze, ze) : ze) >= aCs.ze) ? 1 : 1 - bn.e0(id, ze, e2)
	}
	...
	function aD0() {
		var eh = aCr.eh,
			ej = aCr.ej,
			aDB = (bm.tE.qq(), aD1());
		aCr = new tA([new v(bn.dz[5][0], function() {
			aD4(5, 0)
		}, aDB), new v(bn.dz[5][1], function() {
			aD4(5, 1)
		}, aDB), new v(bn.dz[5][2], function() {
			aD4(5, 2)
		}, aDB), new v(bn.dz[5][3], function() {
			aD4(5, 3)
		}, aDB)]), aD3(eh, ej), aCu = aCt = 2
	}

	function aD2() {
		29 === s.rm && s.aDC().aAz(bD.rp.y4(aCs.rk, 5))
	}
	...
	function aD5() {
		var eh = aCr.eh,
			ej = aCr.ej;
		bm.tE.qq(), aCr = new tA([new v(bn.dz[1][0], function() {
			aD4(1, 0)
		}, aD9(1, 0)), new v(bn.dz[1][1], function() {
			aD4(1, 1)
		}, aD9(1, 1)), new v(bn.dz[1][2], function() {
			aD4(1, 2)
		}, aD9(1, 2)), new v(bn.dz[1][3], function() {
			aD4(1, 3)
		}, aD9(1, 3)), new v(bn.dz[1][4], function() {
			aD4(1, 4)
		}, aD9(1, 4))]), aD3(eh, ej), aCt = 3, aCu = 1
	}

	function aD6() {
		var eh = aCr.eh,
			ej = aCr.ej;
		bm.tE.qq(), aCr = new tA([new v(bn.dz[2][0], function() {
			aD4(2, 0)
		}, aD9(2, 0)), new v(bn.dz[2][1], function() {
			aD4(2, 1)
		}, aD9(2, 1)), new v(bn.dz[2][2], function() {
			aD4(2, 2)
		}, aD9(2, 2))]), aD3(eh, ej), aCt = 3, aCu = 2
	}

	function aD7() {
		var eh = aCr.eh,
			ej = aCr.ej;
		bm.tE.qq(), aCr = new tA([new v(bn.dz[3][0], function() {
			aD4(3, 0)
		}, aD9(3, 0)), new v(bn.dz[3][1], function() {
			aD4(3, 1)
		}, aD9(3, 1)), new v(bn.dz[3][2], function() {
			aD4(3, 2)
		}, aD9(3, 2))]), aD3(eh, ej), aCu = aCt = 3
	}

	function aD8() {
		var eh = aCr.eh,
			ej = aCr.ej;
		bm.tE.qq(), aCr = new tA([new v(bn.dz[4][0], function() {
			aD4(4, 0)
		}, aD9(4, 0)), new v(bn.dz[4][1], function() {
			aD4(4, 1)
		}, aD9(4, 1)), new v(bn.dz[4][2], function() {
			aD4(4, 2)
		}, aD9(4, 2)), new v(bn.dz[4][3], function() {
			aD4(4, 3)
		}, aD9(4, 3)), new v(bn.dz[4][4], function() {
			aD4(4, 4)
		}, aD9(4, 4))]), aD3(eh, ej), aCt = 3, aCu = 4
	}

	function aD3(eh, ej, tG) {
		aCr.show(eh, ej, tG), bm.sq.show(aCr.eh, aCr.ej, aCs, 1)
	}
	this.aCw = function(e, pR) {
		aCt = 1, aCs = pR, aCr = new tA([new v(L(125), aCx, 0 === aCs.sz ? 1 : 0), new v(L(126), aCy, function() {
			if (!bm.aAy) return 1;
			if (bm.qj.t0(aCs)) return 1;
			if (!(9 === bm.aAy.sz && bm.aAy.ze < aCs.ze)) {
				if (100 <= bm.aAy.aBC) return 1;
				if (bm.aAy.aBC >= aCs.ze) return 1
			}
			return 0
		...
		if (!(code.length < 1))
			...
			if (!isNaN(code))
				if (0 === aCt) this.aCw(aCv, aCs);
					...
					if (!aCr) return !1;
					1 === aCt ? code <= 1 ? aCx() : 2 === code ? aCy() : 3 === code ? aD0() : (aD2(), this.qq()) : 2 === aCt ? 1 === aCu ? code <= 1 ? (aD4(0, 0), this.qq()) : (2 === code ? aD5 : 3 === code ? aD6 : 4 === code ? aD7 : aD8)() : (
						aD4(5, bJ.p7(code - 1, 0, 3)), this.qq()) : (aD4(aCu, bJ.p7(code - 1, 0, bn.dz[aCu].length - 1)), this.qq())
				}
		}
		return !0
	}, this.qq = function() {
		aCt = 0, aCr && aCr.qq(), aCr = null, bm.sq.qq()
	}
}

function aC6() {
	this.sd = 0, this.eG = 0, this.mapSeed = 0, this.aBW = 0, this.aDD = 0, this.aDE = 0, this.aBc = 0, this.aCH = 0, this.spawningSeed = 0, this.a03 = 0, this.aBa = 0, this.qf = [], this.qg = 1048575, this.aCG = 0
}
...
function aB9() {
	...
	function aDL(pG, pR) {
		var aDM = function(pG) {
				var rk = bE.rp.v9(pG),
					aDM = bm.ss.aBU(rk);
				if (aDM) {
					for (aDF.push(aDM); 50 < aDF.length;) aDF.shift();
					return aDM
				}
				for (var aA = aDF.length - 1; 0 <= aA; aA--)
					if (rk === aDF[aA].rk) return aDM = aDF[aA], aA < 40 && aDF.push(aDM), aDM;
				return bm.ss.aBE(rk, pG, 1, 999999, 999999, 0, 0, 0, 0)
			}(pG),
			pG = (pR && 0 === pR.id && pR.qo && (pR.fontSize = bm.qj.aBp(aDM.sz, aDM.ze), pR.aBm = bm.qj.aBq(aDM.ze)), document.createElement("span"));
		return pG.textContent = aDM.username, pG.style.display = "inline-block", pG.style.color = bm.qj.sy(aDM.sz), pG.style.cursor = "pointer", pG.style.margin = "0", pG.style.font = "inherit", pG.style.minWidth = pG.style.minHeight = "1em", bm.qj
			.t0(aDM) && (pG.style.textDecoration = "underline"), bm.qj.aBq(aDM.ze) && (pG.style.fontWeight = "bold"), pG.onclick = function(e) {
				bm.tE.aCw(e, aDM)
	...
	function aDK(p, pR) {
		var qY = document.createElement("span");
		return qY.textContent = p, qY.style.color = pR.aBn, qY.style.margin = "0", qY.style.font = "inherit", qY
	}
	this.t8 = function() {
		for (var aA = 0; aA < rz.length; aA++) rz[aA].onclick = rz[aA].onmouseover = null;
		rz[aA] = null
	}, this.transform = function(pR) {
		for (var pE = document.createElement("div"), aDG = function(pR) {
				var p = pR.p,
					aDG = [];
				for (;;) {
					var ev = function aDJ(p, position) {
						position = p.indexOf("@", position);
						if (position < 0) return -1;
						var pG = p.substring(position + 1, position + 6);
						if (5 !== pG.length) return aDJ(p, position + 1);
						if (b8.zN.startsWith(pG, "room")) return aDJ(p, position + 1);
						var aDO = new RegExp("^[a-zA-Z0-9_-]+$");
						if (!aDO.test(pG)) return aDJ(p, position + 1);
						aDO = p.substring(position + 6, position + 7);
						if (1 !== aDO.length) return position;
						pG = new RegExp("^[ :!.]+$");
						if (!pG.test(aDO)) return aDJ(p, position + 1);
						return position
					}(p, 0);
					if (-1 === ev) {
						aDG.push(aDK(p, pR));
					...
					0 === ev ? aDG.push(aDL(p.substring(1, 6), pR)) : (aDG.push(aDK(p.substring(0, ev), pR)), aDG.push(aDL(p.substring(ev + 1, ev + 6)))), p = p.substring(ev + 6)
				}
				return aDG
			}(pR), aA = 0; aA < aDG.length; aA++) pE.appendChild(aDG[aA]);
		pE.style.margin = "0.6em 0.6em", pR.qo && (pE.style.marginLeft = pE.style.marginRight = "inherit"), pE.style.font = "inherit";
		var aDI = 0 < pR.id;
		return pR.aBm && (pE.style.fontWeight = "bold"), aDI && (pE.style.paddingLeft = "0.7em"), aDI && (pE.style.fontStyle = "italic"), pE.style.fontSize = pR.fontSize.toFixed(2) + "em", pE
	}
}
...
function cL() {
	...
	function aDY(aA) {
		var button = aX.q9[aA],
			...
			i = button.i,
			j = button.j;
		tf.fillStyle = button.aDW, tf.fillRect(eh, ej, i, j), aA === aDR && (tf.fillStyle = aDT, tf.fillRect(eh, ej, i, j)), tf.lineWidth = ba.xn, tf.strokeStyle = aDS, tf.strokeRect(eh, ej, i, j),
			function(button) {
				var eh = button.eh,
					ej = button.ej,
					i = button.i,
					j = button.j;
				b8.pZ.textAlign(tf, 1), b8.pZ.textBaseline(tf, 1), tf.font = button.font, tf.fillStyle = aDS, tf.fillText(button.a5Z, Math.floor(eh + i / 2), Math.floor(ej + j / 2 + .1 * button.fontSize))
			}(button)
	}
	this.i = 0, this.j = 0, this.ej = 0, this.gap = 0, this.dW = function() {
		aDR = -1, aDS = b9.mh, aDT = "rgba(255,255,255,0.16)", this.q9 = new Array(7), this.j = Math.floor((z.a0.qx() ? .123 : .093) * h.pb), this.i = Math.floor((z.a0.qx() ? 3.96 : 4.2) * this.j), this.gap = Math.floor(.025 * this.i);
		var aDU = Math.floor(.26 * this.j),
			aDV = b8.pZ.rN(1, aDU);
		this.q9[0] = {
			eh: 0,
			ej: 0,
			...
			a5Z: "Multiplayer",
			font: aDV,
			aDW: "rgba(22,88,22,0.8)",
			fontSize: aDU
		}, aDU = Math.floor(.18 * this.j), aDV = b8.pZ.rN(1, aDU), this.q9[1] = {
			eh: 0,
			ej: 0,
		...
		var aA = -1;
		return 0 === aZ.zx() ? aA = this.a0n(eh, ej, 0, 2) : 3 === aZ.zx() ? aA = this.a0n(eh, ej, 3, 1) : 5 === aZ.zx() && (aA = this.a0n(eh, ej, 5, 2)), aDR !== aA && (aDR = aA, lQ) && (bd.de = !0), -1 !== aA && (aS.qZ(), !0)
	}, this.a0n = function(eh, ej, aDb, size) {
		for (var aA = aDb; aA < aDb + size; aA++)
...
function cM() {
	var aDd, aDe, a5j, a5t, a6k, aDf, aDg, aDh, aDi, a4M, fontSize, lr, aDj, aDl, aDk = 0;

	function aDo() {
		return ay.x.aDp[(aDj + aDk) % ay.x.aDq]
	}
	...
	function aDz(ej, a7d, sd) {
		var m7 = Math.floor((h.i - a5t) / 2) + aDg,
			mK = m7 + Math.floor(sd * (a5t - 2 * aDg));
		tf.lineWidth = a7d, tf.beginPath(), tf.moveTo(m7, ej), tf.lineTo(mK, ej), tf.lineTo(Math.floor(m7 - aDg + sd * a5t), ej + a5j), tf.lineTo(m7 - aDg, ej + a5j), tf.closePath()
	}
	this.dW = function() {
		aZ.setState(6), aDd = 0, aDe = 1, aDh = "rgba(0,220,120,0.4)", aDi = "rgba(0,0,0,0.8)", this.resize(), bd.de = !0, aDj = 0, aDl = !1, aDj++, lr = bd.lx, ay.x.aDr(aDo(), 4) && (aDl = !0, ay.aCb.aDs(aDo()))
	}, this.resize = function() {
		a5t = Math.floor((z.a0.qx() ? .5 : .25) * h.pb), a6k = a5t + 12, a5j = Math.floor(.125 * a5t), aDg = 3 * a5j, aDf = Math.floor(.225 * a5t), fontSize = Math.floor(.3 * a5j), a4M = b8.pZ.rN(0, fontSize)
	}, this.aDn = function(et) {
		aDk = et
	}, this.a00 = function(zu) {
		zu === aDo() && (aDl = !1, aDt())
	}, this.aDu = function(zu) {
		6 !== aZ.zx() || aDl || (lr = bd.lx, aDl = !0)
	}, this.go = function(eh, ej) {
		var m7 = Math.floor((h.i - a6k) / 2),
			m8 = Math.floor(.5 * (h.j - ba.gap - a5j - aDf)) + a5j + ba.gap;
		return m7 < eh && eh < m7 + a6k && m8 < ej && ej < m8 + aDf && (this.a0z(), aX.a0J(eh, ej, !1), !0)
	}, this.a0z = function() {
		ay.x.a09(3260), __fx.customLobby.setActive(false), s.x.y()
	}, this.ik = function() {
		6 === aZ.zx() && (aDl ? bd.lx > lr + 12e3 && q.a08(3250) : bd.lx > lr + 12e3 && aDt(), 100 < (aDd += .07 * aDe * (aDd < 16 ? 5 + aDd : 84 < aDd ? 105 - aDd : 17)) ? (aDd = 100, aDe = -1) : aDd < 0 && (aDd = 0, aDe = 1), aDh = "rgba(0," +
			Math.floor(190 - 1.9 * aDd) + "," + Math.floor(120 - 1.2 * aDd) + "," + (.4 + .004 * aDd) + ")", aDi = "rgba(0," + Math.floor(1.9 * aDd) + "," + Math.floor(1.2 * aDd) + "," + (.8 - .004 * aDd) + ")", bd.de = !0)
	}, this.te = function() {
		var eh = Math.floor((h.i - a6k) / 2),
			ej = Math.floor(.5 * (h.j - ba.gap - a5j - aDf));
		! function(title, ej, a7d, sd) {
			tf.fillStyle = aDi, aDz(ej, a7d, 1), tf.fill(), tf.fillStyle = aDh, aDz(ej, a7d, sd), tf.fill(), tf.strokeStyle = b9.mh, aDz(ej, a7d, 1), tf.stroke(),
				function(aE1, ej) {
					b8.pZ.textAlign(tf, 1), b8.pZ.textBaseline(tf, 1), tf.font = a4M, tf.fillStyle = b9.mh, tf.fillText(aE1, Math.floor(.5 * h.i), Math.floor(ej + .58 * a5j))
				}(title, ej)
		}(L(129), ej, 3, aDd / 100),
...
function cN() {
	...
	this.dW = function() {
		...
		aS.a0i()
	}, this.a0M = function(eh, ej, deltaY) {}, this.aE6 = function() {
		aX.a7w(), bd.de = !0
	}, this.te = function() {
		8 !== zp && 10 !== zp && (tf.imageSmoothingEnabled = !0, this.wx(), 0 !== zp && (aS.te(), aN.te(), this.aE7(), bW.te()), 0 !== zp && 6 === zp && aY.te(), bX.te(), s.te())
	}, this.wx = function() {
		var aE9, aE8;
		if (__fx.makeMainMenuTransparent) tf.clearRect(0, 0, h.i, h.j);
		else bQ.vP ? (aE8 = h.i / bQ.el, aE9 = h.j / bQ.em, tf.setTransform(aE8 = aE9 < aE8 ? aE8 : aE9, 0, 0, aE8, Math.floor((h.i - aE8 * bQ.el) / 2), Math.floor((h.j - aE8 * bQ.em) / 2)), tf.drawImage(bQ.vR, 0, 0), tf.setTransform(1, 0, 0, 1,
			0, 0), tf.fillStyle = b9.mc) : tf.fillStyle = b9.mY, tf.fillRect(0, 0, h.i, h.j)
	}, this.aE7 = function() {
		var ej = Math.floor(.3 * h.j),
			canvas = aa.aEA("territorial.io"),
...
function cm() {
	this.aBa = 0;
	var aEC, aED, aEE, aEF, aEG, aEH = this.aEB = 0;

	function aEL() {
		aEF = aEG = null, aEH = 0
	}
	this.dW = function(qd, aBX, aBY) {
		s.w(), bm.t8(), aZ.setState(10), aEF = qd, aEG = aBX, aEH = aBY, this.aBa = qd.aBa, this.aEB = aBY, aEC = 0, aED = bd.lx + 4500, ay.x.a02 > ay.x.aEI && (qd.a03 += ay.x.aEI), ay.x.a03 = qd.a03, ay.x.a02 === qd.a03 ? (console.log(
			"direct pass"), aEE = 0) : (console.log("delayed pass"), ay.x.close(ay.x.a02, 3247), aEE = 2, ay.x.aDr(qd.a03, 5) && ay.ny.aEJ()), tf.imageSmoothingEnabled = !0, aZ.wx();
		aBX = aa.aEA("loading"), aBY = (z.a0.qx() ? .396 : .25) * h.pb / aBX.width;
		...
		0 < aEE && bd.lx > aED && (aEE--, aED += 4500, 0 === bd.aEN) && 0 === bd.jn() && (0 === aEE && ay.x.a03 < ay.x.aEO && (ay.x.a03 += ay.x.aEI), ay.x.aDr(ay.x.a03, 5))
	}, this.aEP = function() {
		return 10 === aZ.zx() && (bm.aB0.aBb(aEF, aEG, aEH), aEL(), !0)
	}, this.aEQ = function() {
		10 === aZ.zx() && 2 <= ++aEC && (bm.aB0.aBb(aEF, aEG, aEH), aEL())
	}
}

function cO() {
	var aES, canvas, z8, aET;

	function aEZ(e2, name, aEa, pG) {
		z8[e2] = name, canvas[e2] = new Image, canvas[e2].onload = function() {
			! function(e2, aEa) {
				var a2e, a2f = null;
				7 === aEa ? a2e = b8.a15.a2h : 8 === aEa ? (a2e = b8.a15.a2k, a2f = .1) : 3 === aEa ? (a2e = b8.a15.a2i, a2f = .06) : 5 === aEa ? a2e = b8.a15.a2l : 6 === aEa ? a2e = b8.a15.a2g : 4 === aEa && (a2e = b8.a15.a2m);
				canvas[e2] = b8.a15.a2d(canvas[e2], a2e, a2f)
			}(e2, aEa), aEc()
		}, canvas[e2].onerror = function(e) {
			console.error("Error loading image at index", e2, "Error:", e), aEc()
	...
	function aEW() {
		0 === aES && (aES = -1, aEY(), bd.de = !0, canvas[7] = aET, canvas[8] = aET, canvas[9] = aET, canvas[10] = aET, 5 === s.rm) && s.aDC().aEe.resize()
	}
	...
	this.dW = function() {
		if (void 0 === canvas) {
			aES = 23, canvas = new Array(aES), z8 = new Array(aES), (aET = document.createElement("canvas")).width = 1;
			for (var aA = aES - (aET.height = 1); 0 <= aA; aA--) canvas[aA] = aET;
			aEY(), aEZ(0, "exit", 6,
					""
					), aEZ(1, "victory", 6,
					"iVBORw0KGgoAAAANSUhEUgAAADYAAAAKAQMAAADFMz9IAAAABlBMVEUAAAD///+l2Z/dAAAASUlEQVQI12M4lvj+++efLQzHkoH0jxaGI+yMbcIcZxiOpEHoMyD6xx+GHBB9oIIhA0Q/MGCoSAfSBQYMBskP2z9bAOlEIC1hAADJYSFMvxXXTAAAAABJRU5ErkJggg=="), aEZ(2, "defeat", 6,
					"iVBORw0KGgoAAAANSUhEUgAAADAAAAAKAQMAAADILU8PAAAABlBMVEUAAAD///+l2Z/dAAAAOklEQVQI12P48efPH5v/DEDyT81/hjMHDhxIkWA4AqV+/PgBpf5JgOWA1B0gdUyC4cefA3+A1AcwBQAlGyu1reW1ZgAAAABJRU5ErkJggg=="), aEZ(3, "orders", 6,
					...
					), aEZ(5, "arena", 6, "iVBORw0KGgoAAAANSUhEUgAAACsAAAAKAQMAAAAXYzUQAAAABlBMVEUAAAD///+l2Z/dAAAARklEQVQI12OwqbdXOHyAoabe3uD4AYaURAOLYw4gygZE1dvpAKl/FXZq/g8Y/tUYGAOpY3kGxj4JDMfS7Q3PAKlke4MzCQCHpxoxsfTs8gAAAABJRU5ErkJggg=="),
				aEZ(6, "territorial.io", 6,
					...
					), aEZ(7, "youtube", 7, "iVBORw0KGgoAAAANSUhEUgAAADAAAAAKAQMAAADILU8PAAAABlBMVEUAAAD///+l2Z/dAAAAOklEQVQI12P48efPH5v/DEDyT81/hjMHDhxIkWA4AqV+/PgBpf5JgOWA1B0gdUyC4cefA3+A1AcwBQAlGyu1reW1ZgAAAABJRU5ErkJggg=="), aEZ(8,
					"googleplay", 3,
					...
					), aEZ(10, "insta", 3, "iVBORw0KGgoAAAANSUhEUgAAADAAAAAKAQMAAADILU8PAAAABlBMVEUAAAD///+l2Z/dAAAAOklEQVQI12P48efPH5v/DEDyT81/hjMHDhxIkWA4AqV+/PgBpf5JgOWA1B0gdUyC4cefA3+A1AcwBQAlGyu1reW1ZgAAAABJRU5ErkJggg=="), aEZ(11, "emojis",
					4, "iVBORw0KGgoAAAANSUhEUgAAADAAAAAKAQMAAADILU8PAAAABlBMVEUAAAD///+l2Z/dAAAAOklEQVQI12P48efPH5v/DEDyT81/hjMHDhxIkWA4AqV+/PgBpf5JgOWA1B0gdUyC4cefA3+A1AcwBQAlGyu1reW1ZgAAAABJRU5ErkJggg=="), aEZ(12, "flags", 3,
					"iVBORw0KGgoAAAANSUhEUgAAADAAAAAKAQMAAADILU8PAAAABlBMVEUAAAD///+l2Z/dAAAAOklEQVQI12P48efPH5v/DEDyT81/hjMHDhxIkWA4AqV+/PgBpf5JgOWA1B0gdUyC4cefA3+A1AcwBQAlGyu1reW1ZgAAAABJRU5ErkJggg=="), aEZ(13, "bestTeam", 5,
					"iVBORw0KGgoAAAANSUhEUgAAADAAAAAKAQMAAADILU8PAAAABlBMVEUAAAD///+l2Z/dAAAAOklEQVQI12P48efPH5v/DEDyT81/hjMHDhxIkWA4AqV+/PgBpf5JgOWA1B0gdUyC4cefA3+A1AcwBQAlGyu1reW1ZgAAAABJRU5ErkJggg=="), aEZ(14, "bestPlayer", 5,
					...
					"iVBORw0KGgoAAAANSUhEUgAAAEEAAAAKAQMAAADRpqGpAAAABlBMVEUAAAD///+l2Z/dAAAATklEQVQI12M48E/OzoinjoGB4cA/O3tjnn8g1iEjY+aeAxCWofGZBijLCMqqNzRKmQdhGRubNINZyeYQ1p9/yXbGMv9yG0AsG2OemtwGAJcsIuxbPF7gAAAAAElFTkSuQmCC"), aEZ(18, "target",
					7,
...
function cP() {
	var aEh, aEi, aEj, aEk, aEl, aEm, aEn, aEo, aEp, aEq, aEf = [
			[100, 100, 100],
			[144, 0, 0],
			[0, 128, 0],
			[0, 0, 144],
	...
	function aEw(j7, mP) {
		for (var aA = j7; aA < mP; aA++) aEh[aA] = 4 * bJ.dn(64 * aw.random(), aw.value(100)), aEi[aA] = 4 * bJ.dn(64 * aw.random(), aw.value(100)), aEj[aA] = 4 * bJ.dn(64 * aw.random(), aw.value(100))
	}

	function aEv(j7, mP) {
		for (var colorsData = aC.data.colorsData, aA = j7; aA < mP; aA++) {
			var f2 = colorsData[aA];
			aEh[aA] = 4 * (f2 >> 12), aEi[aA] = 4 * (f2 >> 6 & 63), aEj[aA] = 4 * (63 & f2)
		}
	}

	function aF7(eE, aF9) {
		aAE[eE] = 0, aAE[eE + 1] = 0, aAE[eE + 2] = aF9, aAE[eE + 3] = 0, aFA(eE)
	}
	...
	this.ec = new Int32Array(4), this.dX = function() {
		...
		if (aEh = new Uint8Array(aC.eX), aEi = new Uint8Array(aC.eX), aEj = new Uint8Array(aC.eX), aEk = new Uint8Array(aC.eX), aEl = new Uint8Array(aC.eX), aEm = new Uint8Array(aC.eX), aEn = new Uint8Array(aC.eX), aEo = new Uint8Array(aC.eX),
			aEp = new Uint8Array(aC.eX), aEq = new Uint8Array(aC.eX), this.a6p = new Uint8Array(aC.eX), aC.hQ)
			for (var aA = aC.eX - 1; 0 <= aA; aA--) {
				var ev = be.kC[be.eY[aA]],
					kY = bJ.dn((aEg[ev][3] + 1) * aw.random(), aw.value(100));
				aEh[aA] = aEf[ev][0] + kY * aEg[ev][0], aEi[aA] = aEf[ev][1] + kY * aEg[ev][1], aEj[aA] = aEf[ev][2] + kY * aEg[ev][2]
			} else 0 === aC.data.colorsType ? aC.data.selectableColor ? (aEv(0, aC.jq), aEw(aC.jq, aC.eX)) : aEw(0, aC.eX) : aEv(0, aC.eX);
		! function() {
			var aA, ed;
			for (aA = aC.eX - 1; 0 <= aA; aA--) ed = bJ.dn(aEh[aA] + aEi[aA] + aEj[aA], 3), aEh[aA] += aF2(ed - aEh[aA], 2), aEi[aA] += aF2(ed - aEi[aA], 2), aEj[aA] += aF2(ed - aEj[aA], 2), aEh[aA] -= aEh[aA] % 4, aEi[aA] -= aEi[aA] % 4, aEj[
				aA] -= aEj[aA] % 4
		}(),
		function() {
			for (var aA = aC.eX - 1; 0 <= aA; aA--) aEh[aA] += bJ.dn(aA, 128), aEi[aA] += bJ.dn(aA % 128, 32), aEj[aA] += bJ.dn(aA % 32, 8), aEk[aA] = aA % 8
		}(), this.aEz(),
			function() {
				for (var aA = aC.eX - 1; 0 <= aA; aA--) aEl[aA] = aEh[aA] < 32 ? aEh[aA] + 32 : aEh[aA] - 32, aEm[aA] = aEi[aA] < 32 ? aEi[aA] + 32 : aEi[aA] - 32, aEn[aA] = aEj[aA] < 32 ? aEj[aA] + 32 : aEj[aA] - 32
			}(),
			function() {
				for (var aA = aC.eX - 1; 0 <= aA; aA--) aEo[aA] = 235 < aEh[aA] ? aEh[aA] - 20 : aEh[aA] + 20, aEp[aA] = 235 < aEi[aA] ? aEi[aA] - 20 : aEi[aA] + 20, aEq[aA] = 235 < aEj[aA] ? aEj[aA] - 20 : aEj[aA] + 20
			}()
	}, this.a5o = function(player) {
		var g = bM.fA;
		return g[0] = aEh[player], g[1] = aEi[player], g[2] = aEj[player], g
	}, this.aEz = function() {
		for (var aA = aC.eX - 1; 0 <= aA; aA--) this.a6p[aA] = aEh[aA] + aEi[aA] + aEj[aA] < 280 ? 0 : 1
	}, this.wy = function(eE) {
		...
		var ec = this.ec;
		return this.aF3(eE + ec[0]) || this.aF3(eE + ec[1]) || this.aF3(eE + ec[2]) || this.aF3(eE + ec[3])
	}, this.ez = function(eE) {
		var ec = this.ec;
		return this.ef(eE + ec[0]) || this.ef(eE + ec[1]) || this.ef(eE + ec[2]) || this.ef(eE + ec[3])
	}, this.wm = function(eE, player) {
		var ec = this.ec;
		return this.aF4(eE + ec[0], player) || this.aF4(eE + ec[1], player) || this.aF4(eE + ec[2], player) || this.aF4(eE + ec[3], player)
	}, this.gA = function(eE) {
		return 208 <= aAE[eE + 3]
	}, this.wt = function(player, eE) {
		return this.gA(eE) && this.aF5(player, eE)
	}, this.aF5 = function(player, eE) {
		return player === this.eS(eE)
	}, this.aF6 = function(eE) {
	...
	}, this.aF3 = function(eE) {
		return 0 === aAE[eE + 3] && 3 <= aAE[eE + 2]
	}, this.eI = function(eE) {
		return aAE[eE + 2] - 5
	}, this.aF4 = function(eE, player) {
		return this.eR(eE) || this.gA(eE) && player !== this.eS(eE)
	}, this.eS = function(eE) {
		return aAE[eE] % 4 * 128 + aAE[eE + 1] % 4 * 32 + aAE[eE + 2] % 4 * 8 + aAE[eE + 3] % 8
	}, this.wu = function(eE) {
		aF7(eE, 1)
	}, this.aF8 = function(eE) {
		aF7(eE, 2)
	}, this.wZ = function(eE, player) {
		aAE[eE] = aEh[player], aAE[eE + 1] = aEi[player], aAE[eE + 2] = aEj[player], aAE[eE + 3] = 208 + aEk[player], aFA(eE)
	}, this.g5 = function(eE, player) {
		aAE[eE] = aEl[player], aAE[eE + 1] = aEm[player], aAE[eE + 2] = aEn[player], aAE[eE + 3] = 224 + aEk[player], aFA(eE)
	}, this.j4 = function(eE, player) {
		aAE[eE] = aEo[player], aAE[eE + 1] = aEp[player], aAE[eE + 2] = aEq[player], aAE[eE + 3] = 248 + aEk[player], aFA(eE)
	}
}

function cn() {
	var e2 = 0,
		aFB = new Uint16Array(32);

	function remove(a3u) {
		var aA;
		for (e2 -= 2, aA = a3u; aA < e2; aA += 2) aFB[aA] = aFB[aA + 2], aFB[aA + 1] = aFB[aA + 3]
	}
	this.dW = function() {
		e2 = 0
	}, this.ik = function() {
		var aA, j1, iA;
		if (0 !== e2)
			if (0 === af.le[aC.eK] || ac.aFC(aC.eK) === ac.fg(aC.eK)) e2 = 0;
			else
				for (aA = e2 - 2; 0 <= aA; aA -= 2)(j1 = aFB[aA]) < aC.eX && 0 === af.le[j1] ? remove(aA) : (iA = aFB[aA + 1], (j1 >= aC.eX && aFD(aC.eK) || j1 < aC.eX && aFE(aC.eK, j1)) && (b6.gx.h8(iA, j1), remove(aA)))
	}, this.hA = function(j1, iA) {
		! function(j1, iA) {
			var aA;
			for (aA = 0; aA < e2; aA += 2)
				if (aFB[aA] === j1) return aFB[aA + 1] = Math.min(aFB[aA + 1] + iA, 1023), 1;
			return
		}(j1, iA) && 32 !== e2 && (aFB[e2] = j1, aFB[e2 + 1] = iA, e2 += 2)
	}
}
...
function cQ() {
	function aFL(player) {
		var dm;
		b8.fw.a2F(player) && (dm = af.gc[player] - af.a2J[player] + ac.aFN(player), bb.g0(player, Math.abs(dm), dm < 0 ? 18 : 12)), af.gc[player] = 0, af.a2J[player] = 0
	}
	...
	function aFI(player, aFT) {
		for (var aA = aFT.length - 1; 0 <= aA; aA--) ac.aFW(aFT[aA], player)
	}
	...
	this.df = function(g8) {
		...
		bL.x.om[g8] ? dm && (aFI(player = g8, ac.aFJ(player)), aFK(player), aE.fy(player), ac.clear(player), aFL(player), function(player) {
			af.wU[player] = 0, af.g2[player] = [], af.gG[player] = [], af.gH[player] = [], af.f0[player] = []
		}(player)) : !dm && af.g2[g8].length || this.aFH(g8)
	}, this.aFH = function(player) {
		! function(player) {
			b8.fw.jE(player) || (af.zK[player] = bg.zb.aFS(), aC.yo++);
			var aFT = ac.aFJ(player);
			0 === aFT.length ? b8.fw.a2C(player) && aFU() : (aFI(player, aFT), function(player, aFT) {
				var aFY = aFT[function(aFT) {
					var aA, e2 = 0;
					for (aA = aFT.length - 1; 1 <= aA; aA--) af.gO[aFT[aA]] > af.gO[aFT[e2]] && (e2 = aA);
					return e2
				}(aFT)];
				9 === aC.k7 && 1 === be.eY[player] && aw.ji(8) && ax.aFZ(aFY);
				if (b8.fw.a2C(player)) aFU(), aM.yy(aFY, 1);
				else {
					for (var aA = aFT.length - 1; 0 <= aA; aA--)
						if (b8.fw.a2F(aFT[aA]) && (bb.la[4 - b8.fw.jE(player)]++, b8.fw.a2C(aFT[aA]))) return aM.yy(player, 0);
					b8.fw.jE(player) || aM.a56(0, player, aFY)
				}
			}(player, aFT))
		}(player), aFK(player), aFL(player),
			function(player) {
				af.le[player] = 0, af.g2[player] = null, af.gG[player] = null, af.gH[player] = null, af.f0[player] = null
			}(player), aE.fy(player), ac.clear(player), bL.aFQ.aFR(player)
	}
}
...
function cs() {
	...
	function aFa(e) {
		(e = e.target.files) && 0 < e.length && b4.aFd(e[0])
	}

	function aFh(e) {
		var ev = new Image;
		ev.onload = aFi, ev.src = e.target.result
	}
	...
	function aFi(e) {
		...
		var e = canvas.width,
			j = canvas.height;
		e > bQ.aFk || j > bQ.aFk || e < 10 || j < 10 ? (e = "Image dimensions must be between 10 and " + bQ.aFk + ".", z.uF ? z.uF.showToast(e) : alert(e)) : 20 === s.rm && s.aDC().aFi(canvas)
	}
	this.dW = function() {
		(input = document.createElement("input")).type = "file", input.setAttribute("accept", ".png, .jpg, .gif, .jpeg"), input.onchange = aFa
	}, this.t8 = function() {
		input && (input.onchange = null, input.value = "", input = null)
	}, this.aFb = function() {
		input.click()
	}, this.aFd = function(aFe) {
		var g = aFe.name.split("."),
			g = g[g.length - 1].toLowerCase();
		"gif" !== g && "jpg" !== g && "jpeg" !== g && "png" !== g || ((g = new FileReader).onload = aFh, g.readAsDataURL(aFe))
	}
}

function cq() {
	this.aFm = null, this.dW = function() {
		10 !== aC.k7 ? this.aFm = null : this.aFm = new Uint32Array(aC.eX)
	}, this.ik = function() {
		10 === aC.k7 && this.qj()
	}, this.qj = function() {
		for (var g8, target, a9Z, aFm = this.aFm, ya = ak.js, a2K = af.gc, aA = ak.jr - 1; 0 <= aA; aA--)(g8 = ya[aA]) >= aC.jq || (target = Math.max(bJ.dn(a2K[g8], 4), 2048), a9Z = Math.max(ad.a9a(g8), 100), aFm[g8] += bJ.dn(a9Z * target, 1e4),
			aFm[g8] > target && (aFm[g8] = target))
	}, this.a2Q = function(player, hF) {
		return hF > this.aFm[player] ? (hF = this.aFm[player], this.aFm[player] = 0) : this.aFm[player] -= hF, hF
	}
}
...
function dS() {
	function aFo(e) {
		...
		e && 0 < e.length && (e = e[0], "json" === (g = e.name.split("."))[g.length - 1].toLowerCase()) && ((g = new FileReader).onload = aFw, g.readAsText(e))
	}

	function aFw(e) {
		var aG0;
		aC.ym || (e = JSON.parse(e.target.result), aG0 = aC.data = new a3G, aG1(e, aG0, "mapType", 0, 2), aG1(e, aG0, "mapProceduralIndex", 0, 255), aG1(e, aG0, "mapRealisticIndex", 0, 255), aG1(e, aG0, "mapSeed", 0, 16383), function(aFz, aG0, g9,
				max) {
				aFz = aFz[g9];
				aG0[g9] = aG7(aFz) ? aFz.slice(0, max) : aG0[g9]
			}(e, aG0, "mapName", 20), function(aFz, aG0, g9) {
				var aFj;
				2 === aG0.mapType && (!aG7(aFz = aFz[g9]) || aFz.length <= 20 ? aG0.mapType = 0 : ((aFj = new Image).onload = function() {
					b7.aG8.aG9(aFj, 1), aFj.onload = null, aFj = null
				}, aFj.src = aFz))
			}(e, aG0, "canvas"), aG1(e, aG0, "passableWater", 0, 1), aG1(e, aG0, "passableMountains", 0, 1), aG1(e, aG0, "playerCount", 1, 512), aG1(e, aG0, "humanCount", 1, 1), aG1(e, aG0, "selectedPlayer", 0, 0), aG1(e, aG0, "gameMode", 0, 1),
			aG1(e, aG0, "playerMode", 0, 0), aG1(e, aG0, "battleRoyaleMode", 0, 0), aG1(e, aG0, "numberTeams", 0, 8), aG1(e, aG0, "isZombieMode", 0, 0), aG1(e, aG0, "isContest", 0, 0), aG1(e, aG0, "isReplay", 0, 0), aG4(e, aG0, "elo", 16, 2,
				16383), aG1(e, aG0, "colorsType", 0, 1), aG1(e, aG0, "colorsPersonalized", 0, 1), aG4(e, aG0, "colorsData", 32, 512, 262143), aG1(e, aG0, "selectableColor", 0, 1), aG4(e, aG0, "teamPlayerCount", 16, 9, 512), aG1(e, aG0,
				"neutralBots", 0, 1), aG1(e, aG0, "botDifficultyType", 0, 3), aG1(e, aG0, "botDifficultyValue", 0, 15), aG4(e, aG0, "botDifficultyTeam", 8, 9, 15), aG4(e, aG0, "botDifficultyData", 8, 512, 15), aG1(e, aG0, "spawningType", 0, 2),
			aG1(e, aG0, "spawningSeed", 0, 16383), aG4(e, aG0, "spawningData", 16, 1024, 4095), aG1(e, aG0, "selectableSpawn", 0, 1), aG1(e, aG0, "playerNamesType", 0, 2),
			function(aFz, aG0, g9, size, max) {
				var a1Q = aFz[g9];
				if (Array.isArray(a1Q)) {
					for (var a1R = new Array(size), ea = Math.min(a1Q.length, size), aA = 0; aA < ea; aA++) a1R[aA] = aG7(a1Q[aA]) ? a1Q[aA].slice(0, max) : "";
					aG0[g9] = a1R
				}
			}(e, aG0, "playerNamesData", 512, 20), aG1(e, aG0, "selectableName", 0, 1), aG1(e, aG0, "aIncomeType", 0, 2), aG1(e, aG0, "aIncomeValue", 0, 255), aG4(e, aG0, "aIncomeData", 8, 512, 255), aG1(e, aG0, "tIncomeType", 0, 2), aG1(e, aG0,
				"tIncomeValue", 0, 255), aG4(e, aG0, "tIncomeData", 8, 512, 255), aG1(e, aG0, "iIncomeType", 0, 2), aG1(e, aG0, "iIncomeValue", 0, 255), aG4(e, aG0, "iIncomeData", 8, 512, 255), aG1(e, aG0, "sResourcesType", 0, 2), aG1(e, aG0,
				"sResourcesValue", 0, 2047), aG4(e, aG0, "sResourcesData", 16, 512, 2047), s.w(), s.x.aFy[0] = 0, s.t(19))
	}

	function aG1(aFz, aG0, g9, min, max) {
		aFz = aFz[g9];
		aG0[g9] = "number" == typeof aFz && min <= aFz && aFz <= max ? Math.floor(aFz) : aG0[g9]
	}
	...
	function aG4(aFz, aG0, g9, aGA, size, max) {
		var a1Q = aFz[g9];
		if (Array.isArray(a1Q)) {
			for (var a1R = new(8 === aGA ? Uint8Array : 16 === aGA ? Uint16Array : Uint32Array)(size), ea = Math.min(a1Q.length, size), aA = 0; aA < ea; aA++) a1R[aA] = bJ.p7(a1Q[aA], 0, max);
			aG0[g9] = a1R
		}
	}
	this.aFn = function() {
		var input = document.createElement("input");
		input.type = "file", input.setAttribute("accept", ".json"), input.onchange = aFo, input.click()
	}, this.aFp = function() {
		for (var aFs, aAo, a67 = aC.data, keys = Object.keys(a67), aFq = {}, aA = 0; aA < keys.length; aA++) {
			var key = keys[aA];
			a67[key] instanceof Uint8Array || a67[key] instanceof Uint16Array || a67[key] instanceof Uint32Array ? aFq[key] = Array.from(a67[key]) : aFq[key] = a67[key]
		}
		aFq.canvas = 2 === aFq.mapType && aFq.canvas ? aFq.canvas.toDataURL() : null, aFs = aFq, aFs = JSON.stringify(aFs, null, 2), aFs = new Blob([aFs], {
			type: "application/json"
		}), (aAo = document.createElement("a")).href = URL.createObjectURL(aFs), aAo.download = "tt_scenario.json", aAo.click()
	}
}

function cT() {
	var aGB, aGC, size, j1, hF, id, aGD;

	function aGE(player) {
		return player < aC.jq ? aGB * player : aGB * aC.jq + aGC * (player - aC.jq)
	}
	this.dW = function() {
		aGB = aC.jq < 16 ? 12 : 8, aGC = 4;
		var ea = aGE(aC.eX);
		size = new Uint8Array(aC.eX), j1 = new Uint16Array(ea), hF = new Uint32Array(ea), id = new Uint16Array(ea), aGD = new Uint8Array(ea)
	}, this.p6 = function(a6K, aGF) {
		var aGG = this.gd(a6K, aGF),
			aGF = (this.gb(a6K, aGF, 0), b8.fw.fz(a6K, aGG));
		bb.g0(a6K, aGG - aGF, 12)
	}, this.clear = function(player) {
		size[player] = 0
	}, this.aFW = function(player, aGF) {
		var aGJ, aGF = function(player, aGF) {
			var aA, kY = aGE(player);
			for (aA = size[player] - 1; 0 <= aA; aA--)
				if (0 === id[kY + aA] && j1[kY + aA] === aGF) return aA;
			return size[player]
		}(player, aGF);
		aGF !== size[player] && (aGJ = hF[aGE(player) + aGF], this.g1(player, aGF), this.iy(player, aGJ, aC.eX))
	}, this.jC = function(player, aGF) {
		for (var kY = aGE(player), aA = size[player] - 1; 0 <= aA; aA--)
			if (0 === id[kY + aA] && j1[kY + aA] === aGF) return !0;
		return !1
	}, this.jU = function(player) {
		return player < aC.jq ? size[player] < aGB : size[player] < aGC
	}, this.fg = function(player) {
		return size[player]
	}, this.fm = function(player, aA) {
		return j1[aGE(player) + aA]
	}, this.fh = function(player, aA) {
		return id[aGE(player) + aA]
	}, this.aGK = function(player, aGL) {
		for (var kY = aGE(player), aA = size[player] - 1; 0 <= aA; aA--)
			if (id[kY + aA] === aGL) return aA;
		return -1
	}, this.fn = function(player, aA) {
		return hF[aGE(player) + aA]
	}, this.gd = function(player, aGF) {
		for (var kY = aGE(player), aA = size[player] - 1; 0 <= aA; aA--)
			if (0 === id[kY + aA] && j1[kY + aA] === aGF) return hF[kY + aA];
		return 0
	}, this.aFN = function(player) {
		for (var kY = aGE(player), f2 = 0, aA = size[player] - 1; 0 <= aA; aA--) f2 += hF[kY + aA];
		return f2
	}, this.aGM = function(player) {
		for (var kY = aGE(player), f2 = 0, aA = size[player] - 1; 0 <= aA; aA--) 0 === id[kY + aA] && (f2 += hF[kY + aA]);
		return f2
	}, this.aFC = function(player) {
		for (var kY = aGE(player), g3 = 0, aA = size[player] - 1; 0 <= aA; aA--) 0 < id[kY + aA] && g3++;
		return g3
	}, this.gb = function(player, aGF, aGJ) {
		for (var kY = aGE(player), aA = size[player] - 1; 0 <= aA; aA--) 0 === id[kY + aA] && j1[kY + aA] === aGF && (hF[kY + aA] = aGJ)
	}, this.gM = function(player, aA, aGJ) {
		hF[aGE(player) + aA] = Math.max(aGJ, 0)
	}, this.gN = function(player, aA) {
		aGD[aGE(player) + aA] = 0
	}, this.fo = function(player, aA) {
		return aGD[aGE(player) + aA]
	}, this.iy = function(player, aGJ, aGF) {
		b8.fw.a2F(aGF) && bb.la[6 - b8.fw.jE(player)]++;
		for (var kY = aGE(player), aA = size[player] - 1; 0 <= aA; aA--)
			if (0 === id[kY + aA] && j1[kY + aA] === aGF) return hF[kY + aA] += aGJ, void(hF[kY + aA] = hF[kY + aA] > aC.a2M ? aC.a2M : hF[kY + aA]);
		j1[kY + size[player]] = aGF, hF[kY + size[player]] = aGJ, id[kY + size[player]] = 0, aGD[kY + size[player]] = 1, size[player]++, player < aC.jq && (aGF === aC.eK ? aM.yy(player, 5) : player === aC.eK && ae.a58(aGF))
	}, this.aGN = function(player, aGJ, aGL) {
		var kY = aGE(player);
		j1[kY + size[player]] = 0, hF[kY + size[player]] = aGJ, id[kY + size[player]] = aGL, aGD[kY + size[player]] = 0, size[player]++
	}, this.g1 = function(player, e2) {
		var et, kY;
		if (0 !== size[player])
			for (kY = aGE(player), size[player]--, et = e2; et < size[player]; et++) j1[kY + et] = j1[kY + et + 1], hF[kY + et] = hF[kY + et + 1], id[kY + et] = id[kY + et + 1], aGD[kY + et] = aGD[kY + et + 1]
	}, this.aFJ = function(player) {
		for (var et, kY, aFT = [], aA = ak.jr - 1; 0 <= aA; aA--)
			for (kY = aGE(ak.js[aA]), et = size[ak.js[aA]] - 1; 0 <= et; et--)
...
function cU() {
	...
	function aGQ(player) {
		var e1, jV;
		return b8.fw.jE(player) && player < aC.jq ? 0 : (e1 = aGO[bJ.dn((aC.eX - 1) * af.gO[player], aC.ja)], bd.jn() < 1920 && (e1 = Math.max(bJ.dn(100 * (13440 - 6 * bd.jn()), 1920), e1)), jV = ad.jW(player), af.gc[player] > jV && (e1 -= bJ.dn(2 *
	...
	this.dd = function() {
		for (var ea = aC.eX, aA = (aGO = new Uint16Array(ea), 0); aA < ea; aA++) aGO[aA] = 100 + aGP(bJ.dn(25600 * aA, ea - 4), 9)
	}, this.dW = function() {
		0 === aC.data.iIncomeType ? this.a9a = aGQ : 1 === aC.data.iIncomeType ? this.a9a = function(player) {
			return bJ.dn(aC.data.iIncomeValue * aGQ(player), 64)
		} : this.a9a = function(player) {
			return bJ.dn(aC.data.iIncomeData[player] * aGQ(player), 64)
		}
	}, this.ik = function() {
		if (bd.jn() % 10 == 9 && (function() {
				...
				for (var js = ak.js, gc = af.gc, aA = ak.jr - 1; 0 <= aA; aA--) {
					var g8 = js[aA],
						aGa = bJ.dn(ad.a9a(g8) * gc[g8], 1e4);
					b8.fw.fz(g8, Math.max(aGa, 1))
				}
				aGb(9)
			}(), function() {
				if (0 !== aC.data.aIncomeType) {
					if (aGZ(), 1 === aC.data.aIncomeType)
			...
			if (aGZ(), 0 === aC.data.tIncomeType) aGc(32);
			else if (1 === aC.data.tIncomeType) aGc(aC.data.tIncomeValue);
			else
		...
		b8.fw.fz(o2, bM.f8[0]), bb.oN(player, o2), ae.aGS(player, bM.f8[0] + bM.f8[1]), ae.oO(o2, bM.f8[0]), b8.fw.ow(player)
	}, this.aGT = function() {
		for (var ea = ak.jr, ya = ak.js, kY = 0, a2K = af.gc, aA = 0; aA < ea; aA++) kY += a2K[ya[aA]];
		return kY
	}, this.aGU = function(aGV) {
		for (var g8, ea = ak.jr, ya = ak.js, kY = 0, a2K = af.gc, eY = be.eY, aA = 0; aA < ea; aA++) eY[g8 = ya[aA]] === aGV && (kY += a2K[g8]);
		return kY
	}
}

function cW() {
	var aGg, aGh, aGi, aGj, aGk, aGl, aGm, aGn, aGo, aGp, aGq, aGr, aGs, aGt, aGu, aGv, aGw, aGx, aGz, aH0, aAh, aH1, aH2, aH9, aHA, aGy = null,
		aH4 = 0,
		aH5 = !1,
		aH6 = new Float32Array(4),
		aH7 = 0,
		aH8 = !0,
		a8l = 400,
		aHB = 0;
	...
	function pd() {
		aGo = Math.floor(+h.pb), aGp = Math.floor(.5 * aGo)
	}

	function aHC() {
		var aA, aHH;
		for (tf.font = b8.pZ.rN(1, 100 * aGq), aHH = 80 / Math.floor(tf.measureText(b8.zN.y4(aC.a2M)).width), tf.font = b8.pZ.rN(1, 100), aA = aC.eX - 1; 0 <= aA; aA--) aGn[aA] = 100 / Math.floor(tf.measureText(af.zL[aA]).width), aGm[aA] = Math.min(
			aHH, aGn[aA])
	}

	function aHI(aA) {
		return !aHB || (aA = af.gc[aA]) < 1e6 ? 1 : aA < 1e7 ? aH6[0] : aH6[Math.min(Math.floor(Math.log10(aA)) - 6, 3)]
	}

	function aHG(hY) {
		aGx = !1, aGw = 1, aGu = aGv = 0, aH8 && (b8.pZ.textAlign(hY, 1), b8.pZ.textBaseline(hY, 1));
		for (var aHO, aHP, aA, aHQ, fontSize, aHR, m7 = iB / iC, m8 = iD / iC, mK = (h.i + iB) / iC, mL = (h.j + iD) / iC, aHS = 0 !== af.le[aC.eK] && !b8.fw.jE(aC.eK), et = ak.jr - 1; 0 <= et; et--) aA = ak.js[et], (fontSize = Math.floor(aGt * iC *
			aHI(aA) * aGm[aA] * aGk[aA])) < aGs || aGo <= fontSize || aGi[aA] + aGk[aA] > m7 && aGi[aA] < mK && aGj[aA] + aGl[aA] > m8 && aGj[aA] < mL && (aHO = Math.floor(h.i * (aGi[aA] + aGk[aA] / 2 - m7) / (mK - m7)), aHP = Math.floor(h.j * (
			aGj[aA] + aGl[aA] / 2 - m8) / (mL - m8) - .1 * fontSize), aHQ = ab.a6p[aA], hY.font = b8.pZ.rN(1 === af.a2B[aA] ? 4 : 1, fontSize), hY.fillStyle = aHT(fontSize, aHQ % 2), aHB ? aHU(hY, aA, fontSize, aHO, aHP, aHQ) : aHV(aA,
			fontSize, aHO, aHP, hY), aGx = !0, 0 < aAh[aA] ? function(aHO, aHP, fontSize, aA, hY) {
			0 === jb[aA] ? ai.qp.xv(aH0[aA]) ? (function(aHO, aHP, fontSize, player, oC, hY) {
				for (var w3 = aHP, hX = (hY.globalAlpha = aHd(fontSize), aHI(player) * (aHB ? aH7 : aGn[player])), w2 = aHO - .5 * fontSize / hX - .9 * fontSize, eu = 0; eu < 2; eu++) hY.fillText(ai.qp.xp(oC), w2, w3), w2 = aHO + .5 *
					fontSize / hX + .9 * fontSize;
				hY.globalAlpha = 1
			}(aHO, aHP, fontSize, aA, aH0[aA], hY), aHX(aHO, aHP, fontSize, 0, 0, hY)) : ai.qp.xx(aH0[aA]) ? (aHg(aHO, aHP, fontSize, aH0[aA], 0, hY), aHX(aHO, aHP, fontSize, 0, 1, hY)) : (aHg(aHO, aHP, fontSize, aH0[aA], 1, hY), aHX(aHO,
				aHP, fontSize, 1, 0, hY)) : aHg(aHO, aHP, fontSize, aH0[aA], 0, hY)
		}(aHO, aHP, fontSize, aA, hY) : 0 === jb[aA] && aHX(aHO, aHP, fontSize, 0, 0, hY), aHS && (0 < aAh[aA + aC.eX] || 0 < aAh[aA + 2 * aC.eX] || 0 < aAh[aA + 3 * aC.eX] || 0 < aAh[aA + 4 * aC.eX]) && function(aHO, aHP, fontSize, aA, hY) {
			var ev, g3 = -1;
			for (ev = 4; 1 <= ev; ev--) 0 < aAh[aA + ev * aC.eX] && g3++;
			for (ev = 1; ev < 5; ev++) 0 < aAh[aA + ev * aC.eX] && (! function(aHO, aHP, fontSize, ev, aA, aHb, dm, hY) {
				var a1e;
				if (1 === ev) {
					aA = aH0[aA + aC.eX];
					if (!ai.qp.xw(aA)) return function(aHO, aHP, fontSize, oC, aHb, hY) {
						hY.globalAlpha = aHd(fontSize);
						aHO -= .534 * aHb * fontSize, aHb = aHP + 1.59 * fontSize;
						hY.font = b8.pZ.rN(0, .785 * fontSize), hY.fillText(ai.qp.xp(oC), aHO, aHb), hY.globalAlpha = 1
					}(aHO, aHP, fontSize, aA, aHb, hY);
					a1e = ai.vU.xO[aA - 1024 + ai.qp.xa]
				} else a1e = 2 === ev ? aK.a3s()[4].canvas[+(dm < 255)] : (3 === ev ? aK.a3s()[5] : aK.a3s()[6]).canvas[0];
				aA = ai.vU.xP, dm = .8 * fontSize / aA, ev = aHO - .5 * dm * aA - .534 * aHb * fontSize, aHO = aHP + 1.4 * dm * aA;
				hY.setTransform(dm, 0, 0, dm, ev, aHO), hY.globalAlpha = aHd(fontSize), hY.drawImage(a1e, 0, 0), hY.globalAlpha = 1, hY.setTransform(1, 0, 0, 1, 0, 0)
			}(aHO, aHP, fontSize, ev, aA, g3, aAh[aA + ev * aC.eX], hY), g3 -= 2)
		}(aHO, aHP, fontSize, aA, hY), (aHR = aGq * fontSize) < aGs || (hY.font = b8.pZ.rN(1, aHR), aHP += Math.floor(.78 * fontSize), aHB ? aHV(aA, aHR, aHO, aHP, hY) : aHU(hY, aA, aHR, aHO, aHP, aHQ)))
	}

	function aHV(aA, fontSize, eh, ej, hY) {
		var ___id = aA;
		var showName = aA < aC.jq || !__fx.settings.hideBotNames;
		if (showName) hY.fillText(af.zL[aA], eh, ej), aA < aC.jq && 2 !== af.a2B[aA] || (aA = fontSize / aGn[aA], hY.fillRect(eh - .5 * aA, ej + b8.pZ.xq * fontSize, aA, Math.max(1, .1 * fontSize)));
		aHB && __fx.settings.showPlayerDensity && (
	...
	function aHU(hY, aA, fontSize, aHO, aHP, aHQ) {
		var ___id = aA;
		aA = b8.zN.y4(af.gc[aA]);
		aHQ >> 1 & 1 ? (hY.lineWidth = .05 * fontSize, hY.strokeStyle = aHT(fontSize, aHQ % 2), hY.strokeText(aA, aHO, aHP)) : (1 < aHQ && (hY.lineWidth = .12 * fontSize, hY.strokeStyle = aHT(fontSize, aHQ), hY.strokeText(aA, aHO, aHP)), hY.fillText(
			aA, aHO, aHP));
		aHB || __fx.settings.showPlayerDensity && (__fx.settings.coloredDensity && (hY.fillStyle = __fx.utils.textStyleBasedOnDensity(___id)), hY.fillText(__fx.utils.getDensity(___id), aHO, aHP + fontSize))
	}

	function aHX(aHO, aHP, fontSize, aHb, aHc, hY) {
		var a4R = .95 * fontSize / aH2,
			aHO = aHO - .5 * a4R * aH1 + .8 * aHb * fontSize,
			aHb = aHP - 1.76 * a4R * aH2 - (.35 - b8.pZ.xq + .7) * aHc * fontSize;
		hY.setTransform(a4R, 0, 0, a4R, aHO, aHb), hY.globalAlpha = aHd(fontSize), hY.drawImage(aa.get(4), 0, 0), hY.globalAlpha = 1, hY.setTransform(1, 0, 0, 1, 0, 0)
	}

	function aHg(aHO, aHP, fontSize, oC, aHb, hY) {
		var hS, w2, a4R;
		hY.globalAlpha = aHd(fontSize), ai.qp.xw(oC) ? (hS = ai.vU.xP, hY.setTransform(a4R = 1.1 * fontSize / hS, 0, 0, a4R, w2 = aHO - .5 * a4R * hS - .8 * aHb * fontSize, a4R = aHP - 1.55 * a4R * hS), hY.drawImage(ai.vU.xO[oC - 1024 + ai.qp.xa], 0,
			0), hY.setTransform(1, 0, 0, 1, 0, 0)) : (w2 = aHO - .8 * aHb * fontSize, a4R = aHP - (.35 - b8.pZ.xq + 1) * fontSize, hY.fillText(ai.qp.xp(oC), w2, a4R)), hY.globalAlpha = 1
	}

	function aHT(fontSize, aHQ) {
		return aGp <= fontSize && fontSize < aGo ? be.aHi[aHQ] + aHd(fontSize).toFixed(3) + ")" : be.aHj[aHQ]
	}

	function aHd(fontSize) {
		return aGp <= fontSize && fontSize < aGo ? 1 - (fontSize - aGp) / (aGo - aGp) : 1
	}

	function aHs(hX, i) {
		return 1 + Math.floor(aGr * hX * i)
	}

	function aHp(aA) {
		for (var left = aGi[aA], et = aGi[aA] - af.iP[aA] - 1; 0 <= et; et--)
			if (!aHu(aA, --left, aGj[aA], aGl[aA])) {
				left++;
				break
			} var right = aGi[aA];
		for (et = af.iQ[aA] - aGi[aA] - aGk[aA]; 0 <= et; et--)
			if (!aHu(aA, ++right + aGk[aA] - 1, aGj[aA], aGl[aA])) {
				right--;
				break
			} var eh = Math.floor((left + right) / 2),
			top = aGj[aA];
		for (et = aGj[aA] - af.iR[aA] - 1; 0 <= et; et--)
			if (!aHv(aA, eh, --top, aGk[aA])) {
				top++;
				break
			} var bottom = aGj[aA];
		for (et = af.iS[aA] - aGj[aA] - aGl[aA]; 0 <= et; et--)
			if (!aHv(aA, eh, ++bottom + aGl[aA] - 1, aGk[aA])) {
				bottom--;
				break
			} var ej = Math.floor((top + bottom) / 2);
		aHm(aA, eh, ej, aGk[aA], aGl[aA]) && (aGi[aA] = eh, aGj[aA] = ej)
	}

	function aHm(player, eh, ej, i, j) {
		ed = Math.floor(.2 * i);
		for (var ed, ev = eh + i - 1; eh <= ev; ev--)
			if (!aHu(player, ev, ej, j)) return;
		for (ev = ej + j - 1 - (ed = (ed = Math.floor(.25 * j)) < 1 ? 1 : ed); ej + ed <= ev; ev--)
			if (!aHv(player, eh, ev, i)) return;
		return 1
	}

	function aHu(player, eh, ej, j) {
		return ab.wt(player, 4 * (ej * bQ.el + eh)) && ab.wt(player, 4 * ((ej + j - 1) * bQ.el + eh))
	}

	function aHv(player, eh, ej, i) {
		return ab.wt(player, 4 * (ej * bQ.el + eh)) && ab.wt(player, 4 * (ej * bQ.el + eh + i - 1))
	}
	this.dW = function() {
		if (aHB = bh.dr.data[7].value || 8 === aC.k7, a8l = 0 === (a8l = bh.dr.data[11].value) ? 280 : 1 === a8l ? 187 : 112, aGx = !1, aGt = .88, aGq = .5, aGr = 1.8, aGs = 12 - 3 * bh.dr.data[9].value, aGh = aGg = 0, aGi = new Uint16Array(aC
				.eX), aGj = new Uint16Array(aC.eX), aGk = new Uint16Array(aC.eX), aGl = new Uint16Array(aC.eX), aGm = new Float32Array(aC.eX), aGn = new Float32Array(aC.eX), aH0 = new Uint16Array(2 * aC.eX), aAh = new Uint8Array(5 * aC.eX), aH9 =
			new Uint8Array(aC.eX), aHA = new Uint8Array(aC.eX), aH8 || (aGy = aGy || document.createElement("canvas")), pd(), aGv = aGu = 0, aGw = 1, aHB) {
			var aA, aHH;
			for (aHC(), tf.font = b8.pZ.rN(1, 100), aHH = 100 / Math.floor(tf.measureText("900 000").width), aA = aC.eX - 1; 0 <= aA; aA--) aGm[aA] = Math.min(aHH, 2 * aGn[aA]);
			aH7 = aHH, aH6[0] = 100 / (aHH * Math.floor(tf.measureText("5 000 000").width)), aH6[1] = 100 / (aHH * Math.floor(tf.measureText("50 000 000").width)), aH6[2] = 100 / (aHH * Math.floor(tf.measureText("500 000 000").width)), aH6[3] =
				100 / (aHH * Math.floor(tf.measureText("1 000 000 000").width))
		} else aHC();
		! function() {
			var aA;
			for (aA = aC.eX - 1; 0 <= aA; aA--) af.gO[aA] < 12 ? (aGi[aA] = af.iP[aA] + 1, aGj[aA] = af.iR[aA] + 1, aGk[aA] = 1, aGl[aA] = 1) : (aGi[aA] = af.iP[aA], aGj[aA] = af.iR[aA] + 1, aGk[aA] = 4, aGl[aA] = 2);
			if (aC.gw)
				for (aA = 0; aA < aC.jq; aA++) aGk[aA] = 0;
			aH1 = aa.get(4).width, aH2 = aa.get(4).height
		}()
	}, this.aGS = function(g8, a5O) {
		a5O > 18 * af.gO[g8] ? (aHA[g8] = 6, ab.a6p[g8] = 2 + ab.a6p[g8] % 2) : (aH9[g8] = 4, (ab.a6p[g8] < 2 || 3 < ab.a6p[g8]) && (ab.a6p[g8] = 6 + ab.a6p[g8] % 2))
	}, this.oO = function(g8, a5O) {
		a5O > 6 * af.gO[g8] ? (aHA[g8] = 6, ab.a6p[g8] = 4 + ab.a6p[g8] % 2) : (aH9[g8] = 4, (ab.a6p[g8] < 4 || 5 < ab.a6p[g8]) && (ab.a6p[g8] = 8 + ab.a6p[g8] % 2))
	}, this.resize = function() {
		pd(), aH8 || aHG(aGz)
	}, this.a38 = function() {
		for (var aA = 0; aA < aC.jq; aA++) af.iQ[aA] - af.iP[aA] != 3 || af.iS[aA] - af.iR[aA] != 3 ? (aGi[aA] = af.iP[aA] + (af.iQ[aA] !== af.iP[aA] ? 1 : 0), aGj[aA] = af.iR[aA], aGk[aA] = 1, aGl[aA] = 1) : (aGi[aA] = af.iP[aA], aGj[aA] = af
			.iR[aA] + 1, aGk[aA] = 4, aGl[aA] = 2)
	}, this.p8 = function(player, e2, aHJ) {
		! function(player, e2, aHJ) {
			player += e2 * aC.eX;
			0 === e2 ? aH0[player] === aHJ && 0 < aAh[player] ? aAh[player] = 0 : (aH0[player] = aHJ, aAh[player] = ai.qp.xv(aHJ) ? 255 : 64) : 1 === e2 ? (aAh[player] = 64, aH0[player] = aHJ) : aAh[player] = aHJ
		}(player, e2, aHJ), 2 === aC.ym && this.lQ(!0)
	}, this.te = function() {
		aH8 ? aHG(tf) : aGx && (1 !== aGw ? (tf.imageSmoothingEnabled = !0, tf.setTransform(aGw, 0, 0, aGw, 0, 0), tf.drawImage(aGy, -aGu / aGw, -aGv / aGw), tf.setTransform(1, 0, 0, 1, 0, 0), tf.imageSmoothingEnabled = !1) : tf.drawImage(aGy, -
			aGu, -aGv))
		...
		aGw *= a1D, aGu = (aGu + kt) * a1D - kt, aGv = (aGv + ku) * a1D - ku
	}, this.lQ = function(bq) {
		return !aH8 && !(!aH5 && !bq && bd.lx < aH4 + (1 === aGw && 0 === aGu && 0 === aGv && (aC.a3b() || aC.gw || 2 === aC.ym) ? 1e3 : a8l) || (aH5 = !1, aH4 = bd.lx, aHG(aGz), 0))
	}, this.aHM = function(aA) {
		return aHI(aA) * aGm[aA]
	}, this.aHN = function(player) {
		return aGm[player]
	}, this.ik = function() {
		bd.jn() % 10 == 9 && (aH5 = aC.a3d() && !aC.a3b()), !aC.a3b() && 4 <= ++aGh && function() {
			var aA, et, eu;
			for (aGh = 0, eu = 4; 1 <= eu; eu--)
		...
		for (ea = (ea = ea < 8 ? 8 : ea) > ak.jr ? ak.jr : ea, aA = aGg + ea - 1; aGg <= aA; aA--) et = aA % ak.jr, ! function(aA) {
			var hX = aHI(aA) * aGm[aA];
			0 < aGk[aA] && aHm(aA, aGi[aA], aGj[aA], aGk[aA], aGl[aA]) ? ! function(aA) {
				for (var eh, ej, i, j, eE = !1, eu = 0; eu < 8; eu++) {
					if (i = aGk[aA] + 2, j = aGl[aA] + 2, i > af.iQ[aA] - af.iP[aA] + 1 || j > af.iS[aA] - af.iR[aA] + 1) return eE;
					if (eh = aGi[aA] - 1, ej = aGj[aA] - 1, !aHm(aA, eh, ej, i, j)) return eE;
					aGi[aA] = eh, aGj[aA] = ej, aGk[aA] = i, aGl[aA] = j, eE = !0
				}
				return eE
			}(aA) && function(aA, hX) {
				for (var eh, ej, i, j, eE = !1, aAq = aGk[aA], mJ = 1 + Math.floor(.02 * aAq), eu = 1; eu < 5; eu++) {
					if ((i = aAq + eu * mJ) > af.iQ[aA] - af.iP[aA] + 1) return eE;
					if ((j = aHs(hX, i)) > af.iS[aA] - af.iR[aA] + 1) return eE;
					eh = af.iP[aA] + Math.floor(Math.random() * (af.iQ[aA] - af.iP[aA] + 2 - i)), ej = af.iR[aA] + Math.floor(Math.random() * (af.iS[aA] - af.iR[aA] + 2 - j)), aHm(aA, eh, ej, i, j) && (aGi[aA] = eh, aGj[aA] = ej, aGk[
						aA] = i, aGl[aA] = j, eE = !0)
				}
				return eE
			}(aA, hX) && aHp(aA) : ! function(aA, hX) {
				var j, eh = aGi[aA] + 1,
					ej = aGj[aA] + 1,
					i = aGk[aA] - 2;
				for (;;) {
					...
					if (j = aHs(hX, i), aHm(aA, eh, ej, i, j)) return aGi[aA] = eh, aGj[aA] = ej, aGk[aA] = i, aGl[aA] = j, 1;
					eh++, ej++, i -= 2
				}
				return
			}(aA, hX) ? function(aA, hX) {
				var eh, ej, i, j, eu, mP, j7 = af.iQ[aA] - af.iP[aA] + 1,
					aHt = Math.floor(.02 * j7);
				for (mP = -6 * (aHt = aHt < 1 ? 1 : aHt), eu = j7; mP <= eu; eu -= aHt)
					if (j = aHs(hX, i = 0 < eu ? eu : 1), eh = af.iP[aA] + Math.floor(Math.random() * (af.iQ[aA] - af.iP[aA] + 2 - i)), ej = af.iR[aA] + Math.floor(Math.random() * (af.iS[aA] - af.iR[aA] + 2 - j)), aHm(aA, eh, ej, i, j))
						return aGi[aA] = eh, aGj[aA] = ej, aGk[aA] = i, aGl[aA] = j
			}(aA, hX) : aHp(aA)
		}(ak.js[et]);
		aGg = (aGg += ea) % ak.jr
	}, this.lL = function() {
		var aA, g8, hg, hh;
		if (bd.jn() % 4 == 1)
			for (aA = ak.jr - 1; 0 <= aA; aA--) g8 = ak.js[aA], ab.a6p[g8] < 2 || ((hg = Math.max(aH9[g8] - 1, 0)) === (hh = Math.max(aHA[g8] - 1, 0)) ? 0 === hg && (ab.a6p[g8] %= 2) : 0 === hh && ab.a6p[g8] < 6 && (ab.a6p[g8] += 4), aH9[g8] =
				hg, aHA[g8] = hh)
...
function cY() {
	...
	this.dW = function() {
		aHw =
			...
			.split(";");
		for (var a5Q = ["K ", " Y", "E ", " Z", " z", " s", "S "], aHy = ["Kingdom of ", " Kingdom", "Empire of ", " Empire", " Dynasty", " Sultanate", "Sultanate of "], aA = aHw.length - 1; 0 <= aA; aA--)
			for (var et = a5Q.length - 1; 0 <= et; et--) aHw[aA] = aHw[aA].replace(a5Q[et], aHy[et]);
		if (__fx.settings.realisticNames) aHw = realisticNames;
	}, this.a3N = function() {
		var ea = aC.jq,
			zL = af.zL,
			zP = af.zP,
		...
		if (9 === aC.k7) {
			for (var e1 = aw.random(), aI4 = aHw, aI5 = aHx, hF = aD.hF, ea = aI4.length, kY = aC.data.teamPlayerCount[7], zL = af.zL, zP = af.zP, aA = kY - 1; aA >= aC.jq; aA--) zL[aA] = zP[aA] = aI4[(aA + e1) % ea];
			for (ea = aI5.length - 1, aA = kY; aA < aC.eX; aA++) zL[aA] = zP[aA] = aI5[hF[aA] ? ea : aA % ea]
			...
			for (var aI4 = aHw, ea = aI4.length, e1 = aw.random(), zL = af.zL, zP = af.zP, aA = aC.jq; aA < aC.eX; aA++) zL[aA] = zP[aA] = aI4[(aA + e1) % ea]
		})()
	}
}

function cr() {
	this.aI6 = [], this.aI7 = [], this.dW = function() {
		this.aI6 = [], this.aI7 = []
	}, this.ik = function() {
		0 <= this.aI6.length && this.aI8(this.aI6), 0 <= this.aI7.length && this.aI8(this.aI7)
	}, this.aI8 = function(g) {
	...
	}, this.a40 = function(id, ya, aI9) {
		return this.ew(this.aI6, id, ya, aI9)
	}, this.aIA = function(id, ya, aI9) {
		return this.ew(this.aI7, id, ya, aI9)
	}, this.ew = function(g, id, ya, aI9) {
...
function cp() {
	this.aBA = function(player) {
		aF.ld(player), aC.yo++, af.a2B[player] = 2, af.zK[player] = bg.zb.aFS(), player === aC.eK && (aW.show(!1, !1), aV.a9O(), bP.yX.zH()), ae.a58(player)
	}
}
...
function cZ() {
	...
	this.kG = null, this.kF = 0, this.dW = function() {
		aIF = [], 9 === aC.k7 && this.aIG()
	}, this.aIG = function() {
		var aIH = [60, 80, 105, 150, 190, 333];
		this.kG = [0, 0, 0, 0, 0, 0], this.kF = 0, aC.jq <= aIH[0] ? (this.kF = 256 - bJ.dn(256 * aC.jq, aIH[0]), this.kG[5] = bJ.p7(bJ.dn(aC.jq - 6, 6), 0, 7), this.kG[0] = aC.eX - aC.jq - this.kF - this.kG[5]) : (this.kG[5] = 7 + bJ.dn(100 * (
		...
		if (9 === aC.k7)
			for (var aA = aIF.length - 1; 0 <= aA; aA--) --aIF[aA].g3 <= 0 && (ae.p8(aIF[aA].player, 0, ai.qp.xd + ai.qp.xr), aIF.splice(aA))
	}
}
...
function d6() {
	...
	function aIO(aA) {
		return 1 !== aA && bQ.aBd(aA) && aA !== bQ.aIX()
	}
	this.aIJ = 22, this.aFk = 4096, this.el = 0, this.em = 0, this.vR = null, this.vN = null, this.vO = null, this.vS = null, this.eG = 0, this.mapSeed = 0, this.vP = !1, this.vQ = new aIK, this.vH = new aIL, this.a5W = new aIM, this.dW =
function() {
		this.vH.dW()
	}, this.a6 = function(map, aIN) {
		((map %= this.aIJ) !== this.eG || aIO(this.eG) && aIN !== this.mapSeed) && (this.vP = !1, this.vQ.aIP(), aw.a3M(map), this.eG = map, this.mapSeed = aIN, aIO(map) && (bQ.vH.vI[map].aIQ = aIN), this.aBd(this.eG) ? (map = bQ.vH.vI[this.eG],
			this.el = map.i, this.em = map.j, aw.a3M(map.aIQ), ao.a6([this.el, this.em, map.lj, map.lg]), aIS(), an.aIT(), ao.aIU()) : aIR())
	}, this.aIV = function(map, aIN) {
		var fI = aIW(),
			map = (this.a6(map, aIN), this.vQ.aIP(), aIW());
		...
		canvas && this.vR !== canvas && (this.el = canvas.width, this.em = canvas.height, this.vR = canvas, this.vN = this.vR.getContext("2d", {
			alpha: !1
		}), this.hV = this.vN.getImageData(0, 0, this.el, this.em), this.vS = this.hV.data, this.eG = this.aIX(), this.mapSeed = 0, bQ.vH.vI[this.eG].name = aC.data.mapName)
	}, this.eF = function(aA) {
		return 3 === aA || 7 === aA || 9 === aA || 21 === aA || aA === this.aIX()
		...
		return void 0 === this.vH.vI[aA].aIa
	...
	}, this.aBe = function(pR, aIb) {
		0 === pR.mapType ? pR.mapProceduralIndex = aIb < 10 ? aIb : aIb - 10 : 1 === pR.mapType && (pR.mapRealisticIndex = aIb - 10)
	}
}
...
function aIK() {
	...
	function aIq(g8, aIp) {
		0 < aIp && (bQ.vS[g8] += aIp, bQ.vS[g8 + 1] += aIp, bQ.vS[g8 + 2] += aIp)
	}

	function h3(g8) {
		return bQ.vS[g8 + 2] > bQ.vS[g8] && bQ.vS[g8 + 2] > bQ.vS[g8 + 1]
	}
	this.a7l = -1, this.zp = 0, this.aIc = 0, this.aId = 8, this.aIe = 32, this.aIf = 8, this.aIg = 32, this.aIh = [0, 0], this.a6p = [0, 0, 0, 0], this.iK = null, this.aIi = !0, this.aIj = !1, this.aIP = function() {
		-1 !== this.a7l && clearTimeout(this.a7l), this.a7l = -1, this.iK = null, ao.aIU()
	}, this.dW = function() {
		7 === aZ.zx() || this.aIj || (this.aIi = !0, this.zp = 0, this.aIc = 1, this.aIh = [bQ.vH.vI[bQ.eG].vk[0], bQ.vH.vI[bQ.eG].vl[0]], this.a6p = [bQ.vH.vI[bQ.eG].aIa[3], bQ.vH.vI[bQ.eG].aIa[4], bQ.vH.vI[bQ.eG].aIa[5], bQ.vH.vI[bQ.eG].aIa[
			6]], this.aId = bQ.vH.vI[bQ.eG].aIa[7], this.aIe = bQ.vH.vI[bQ.eG].aIa[8], this.aIf = bQ.vH.vI[bQ.eG].aIa[9], this.aIg = bQ.vH.vI[bQ.eG].aIa[10], this.aIi ? this.a7l = setTimeout(aIk, 16) : this.ik())
	}, this.ik = function() {
		if (8 === aZ.zx() && aG.ly()) this.a7l = setTimeout(aIk, 16);
		else {
			if (0 === this.zp) {
				var aIQ = aw.aIl();
				if (aw.a3M(bQ.vH.vI[bQ.eG].aIa[2]), ao.a6([bQ.el, bQ.em, bQ.vH.vI[bQ.eG].aIa[0], bQ.vH.vI[bQ.eG].aIa[1]]), aw.a3M(aIQ), this.iK = ao.aIm(), this.zp++, this.aIi) return void(this.a7l = setTimeout(aIk, 16))
			}
			for (var g8, eM, aIQ = this.aIi ? 10 : 1e6, aIQ = bQ.em - this.aIc - 1 < aIQ ? bQ.em - this.aIc - 1 : aIQ, wh = this.aIc + aIQ, ej = this.aIc; ej < wh; ej++)
				for (var eh = 1; eh < bQ.el - 1; eh++) h3(g8 = 4 * (eM = eh + ej * bQ.el)) ? this.aIn(g8, eM, 1) : (this.aIn(g8, eM, 0), function(eh, ej, g8) {
					return 1 < eh && h3(g8 - 4) || eh < bQ.el - 2 && h3(g8 + 4) || 1 < ej && h3(g8 - 4 * bQ.el) || ej < bQ.em - 2 && h3(g8 + 4 * bQ.el)
				}(eh, ej, g8) && this.aIo(eh, ej));
			this.aIc = wh, this.aIc >= bQ.em - 1 ? (bQ.vN.putImageData(bQ.vO, 0, 0, 1, 1, bQ.el - 2, bQ.em - 2), bd.de = !0, this.aIP()) : this.aIi && (this.a7l = setTimeout(aIk, 16))
		}
	}, this.aIn = function(g8, eM, e2) {
		aIq(g8, Math.floor(this.aIh[e2] + this.a6p[e2] * this.iK[eM] / 1e4) - bQ.vS[g8])
	}, this.aIr = function(g8, e1, aIs, e2, a6p) {
		aIq(g8, Math.floor(this.aIh[e2] + (1 - e1 / aIs) * a6p) - bQ.vS[g8])
	}, this.aIo = function(kt, ku) {
		for (var g8, e1, aIs, a7b = kt - this.aIe, aIt = ku - this.aIe, wi = kt + this.aIe, wh = ku + this.aIe, a7b = a7b < 1 ? 1 : a7b, wi = wi > bQ.el - 2 ? bQ.el - 2 : wi, wh = wh > bQ.em - 2 ? bQ.em - 2 : wh, ej = aIt < 1 ? 1 : aIt; ej <=
			wh; ej++)
			for (var eh = a7b; eh <= wi; eh++) h3(g8 = 4 * (eh + ej * bQ.el)) ? (aIs = this.aId + (this.aIe - this.aId) * this.iK[eh + bQ.el * ej] / 1e4, Math.abs(kt - eh) > aIs || Math.abs(ku - ej) > aIs || aIs <= (e1 = Math.sqrt((kt - eh) * (
				kt - eh) + (ku - ej) * (ku - ej))) || this.aIr(g8, e1, aIs, 1, this.a6p[3])) : (aIs = this.aIf + (this.aIg - this.aIf) * this.iK[eh + bQ.el * ej] / 1e4, Math.abs(kt - eh) > aIs || Math.abs(ku - ej) > aIs || aIs <= (e1 = Math
				.sqrt((kt - eh) * (kt - eh) + (ku - ej) * (ku - ej))) || this.aIr(g8, e1, aIs, 0, this.a6p[2]))
	}
}

function aIS() {
	2 === bQ.eG ? aIu([256], [256], [0, 205, 256], [500, 500, 0], [0, 0, 0]) : 7 === bQ.eG ? aIu([512], [512], [0, 380, 512], [500, 500, 0], [0, 0, 0]) : 8 === bQ.eG ? aIu([410], [410], [0, 120, 210], [0, 80, 640], [0, 0, 0]) : 9 === bQ.eG ? aIu([
		512], [512], [0, 70, 180, 200, 290, 420, 512], [500, 500, 0, 0, 500, 500, 0], [0, 0, 0, 0, 0, 0, 0]) : 20 === bQ.eG && aIu([512], [512], [0, 380, 512], [500, 500, 0], [0, 0, 0])
}

function aIu(aIv, aIw, aIx, aIy, aIz) {
	for (var eh, ej, aJ1, aJ2, a1D, aJ3, hv = aIv.length - 1, aJ0 = bQ.el + bQ.em, ea = (aJ0 *= aJ0, aIx.length), aA = ea - 1; 0 <= aA; aA--) aIx[aA] *= aIx[aA];
	var aJ4 = new Array(ea),
		aAe = new Array(ea),
		aJ5 = new Array(ea),
		f2 = ao.aIm();
	if (void 0 === aIz)
		for (aIz = new Array(ea), aA = ea - 1; 0 <= aA; aA--) aIz[aA] = 0;
	for (aA = 1; aA < ea; aA++) aJ4[aA] = aIx[aA] - aIx[aA - 1], aAe[aA] = aIy[aA] - aIy[aA - 1], aJ5[aA] = aIz[aA] - aIz[aA - 1];
	for (eh = bQ.el - 1; 0 <= eh; eh--)
		for (ej = bQ.em - 1; 0 <= ej; ej--) {
			for (aJ1 = aJ0, aA = hv; 0 <= aA; aA--) aJ1 = (aJ2 = (eh - aIv[aA]) * (eh - aIv[aA]) + (ej - aIw[aA]) * (ej - aIw[aA])) < aJ1 ? aJ2 : aJ1;
			for (a1D = aIy[ea - 1], aJ3 = aIz[ea - 1], aA = 1; aA < ea; aA++)
				if (aJ1 < aIx[aA]) {
					a1D = aIy[aA - 1] + aF2((aJ1 - aIx[aA - 1]) * aAe[aA], aJ4[aA]), aJ3 = aIz[aA - 1] + aF2((aJ1 - aIx[aA - 1]) * aJ5[aA], aJ4[aA]);
					break
				} aJ6(bQ.el * ej + eh, a1D, aJ3, f2)
		}
}

function aJ6(e2, a1D, aJ3, f2) {
	a1D < 500 ? f2[e2] = bJ.dn(f2[e2] * a1D * 2, 1e3) : 500 < a1D && (f2[e2] += bJ.dn(2 * (1e4 - f2[e2]) * (a1D - 500), 1e3)), f2[e2] += bJ.dn(aJ3 * (10 * a1D - f2[e2]), 1e3)
}

function cb() {
	var aJ7;

	function aJH(a1e, hX, eh, ej, globalAlpha) {
	...
	this.a5T = 0, this.a5U = 0, this.a5V = 0, this.a5W = 0, this.dW = function() {
		...
		var aJG, aA, et, fI, hV = function() {
			...
			aJD = new Array(1 + ea),
			aJE = new Array(1 + ea);
		for (et = ea; 0 <= et; et--) aJB[et] = i[et + 1] - i[et], aJC[et] = e1[et + 1] - e1[et], aJD[et] = sB[et + 1] - sB[et], aJE[et] = eu[et + 1] - eu[et];
		for (aA = bQ.el * bQ.em - 1; 0 <= aA; aA--)
			for (et = ea; 0 <= et; et--)
				if (f2[aA] >= i[et]) {
					fI = f2[aA] - i[et], bQ.vS[4 * aA] = e1[et] + aF2(aJC[et] * fI, aJB[et]), bQ.vS[4 * aA + 1] = sB[et] + aF2(aJD[et] * fI, aJB[et]), bQ.vS[4 * aA + 2] = eu[et] + aF2(aJE[et] * fI, aJB[et]), bQ.vS[4 * aA + 3] = 255;
					break
				} bQ.vN.putImageData(hV, 0, 0), bQ.aIZ(bQ.eG) && aa.sE() && bQ.aIZ(bQ.eG) && (hV = aa.aEA("arena"), aJG = aa.aEA("territorial.io"), aJH(hV, 5, .5, .5, .1), aJH(aJG, 2, .5, .45, .1)), bQ.vP = !0, bd.de = !0
	}, this.a3P = function() {
		for (var g8, eh, ej, aJI, hM, fK, a5U = 0, i = bQ.el, j = bQ.em, fI = i * j * 4, aJJ = aAE, aJK = bQ.vS, aA = i - 1; 0 <= aA; aA--) aJJ[(g8 = aA << 2) + 2] = aJJ[fI - g8 - 2] = 3;
		for (fI = 4 * i, aA = j - 1; 0 <= aA; aA--) aJJ[(g8 = aA * fI) + 2] = aJJ[g8 + fI - 2] = 3;
		for (aJI = i - 1, hM = j - 1, ej = 1; ej < hM; ej++)
			for (fI = ej * i, eh = 1; eh < aJI; eh++) fK = 1 - (aJK[(g8 = fI + eh << 2) + 2] > aJK[g8 + 1] && aJK[g8 + 2] > aJK[g8]), aJJ[g8 + 2] = 2 - fK, a5U += fK;
		this.a5T = (i - 2) * (j - 2), this.a5W = 0, bQ.eF(bQ.eG) && (bQ.a5W.aJL(), bQ.a5W.aJM()), this.a5U = aC.ja = a5U - this.a5W, this.a5V = this.a5T - this.a5U - this.a5W
	}
}
...
function aIL() {
	this.vI = null, this.aJN = null, this.aJO = null, this.dW = function() {
		var aJP = [120, 105, 92],
			cos = [12, 12, 60],
			aJQ = [300, 300, 9827, 26, 18, 36, 36, 8, 32, 3, 9],
			aJR = [140, 130, 120],
			aJS = [12, 12, 76],
			aJT = [240, 120, 1024, 30, 19, 30, 70, 8, 20, 3, 9],
			aJU = [130, 117, 106],
			aJV = [12, 12, 68],
			aJW = [270, 210, 1024, 28, 19, 33, 50, 8, 26, 3, 9];
		this.vI = new Array(bQ.aIJ + 1), __fx.customLobby.setMapInfo(this.vI), this.vI[0] = {
			name: L(130),
			i: 230,
			j: 230,
			lj: 1e3,
			...
			name: ""
		}, this.aJN = new Uint8Array(12);
		for (var aA = 0; aA < 10; aA++) this.aJN[aA] = aA;
		for (this.aJN[10] = 20, this.aJN[11] = 21, this.aJO = new Uint8Array(10), aA = 0; aA < 10; aA++) this.aJO[aA] = 10 + aA
	}
}

function aIM() {
	this.aJL = function() {
		for (var g8, eh, fI, aJJ = aAE, aJK = bQ.vS, i = bQ.el, aJI = i - 1, hM = bQ.em - 1, g3 = 0, ej = 1; ej < hM; ej++)
			for (fI = ej * i, eh = 1; eh < aJI; eh++) aJK[g8 = fI + eh << 2] === aJK[1 + g8] && aJK[g8] === aJK[2 + g8] && (g3++, aJJ[2 + g8] = 4);
		an.a5W = g3
	}, this.aJM = function() {
		for (var aJJ = aAE, i = bQ.el, aJI = i - 1, hM = bQ.em - 1, id = 5, ej = 1; ej < hM; ej++)
			for (var fI = ej * i, eh = 1; eh < aJI; eh++) {
				var eE = 2 + (fI + eh << 2);
				4 === aJJ[eE] && (! function(eE, id) {
					var ea = 1,
						aJJ = aAE,
						ec = ab.ec,
						a1Q = [eE];
					...
					for (; ea;) {
						for (var a1R = [], aA = 0; aA < ea; aA++)
							for (var eP = a1Q[aA], ed = 3; 0 <= ed; ed--) {
								var ee = eP + ec[ed];
								4 === aJJ[ee] && (aJJ[ee] = id, a1R.push(ee))
							}
						ea = (a1Q = a1R).length
					}
...
function cc() {
	var f2, i, j, max, aJY, lg, aJa, aJb, aJc, aJd, aJe, aJf, aJg, aJh, aJZ = 1e4;

	function aJo(aJn, lj, ea) {
		var aA;
		for (aJa[0] = aJn, aA = 1; aA < ea; aA++) aJa[aA] = aJa[aA - 1] + lj, lj = aJa[aA] >= aJZ ? (aJa[aA] = aJZ - 1, -lj) : aJa[aA] < 0 ? (aJa[aA] = 0, -lj) : (lj += 16384 <= aw.random() ? lg : -lg) < -aJY ? -aJY : aJY < lj ? aJY : lj
	}

	function aJq(eh, ej, aJr, ea) {
		(aJr ? function(eh, ej, ea) {
			var aA;
			for (aA = 0; aA < ea; aA++) f2[ej * i + eh + aA] = aJa[aA]
		} : function(eh, ej, ea) {
			var aA;
			for (aA = 0; aA < ea; aA++) f2[ej * i + eh + aA * i] = aJa[aA]
		})(eh, ej, ea)
	}

	function aJu(value, ea) {
		var aA, aHt, eE, hk = value - aJa[ea - 1];
		if (0 != hk) {
			for (aHt = 1 + bJ.dn(Math.abs(hk), ea - 1), aHt = hk < 0 ? -aHt : aHt, aJa[ea - 1] = value, eE = (eE = ea - 1 - bJ.dn(Math.abs(hk), Math.abs(aHt))) < 1 ? 1 : ea - 2 < eE ? ea - 2 : eE, aA = ea - 2; eE <= aA; aA--) aJa[aA] += hk - (ea -
				1 - aA) * aHt;
			(hk < 0 ? function(ea) {
				var aA;
				for (aA = ea - 2; 1 <= aA; aA--) aJa[aA] < 0 && (aJa[aA] = -aJa[aA] - 1)
			} : function(ea) {
				var aA;
				for (aA = ea - 2; 1 <= aA; aA--) aJa[aA] >= aJZ && (aJa[aA] = 2 * aJZ - aJa[aA] - 1)
			})(ea)
		}
	}

	function aJx(a1Q, a1R, ea) {
	...
	function aJz(a3u, gap, hN) {
		aJb.push(a3u), aJc.push(gap), aJd.push(hN)
	}
	this.a6 = function(a2f) {
		! function(a2f) {
			var aA;
			for (i = a2f[0], j = a2f[1], aJY = a2f[2], lg = a2f[3], f2 = new Int16Array(i * j), max = j < i ? i : j, aJa = new Int16Array(max), aJb = [], aJc = [], aJd = [], aJe = new Array(i), aJf = new Array(j), aA = i - 1; 0 <= aA; aA--) aJe[
				aA] = !1;
			for (aA = j - 1; 0 <= aA; aA--) aJf[aA] = !1;
			aJg = new Int16Array(i), aJh = new Int16Array(j)
		}(a2f),
		function(ea) {
			var aJn = aw.random() % aJZ,
				lj = aw.random() % (2 * aJY + 1) - aJY;
			aJo(aJn, lj, ea)
		}(max), aJx(aJh, aJa, j), aJq(0, 0, !0, i);
		var eh, ej, a2f = f2[0],
			ea = max,
			lj = aw.random() % (2 * aJY + 1) - aJY;
		for (aJo(a2f, lj, ea), aJx(aJg, aJa, i), aJq(0, 0, !1, j), aJy(aJg), aJy(aJh), aJo(f2[i - 1], aJg[i - 1], j), aJq(i - 1, 0, !1, j), aJo(f2[i * (j - 1)], aJh[j - 1], i), aJu(f2[i * j - 1], i), aJq(0, j - 1, !0, i), aJe[i - 1] = aJe[0] = !
			0, aJf[j - 1] = aJf[0] = !0, aJz(0, i, !0), aJz(0, j, !1), ! function() {
				var aK1, a3u;
				for (;;) {
					if (aK1 = function() {
							var aA, aK1 = aJb.length - 1;
							for (aA = aK1 - 1; 0 <= aA; aA--) aJc[aA] > aJc[aK1] && (aK1 = aA);
							return aK1
						}(), aJc[aK1] < 5) return;
					a3u = aJb[aK1] + bJ.dn(aJc[aK1], 2), (aJd[aK1] ? function(eh) {
						var ea, aK4, aA, aDb = 0,
							aK5 = 0;
						for (; aK5 < j - 1;) {
							for (aA = aDb + 1; aA < j; aA++)
								if (aJf[aA]) {
									aK5 = aA;
									break
								} ea = aK5 - aDb + 1, aJo(f2[eh + i * aDb], 0 === aDb ? aJg[eh] : aJa[aK4 - 1] - aJa[aK4 - 2], ea), aJu(f2[aK5 * i + eh], ea), aJq(eh, aDb, !1, ea), aK4 = ea, aDb = aK5
						}
						aJe[eh] = !0
					} : function(ej) {
						var ea, aK4, aA, aDb = 0,
							aK5 = 0;
						for (; aK5 < i - 1;) {
							for (aA = aDb + 1; aA < i; aA++)
								if (aJe[aA]) {
									aK5 = aA;
									break
								} ea = aK5 - aDb + 1, aJo(f2[ej * i + aDb], 0 === aDb ? aJh[ej] : aJa[aK4 - 1] - aJa[aK4 - 2], ea), aJu(f2[ej * i + aK5], ea), aJq(aDb, ej, !0, ea), aK4 = ea, aDb = aK5
						}
						aJf[ej] = !0
					})(a3u), aJz(a3u, aJb[aK1] + aJc[aK1] - a3u, aJd[aK1]), aJc[aK1] = a3u - aJb[aK1] + 1
				}
			}(), eh = 0; eh < i; eh++)
			if (!aJe[eh])
				for (ej = 0; ej < j; ej++) aJf[ej] || ! function(eh, ej) {
					var value = f2[ej * i + eh - 1] + f2[(ej - 1) * i + eh],
						a5h = 2;
					aJe[eh + 1] && (a5h++, value += f2[ej * i + eh + 1]);
					aJf[ej + 1] && (a5h++, value += f2[(ej + 1) * i + eh]);
...
function aK9(m7, m8, rt, a6s, mK, mL, ru, sb) {
...
function bt() {
	...
	}, this.aKB = function(fI, fK, fM) {
		return Math.max(Math.min(fI, fK), fM)
	}, this.aKC = function(aKD, aKE, eh, ej) {
		eh -= aKD, aKD = ej - aKE, ej = 0;
		return 0 == eh ? ej = 0 <= aKD ? Math.PI : 0 : (ej = Math.atan(aKD / eh), ej += 0 < eh ? .5 * Math.PI : 1.5 * Math.PI), ej
	}, this.log2 = function(f2) {
		return Math.floor(!!f2 * (1 + Math.log2(f2 + .5)))
	}, this.log10 = function(f2) {
		return Math.floor(Math.log10(f2 + .5))
	}, this.aKG = function(aKH, aKI, aKJ, aKK, aKL) {
		return aKJ - aKL < aKH && aKH < aKJ + aKL && aKK - aKL < aKI && aKI < aKK + aKL
...
function d8() {
	this.x = new aKM, this.rm = 0;
	var aKN = new Array(30);

	function aKR() {
		for (var ea = aKN.length, aA = 0; aA < ea; aA++) aKN[aA] = null
	}
	this.dW = function() {
		for (var aKO, aKP = document.body.firstChild; aKP;) {
			if (aKO = aKP.nextSibling, document.body.contains(aKP) && ("DIV" === aKP.tagName || "INPUT" === aKP.tagName || "BUTTON" === aKP.tagName)) try {
				document.body.removeChild(aKP)
			} catch (e) {
				console.log("error 2623: " + e)
			}
			aKP = aKO
		}
	}, this.t = function(e2, aKQ, a2f) {
		void 0 === aKQ && (aKQ = this.rm), bd.de = !0, 0 === e2 && (0 === aZ.zx() ? e2 = 5 : z.a0.setState(13)), this.qq(), this.rm === e2 && (aKQ = aKN[e2].aKQ, aKN[e2] = null), this.rm = e2;
		var kY = aKN[e2];
		if (!kY || 4 === e2 || 7 === e2 || 8 === e2 || 9 === e2 || 10 === e2 || 11 === e2 || 13 === e2 || 15 === e2 || 18 === e2 || 20 <= e2 && e2 <= 28) {
			if (0 === e2) return void aKR();
			1 === e2 ? kY = new aKS : 2 === e2 ? kY = new aKT : 3 === e2 ? kY = new aKU : 4 === e2 || 9 === e2 || 10 === e2 || 11 === e2 || 13 === e2 ? kY = a2f : 5 === e2 ? kY = new aKV : 6 === e2 ? kY = new aKW : 7 === e2 ? kY = new aKX(s.x
					.aKY) : 8 === e2 ? kY = a2f : 12 === e2 ? kY = new aKZ : 14 === e2 ? kY = new aKa : 15 === e2 ? kY = new aKX(s.x.aKb) : 16 === e2 ? kY = new aKc : 17 === e2 ? kY = new aKd : 18 === e2 ? kY = new aKe : 19 === e2 ? kY =
				new aKf : 20 === e2 ? kY = new aKg : 21 === e2 ? kY = new aKh : 22 === e2 ? kY = new aKi : 23 === e2 ? kY = new aKj : 24 === e2 ? kY = new aKk : 25 === e2 ? kY = new aKl : 26 === e2 ? kY = new aKm : 27 === e2 ? kY = new aKn :
				28 === e2 ? kY = new aKo : 29 === e2 && (kY = new aKp), kY.aKQ = aKQ, aKN[e2] = kY
		}
		kY.show(a2f)
	}, this.a07 = function() {
		this.hI() && this.aKq(this.aDC().aKQ)
	}, this.aKq = function(e2) {
		this.hI() && (aKN[e2] ? (this.qq(), bd.de = !0, this.rm = e2, aKN[e2].show()) : this.t(e2))
	}, this.qq = function() {
		this.hI() && aKN[this.rm].qq()
	}, this.w = function() {
		this.hI() && (aKN[this.rm].qq(), aKR(), this.rm = 0, z.a0.setState(13))
	}, this.te = function() {
		var kY;
		this.hI() && (kY = aKN[this.rm]).te && kY.te()
	}, this.resize = function() {
		if (!this.hI()) return !1;
		aKN[this.rm].resize()
	}, this.go = function(eh, ej) {
		var kY;
		this.hI() && (kY = aKN[this.rm]).go && kY.go(eh, ej)
	}, this.a0J = function(eh, ej) {
		var kY;
		this.hI() && (kY = aKN[this.rm]).a0J && kY.a0J(eh, ej)
	}, this.a0h = function() {
		var kY;
		this.hI() && (kY = aKN[this.rm]).a0h && kY.a0h()
	}, this.a0M = function(kt, ku, deltaY) {
		var kY;
		this.hI() && (kY = aKN[this.rm]).a0M && kY.a0M(kt, ku, deltaY)
	}, this.a0r = function(code) {
		var kY;
		return !!this.hI() && ((kY = aKN[this.rm]).a0r && kY.a0r(code), !0)
	}, this.ik = function() {
		var kY;
		this.hI() && (kY = aKN[this.rm]) && kY.ik && kY.ik()
	}, this.hI = function() {
		return 0 < this.rm
	}, this.aDC = function() {
		return aKN[this.rm]
	}, this.aCC = function(e2) {
		return aKN[e2]
	}, this.aKr = function() {
		return aKN
	}
...
function aKX(data) {
	var aKs, aKt;
	this.show = function() {
		data.aKu && bG.aLc("account", data.rk), aKs.show(), this.resize()
	}, this.qq = function() {
		aKs.qq()
	}, this.resize = function() {
		aKs.resize(), aKt.resize()
	}, this.a0r = function(ev) {
		2 === ev && aKs.tW[0].pr()
	}, aKs = new tP(data.username, [new v("⬅️ " + L(32), function() {
		bG.clear(), s.a07()
	}), new v(data.aKu ? "🔄 " + L(151) : L(152), function() {
		s.t(8, s.aDC().aKQ, new rn(25, {
			ro: 0,
			rk: data.rk,
			rl: data.rl
		}))
	}, 0, 0, 1)]), aKt = new pS(aKs.tV, function() {
		var pU = [];
		pU.push(function() {
				var aLA = new pC,
					qN = (aLA.pF(L(201)), new qO({
						value: data.username,
						e2: -1
					}));
				qN.e.readOnly = !0, aLA.pQ(qN), aLA.pQ(new r4([new v(L(170), function(e) {
					return b8.pZ.a27(qN.e), b8.pZ.a28(e), !0
				}).button])), data.aKu || aLA.pH(L(202));
				return aLA
			}()),
			function(pU) {
				var aLA, pI, aAS, aLS, aLI;
				data.aKu || ((aLA = new pC).pF(L(203)), (pI = aLA.pH(data.aLR.length + " / 160")).style.textAlign = "center", aAS = !0, (aLS = new tn(0, 1, function(e) {
					e = e.target.value.length;
					pI.textContent = e + " / 160", 160 < e ? aAS && (aAS = !1, aLI.pu(1), aLI.button.style.color = b9.mh) : aAS || (aAS = !0, aLI.pu(0), aLI.button.style.color = b9.nd)
				})).e.rows = 6, aLS.e.style.fontSize = "1em", aLS.tu(data.aLR), aLA.pQ(aLS), aLI = new v(L(204), function() {
					if (!aAS) return !0;
					s.t(8, s.aDC().aKQ, new rn(29, {
						ro: 1,
						pG: aLS.tw().substring(0, 160)
					}))
				}, 0, 0, 1), aLA.pQ(new r4([aLI.button])), 0 !== data.aLT && (aLA.pQ(new r4([new v(L(1 === data.aLT ? 206 : 207), function() {
					s.t(8, s.aDC().aKQ, new rn(29, {
						ro: 0,
						pG: ""
					}))
				}, 0, 0, 1).button])), aLA.pH(1 === data.aLT ? L(208, [data.aLV - 1]) : L(209, [data.aLV - 1]))), aLA.pH(L(205, [data.aLU])), pU.push(aLA))
			}(pU),
			function(pU) {
				var aLA;
				data.aKu && 0 !== data.aLT && ((aLA = new pC).pF(L(210)), aLA.pJ(data.aLR), aLA.pQ(new r4([new v(L(211, 0, "Report"), function(e) {
					return ay.x.aDl(0) && (b8.pZ.a28(e), ay.aLG.aLW({
						ro: 5,
						rk: data.rk
					})), !0
				}, 0, 0, 1).button])), pU.push(aLA))
			}(pU), pU.push(function() {
				var aLA = new pC,
					aLB = (aLA.pF(L(153)), [L(154), L(155), L(156), L(157), L(158)]),
					e1 = data.aLC;
				aLA.pL(L(159) + b8.zN.a2u(data.uh, .01, 2) + "<br>" + L(160) + (e1 + 1) + " / " + data.ug + "<br>" + L(161) + aLB[e1 < 10 ? 0 : e1 < 50 ? 1 : e1 < 200 ? 2 : e1 < 1e3 ? 3 : 4]), data.aKu || (aLA.pH(L(162)), aLA.pH(L(163)),
					aLA.pH(L(164)));
				return aLA
			}()), data.aKu && pU.push(function() {
				var aLA = new pC,
					qN = (aLA.pF(L(165)), new qO({
						value: bh.dr.data[147].value,
						e2: -1
					}, 1, void 0, function(e) {
						bh.r1.r2(147, aLD(e.target.value))
					})),
					aLE = (aLA.pQ(qN), new v(L(14), function(e) {
						return qN.e.readOnly && ay.x.aDl(0) && (b8.pZ.a28(e), aLF(), ay.aLG.aLH({
							ro: 0,
							rk: data.rk,
							value: bh.dr.data[147].value
						})), !0
					}, 1)),
					aLI = new v(L(166), function(e) {
						return e.textContent === L(166) ? (e.textContent = L(167), qN.e.readOnly = !0, aLE.pu(0), aLE.button.style.color = b9.nd, bh.r1.r2(147, qN.e.value), aLD(bh.dr.data[147].value)) : aLF(), !0
					}),
					pI = (aLA.pQ(new r4([aLI.button])), aLA.pH()),
					aLD = function(f2) {
						f2 = b8.fw.a2c(f2, 2, 1e6), pI.textContent = L(168, [f2, bh.dr.data[105].value, data.rk, f2 - 1])
					},
					aLF = function() {
						aLI.button.textContent = L(166), qN.e.readOnly = !1, aLE.pu(1), aLE.button.style.color = b9.mh
					};
				return aLD(bh.dr.data[147].value), aLA.pQ(new r4([aLE.button])), aLA
			}());
		pU.push(function() {
			var aLA = new pC,
				qN = (aLA.pF(L(169)), new qO({
					value: data.rk,
					e2: -1
				}));
			return qN.e.readOnly = !0, aLA.pQ(qN), aLA.pQ(new r4([new v(L(170), function(e) {
				return b8.pZ.a27(qN.e), b8.pZ.a28(e), !0
			}).button])), aLA
		}()), data.aKu || (pU.push(function() {
			var aLA = new pC,
				aLJ = (aLA.pF(L(171)), new qO(bh.dr.data[106]));
			return aLJ.e.readOnly = !0, aLJ.e.type = "password", aLA.pQ(aLJ), aLA.pQ(new r4([new v(L(172), function(e) {
				return e.textContent === L(172) ? (e.textContent = L(173), aLJ.e.type = "text") : (e.textContent = L(172), aLJ.e.type = "password"), !0
			}).button, new v(L(170), function(e) {
				return b8.pZ.a27(aLJ.e), b8.pZ.a28(e), !0
			}).button])), aLA.pQ(new r4([new v(L(174), function() {
				s.t(8, s.aDC().aKQ, new rn(15))
			}).button])), aLA.pF(L(175), "0.8em"), aLA.pH(L(176)), aLA.pH(L(177)), aLA.pH(L(178)), aLA
		}()), pU.push(function() {
			var aLA = new pC;
			return aLA.pF(L(179)), aLA.pQ(new r4([new v(L(180), function() {
				s.t(6, s.aDC().aKQ)
			}).button])), aLA.pQ(new r4([new v(L(181), function() {
				bh.r1.r2(105, ""), s.t(8, s.aDC().aKQ, new rn(18))
			}).button])), aLA.pQ(new r4([new v(L(182) + bh.dr.data[105].value, function() {
			...
			function aLL(e2) {
				for (var aA = 0; aA < 2; aA++) aLK[aA].pu(0 === e2 ? b9.mt : 0 === aA ? b9.nM : b9.n4)
			}
			var pO, aLK, aLA = new pC;
			aLA.pF(L(185)), aLA.pH(L(186)), bh.x.uR();
			return aLK = [new v(L(187), function() {
				...
				if (!(e2 < 1)) {
					...
					bh.x.uU(e2), e2 = bh.dr.data[117].value, pO.pP[e2].textContent = pO.pP[e2].textContent.replace("⚪", "🟢"), aLL(e2)
				}
			}, b9.mt), new v(L(188), function() {
				var e2 = Math.min(bh.dr.data[117].value, pO.pP.length - 1);
				e2 < 1 || (e2 = bh.x.uV(e2), bh.r1.r2(105, e2.rk), bh.r1.r2(106, e2.password), s.t(8, s.aDC().aKQ, new rn(18)))
			}, b9.mt)], (pO = new tK(bh.dr.data[117], aLL)).pP[0].style.marginTop = "0.5em", aLA.pN(pO), aLA.pQ(new r4([aLK[1].button])), aLA.pQ(new r4([aLK[0].button])), aLA
		}()));
		return pU.push(function() {
				var aLA = new pC,
					aLB = (aLA.pF(L(192)), [L(193), L(194), L(195), L(196)]),
					e1 = data.aLM;
				return aLA.pL(L(197) + (data.aLN / 100).toFixed(2) + "<br>" + L(160) + (e1 + 1) + " / " + data.ug + "<br>" + L(161) + aLB[e1 < 10 ? 0 : e1 < 50 ? 1 : e1 < 200 ? 2 : 3]), aLA
			}()), pU.push(function() {
				var aLA = new pC;
				return aLA.pF(L(189)), aLA.pL(L(190) + b8.zN.a2u(data.ud, .1, 1) + "<br>" + L(160) + (data.ue + 1) + " / " + data.ug + "<br>" + L(191) + data.uf), aLA
			}()),
			function(pU) {
				var aLA = new pC,
					aLX = data.uk,
					aLY = (aLA.pF(L(212)), aLA.pL(L(213, [aLX ? "[" + data.ui + "]" : "-"])), aLA.pL(L(214, [b8.zN.a2u(aLX, .01, 2)])), aLA.pL(L(215, [data.um + 1 + " / " + data.ug])), data.un),
					aLZ = (aLA.pL(L(216, [b8.zN.a2u(aLY, .1, 1)])), data.up);
				aLA.pL(L(217, [aLZ])), aLA.pL(L(218, [b8.zN.a2u(aLY / Math.max(aLZ, 1), .1, 2)])), aLX = data.ul, aLA.pF(L(219), "0.8em"), aLA.pL(L(213, [aLX ? "[" + data.uj + "]" : "-"])), aLA.pL(L(214, [b8.zN.a2u(aLX, .01, 2)])), aLY = data
					.uo, aLA.pL(L(216, [b8.zN.a2u(aLY, .1, 1)])), aLZ = data.uq, aLA.pL(L(217, [aLZ])), aLA.pL(L(218, [b8.zN.a2u(aLY / Math.max(aLZ, 1), .1, 2)])), data.aKu || (aLA.pH(L(220)), aLA.pH(L(221)));
				pU.push(aLA)
			}(pU),
			function(pU) {
				var aLA = new pC;
				aLA.pF(L(222)), aLA.pL(L(197) + (data.aLa / 10).toFixed(1) + "<br>" + L(161) + (data.aLb.length ? L(223, [data.aLb]) : L(224))), data.aKu ? (aLA.pQ(new r4([new v(L(225), function(e) {
					return ay.x.aDl(0) && (b8.pZ.a28(e), ay.aLG.aLW({
						ro: 4,
						rk: data.rk
					})), !0
				}, 0, 0, 1).button])), aLA.pH(L(226)), aLA.pH(L(227))) : aLA.pH(L(228));
				pU.push(aLA)
			}(pU), pU.push(function() {
				var aLA = new pC;
				if (aLA.pF(L(198)), aLA.pL(L(199) + data.aLO + "<br>" + L(160) + (data.aLP + 1) + " / " + data.ug + "<br>" + L(161) + bn.e4(data.aLP)), data.aKu) {
					var qN = new qO({
							value: bh.dr.data[157].value,
							e2: -1
						}, 1, void 0, function(e) {
							bh.r1.r2(157, aLD(e.target.value))
						}),
						aLI = (qN.e.style.marginTop = "0.6em", aLA.pQ(qN), new v(L(166), function(e) {
							return e.textContent === L(166) ? (e.textContent = L(167), qN.e.readOnly = !0, aLQ[0].pu(0), aLQ[1].pu(0), aLQ[0].button.style.color = b9.nd, aLQ[1].button.style.color = b9.nd, aLD(bh.dr.data[157]
								.value)) : aLF(), !0
						})),
						aLQ = (aLA.pQ(new r4([aLI.button])), [new v("−", function(e) {
							return qN.e.readOnly && ay.x.aDl(0) && (b8.pZ.a28(e), aLF(), ay.aLG.aLH({
								ro: 2,
								rk: data.rk,
					...
					aLA.pQ(new r4([aLQ[0].button, aLQ[1].button]));
					for (var aA = 0; aA < 2; aA++) aLQ[aA].button.style.fontSize = "1.6em";
					var aLF = function() {
						aLI.button.textContent = L(166), qN.e.readOnly = !1, aLQ[0].pu(1), aLQ[1].pu(1), aLQ[0].button.style.color = b9.mh, aLQ[1].button.style.color = b9.mh
					};
...
function aKi() {
	...
	function aLg() {
		aLi(), 2 !== aC.data.aIncomeType && (aC.data.aIncomeData = null), s.aKr()[19] = null, s.a07()
	}

	function aLi() {
		2 === aC.data.aIncomeType ? (b8.pi.a1U(aLf.tw(), aC.data.aIncomeData, 255), b8.pi.max(aC.data.aIncomeData) || (aC.data.aIncomeType = 0)) : 1 !== aC.data.aIncomeType || aC.data.aIncomeValue || (aC.data.aIncomeType = 0)
	}
	this.show = function() {
		aLd.show(), this.resize()
	}, this.qq = function() {
		aLd.qq()
	}, this.resize = function() {
		aLd.resize(), aLe.resize()
	}, this.a0r = function(ev) {
		2 === ev && aLd.tW[0].pr()
	}, aLd = new tP(L(229), [new v("⬅️ " + L(32), aLg)]), aLe = new pS(aLd.tV, (function(pU) {
		var aLA = new pC;
		aLA.pF(L(230)), aLA.pN(new tK({
			tO: [L(231), L(232), L(233)],
			value: aC.data.aIncomeType
		}, function(e2) {
			aLi(), 2 !== e2 || aC.data.aIncomeData || (aC.data.aIncomeData = new Uint8Array(aC.eX)), aC.data.aIncomeType = e2, s.t(22)
		})), pU.push(aLA)
	}(pU = []), function(pU) {
		var aLA;
		1 === aC.data.aIncomeType && ((aLA = new pC).pF("Value"), aLA.pQ(new qO({
			e2: -1,
		...
		var aLA;
		2 === aC.data.aIncomeType && ((aLA = new pC).pF("Data"), (aLf = new tn(0, 1, 0, 1)).tu(b8.zN.a30(aC.data.aIncomeData, 4)), aLA.pQ(aLf), pU.push(aLA))
	}(pU), pU))
}
...
function aKl() {
	...
	function aLg() {
		aLi(), 3 !== aC.data.botDifficultyType || b8.pi.a1I(aC.data.botDifficultyData) || (aC.data.botDifficultyType = 0), 3 !== aC.data.botDifficultyType && (aC.data.botDifficultyData = null), s.aKr()[19] = null, s.a07()
	}

	function aLi() {
		3 === aC.data.botDifficultyType && b8.pi.a1U(aLf.tw(), aC.data.botDifficultyData, aD.k1.length - 1)
	}

	function aLn(pU, e2) {
		var aLA = new pC,
			value = (aLA.pF(e2 < 0 ? L(57) : L(56) + " " + be.z8[e2 % 9]), 0 <= e2 && (aLA.pL(L(236) + ": " + aC.data.teamPlayerCount[e2]).style.marginBottom = "1em"), e2 < 0 ? aC.data.botDifficultyValue : aC.data.botDifficultyTeam[e2]);
		aLA.pN(new tK({
			tO: aD.k1,
			value: value
		}, function(hO) {
	...
	this.show = function() {
		...
		2 === ev && aLd.tW[0].pr()
	}, aLd = new tP(L(57), [new v("⬅️ " + L(32), aLg)]), aLe = new pS(aLd.tV, function() {
		var pU = [];
		if (function(pU) {
				var aLA = new pC,
					tO = (aLA.pF(L(230)), [L(232), L(234), L(235), L(233)]),
				...
				aLA.pN(new tK({
					...
					aLi(), aC.data.botDifficultyType = e2, 0 === aC.data.gameMode && 2 === e2 && (aC.data.botDifficultyType = 3), 3 !== aC.data.botDifficultyType || aC.data.botDifficultyData || (aC.data.botDifficultyData =
			...
			}(pU), 0 === aC.data.botDifficultyType) aLn(pU, -1);
		else if (2 === aC.data.botDifficultyType)
			for (var aA = 0; aA < aC.data.teamPlayerCount.length; aA++) aC.data.teamPlayerCount[aA] && aLn(pU, aA);
		else 3 === aC.data.botDifficultyType && ! function(pU) {
			var aLA = new pC;
			aLA.pF("Data"), (aLf = new tn(0, 1, 0, 1)).tu(b8.zN.a30(aC.data.botDifficultyData, 8)), aLA.pQ(aLf), pU.push(aLA)
		}(pU);
		return pU
	}())
}
...
function aLo(data) {
	var aKs, aLp, aLq, aLr, aLs, aLt, aLu, colors, aLv, aLw, aLx = 0,
		aLy = 0,
		aLz = !1,
		aM0 = !1,
		aM1 = [1, 5, 60, 240, 1440, 10080, 43200];

	function aMV(kt, ku) {
		! function(kt, ku) {
			return aLp < kt && kt < aLp + aLr && aLq < ku && ku < aLq + aLs
		}(aLx = kt, aLy = ku) ? (aLz && (bd.de = !0), aLz = !1) : (aLz = !0, bd.de = !0)
	}
	this.show = function() {
		aM0 = bh.dr.data[127].value, aKs.show(), this.resize()
	}, this.qq = function() {
		aKs.qq()
	}, this.resize = function() {
		aKs.resize();
		var ev = h.k,
			...
			aMA = ev * td.tc,
			ev = ev * td.qt;
		aLt = b8.pZ.sC(.06), aLu = b8.pZ.sC(.04), aLp = b8.pZ.sC(.06), aLq = ev + aLt, aLr = h.i - aLp - aLu, aLs = aMA + ev - aLq - aLu
	}, this.te = function() {
		aKs.te(),
			function() {
				var aA, aM7, g3, eh, et, g = data.data,
					aME = 1,
					aMF = .125,
					aMG = aM0 ? 65536 : 0;
				for (aA = 0; aA < g.length; aA++)
					for (aM7 = g[aA].aM7, g3 = aM7.length, aME = Math.max(g3, aME), et = 0; et < g3; et++) aMF = Math.max(aM7[et], aMF), aMG = Math.min(aM7[et], aMG);
				var m8 = aLq + aLs,
					wr = aLs / (aMF - aMG),
					wq = 1 / (aME - 1);
				for (tf.lineWidth = ba.xn, aA = 0; aA < g.length; aA++) {
					for (aM7 = g[aA].aM7, g3 = aM7.length, eh = aLp, tf.beginPath(), tf.moveTo(eh + aLr, m8 - wr * (aM7[g3 - 1] - aMG)), et = g3 - 2; 0 <= et; et--) tf.lineTo(eh + wq * et * aLr, m8 - wr * (aM7[et] - aMG));
					tf.strokeStyle = colors[aA], tf.stroke()
				}(function(aMG, aMF, m8, wr) {
					tf.font = b8.pZ.rN(0, .25 * aLp), b8.pZ.textBaseline(tf, 1), b8.pZ.textAlign(tf, 2), tf.fillStyle = colors[0];
					for (var eh = .92 * aLp, aA = 0; aA < 3; aA++) {
						var f2 = aMG + aA * (aMF - aMG) / 2;
						tf.fillText((f2 / 1e3).toFixed(3), eh, m8 - wr * (f2 - aMG))
					}
				})(aMG, aMF, m8, wr),
				function(aME) {
					var ej = aLq + aLs + .15 * aLu;
					tf.font = b8.pZ.rN(0, Math.min(.4 * aLu, .028 * h.i)), b8.pZ.textBaseline(tf, 0), b8.pZ.textAlign(tf, 2), tf.fillStyle = colors[0], tf.fillText(b8.a19.a1w(aLv), aLp + aLr, ej), b8.pZ.textAlign(tf, 0), tf.fillText(b8.a19.a1w(
						new Date(aLw.getTime() - 6e4 * (aME - 1) * aM1[data.aM6])), aLp, ej)
				}(aME),
				function(aME, aMG, aMF) {
					if (aLz && !(aME < 2)) {
						for (var a70, e2 = (aLx - aLp) / aLr * (aME - 1), aMJ = Math.floor(e2), aMK = Math.floor(1 + e2), aML = e2 - aMJ, aMM = 1e5, aMN = -1, aMO = -1, aMP = aMF - (aMF - aMG) * (aLy - aLq) / aLs, g = data.data, aA = 0; aA < g
							.length; aA++) {
							var aAe, aM7 = g[aA].aM7;
							aM7.length <= aMK || (aM7 = aM7[aMJ] + aML * (aM7[aMK] - aM7[aMJ]), (aAe = Math.abs(aMP - aM7)) < aMM && (aMM = aAe, aMN = aA, aMO = aM7))
						} - 1 !== aMN && (aMF = aLq + aLs - (aMO - aMG) / (aMF - aMG) * aLs, tf.lineWidth = .5 * ba.xn, tf.strokeStyle = colors[aMN], tf.beginPath(), tf.moveTo(aLp, aMF), tf.lineTo(aLx, aMF), tf.lineTo(aLx, aLq + aLs), tf
						.stroke(), tf.beginPath(), tf.arc(aLx, aMF, .1 * aLp, 0, 2 * Math.PI), tf.fillStyle = colors[aMN], tf.fill(), aMG = aLq + aLs + .15 * aLu, b8.pZ.textAlign(tf, 1), a70 = aME - 2 < e2 ? (a70 = aLw.getTime() - 6e4 * aM1[
								data.aM6], new Date(a70 + (e2 - (aME - 2)) * (aLv.getTime() - a70))) : new Date(aLw.getTime() - 6e4 * (aME - e2 - 1) * aM1[data.aM6]), aME = b8.a19.a1w(a70), e2 = b8.pZ.measureText(aME), a70 = bJ.p7(aLx, aLp +
								.5 * e2, aLp + aLr - .5 * e2), tf.fillStyle = b8.color.mZ(70, 50, 20), tf.fillRect(a70 - .52 * e2, aLq + aLs, 1.04 * e2, .55 * aLu), tf.fillStyle = colors[0], tf.fillText(aME, a70, aMG), tf.font = b8.pZ.rN(0,
								.25 * aLp), b8.pZ.textBaseline(tf, 1), b8.pZ.textAlign(tf, 2), a70 = .92 * aLp, aME = (aMO / 1e3).toFixed(3), e2 = b8.pZ.measureText(aME), aMG = a70 - 1.04 * e2, tf.fillStyle = b8.color.mZ(70, 50, 20), tf
							.fillRect(aMG, aMF - .1625 * aLp, aLp - aMG, .275 * aLp), tf.fillStyle = colors[aMN], tf.fillText(aME, a70, aMF))
					}
				}(aME, aMG, aMF)
			}(), tf.lineWidth = ba.xn, tf.strokeStyle = b9.mh, tf.beginPath(), tf.moveTo(aLp, aLq), tf.lineTo(aLp, aLq + aLs), tf.lineTo(aLp + aLr, aLq + aLs), tf.stroke();
		var aA, fontSize = .5 * aLt,
		...
		pG = pG.trim();
		var aMS = b8.pZ.measureText(pG),
			eh = .5 * (h.i - aMS);
		for (aMS > h.i && (eh = 0, tf.font = b8.pZ.rN(0, h.i / aMS * fontSize)), aA = 0; aA < ea; aA++) tf.fillStyle = colors[aA], tf.fillText(g[aA].name, eh, ej), eh += b8.pZ.measureText(g[aA].name + "  ")
	}, this.go = function(kt, ku) {
		aMV(kt, ku)
	}, this.a0J = function(kt, ku) {
		aMV(kt, ku)
	...
	var aA, dm, a1u, hO, ed = data.data,
		ea = ed.length,
		max = 1;
	for (aA = 0; aA < ea; aA++) max = Math.max(max, ed[aA].aM7.length);
	for (aA = 0; aA < ea; aA++)
		for (; ed[aA].aM7.length < max;) ed[aA].aM7.unshift(0);
	dm = new Date, a1u = 6e4 * dm.getTimezoneOffset(), hO = dm.getTime() - a1u, aLv = new Date(hO), 6 === data.aM6 ? function(dm, a1u) {
		var aM9 = dm.getUTCFullYear(),
			dm = dm.getUTCMonth() + 1;
		aLw = dm < 12 ? new Date(Date.UTC(aM9, dm) - a1u) : new Date(Date.UTC(aM9 + 1, 0) - a1u)
	}(dm, a1u) : (a1u = 6e4 * aM1[data.aM6], aLw = data.aM6 <= 4 ? new Date(hO + a1u - dm.getTime() % a1u) : new Date(hO + a1u - (dm.getTime() + 2592e5) % a1u)), hO = b8.color, colors = [b9.mh, hO.mZ(255, 0, 0), hO.mZ(0, 200, 0), hO.mZ(80, 80,
		255), hO.mZ(255, 255, 0), hO.mZ(255, 0, 255), hO.mZ(0, 255, 255), hO.mZ(255, 140, 0), hO.mZ(128, 128, 128), hO.mZ(0, 255, 140)], aKs = new tP(L(237) + ", " + ["M1", "M5", "H1", "H4", "D1", "W1", "MN"][data.aM6] + ", " + b8.a19.a1t(aLv), [
...
function aKa() {
	...
	this.show = function() {
		...
		2 === ev && aKs.tW[0].pr()
	}, aKs = new tP(L(239), [new v("⬅️ " + L(32), function() {
		s.aKq(13)
	})]), aKt = new pS(aKs.tV, ((pU = []).push(function() {
		var aLA = new pC,
			aLI = (aLA.pF(L(240)), aLA.pH(L(241)), new v(L(242), function() {
				bh.r1.r2(130, 0), s.x.aMa()
			}, 0, 0, 1)),
			qN = new qO(bh.dr.data[126], 0, function() {
				aLI.button.click()
			});
		return aLA.pQ(qN), qN.e.placeholder = "a,b,c", qN.e.style.marginTop = "0.5em", aLA.pQ(new r4([aLI.button])), aLA
	}()), pU.push(function() {
		var aLA = new pC,
			aLI = new v(L(242), function() {
				bh.r1.r2(130, 1), s.x.aMa()
			}, 0, 0, 1),
			aMb = new qO(bh.dr.data[129], 1, function() {
				aMb.e.focus()
			}),
			aMc = new qO(bh.dr.data[128], 1, function() {
				aLI.button.click()
			});
		return aLA.pF(L(243)), aLA.pQ(aMc), aMc.e.style.marginBottom = "0.5em", aLA.pF(L(244)), aLA.pQ(aMb), aLA.pQ(new r4([aLI.button])), aLA
	}()), pU.push(function() {
		var aLA = new pC;
		return aLA.pF(L(245)), bh.dr.data[125].tO = ["M1", "M5", "H1", "H4", "D1", "W1", "MN"], aLA.pN(new tK(bh.dr.data[125])), aLA
	}()), pU.push(function() {
		var aLA = new pC;
		return aLA.pF(L(246)), aLA.pQ(new qy(bh.dr.data[127], L(247))), aLA
	}()), pU))
}

function aKZ() {
	var aKs, aMd, aLr, aMe, aMf, aMg, colors = [0, 0, 0],
		aMh = -1;

	function aMk(aA) {
		var aMl = aMd.ej + aA * (ba.gap + aMg);
		tf.fillStyle = "rgb(" + (0 === aA ? 150 : 2 === aA ? 30 : 0) + "," + (1 === aA ? 130 : 2 === aA ? 30 : 0) + "," + (2 === aA ? 220 : 0) + ")", tf.fillRect(aMe, aMl, colors[aA] * aMf, aMg), tf.strokeStyle = b9.mh, tf.strokeRect(aMe, aMl, aMf,
			aMg), tf.fillStyle = b9.mh, tf.font = b8.pZ.rN(0, .32 * aMg), b8.pZ.textBaseline(tf, 1), b8.pZ.textAlign(tf, 0), tf.fillText(L(0 === aA ? 250 : 1 === aA ? 251 : 252) + aMi(aA), aMe + ba.gap, aMl + .53 * aMg)
	}

	function aMi(aA, aMm) {
		return aMm = aMm || 256, bJ.p7(Math.floor(aMm * colors[aA]), 0, aMm - 1)
	}

	function a0n(kt, ku) {
		return !(kt < aMe || ku < aMd.ej || kt > aMd.eh + aMd.i || ku > aMd.ej + aMd.j)
	}
	this.show = function() {
		var f2 = bh.dr.data[121].value;
		colors[0] = (f2 >> 12) / 63, colors[1] = (f2 >> 6 & 63) / 63, colors[2] = (63 & f2) / 63, aKs.show(), this.resize()
	}, this.qq = function() {
		bh.r1.r2(121, (aMi(0, 64) << 12) + (aMi(1, 64) << 6) + aMi(2, 64)), aKs.qq()
	}, this.resize = function() {
		aKs.resize(), aMd.resize();
		var ev = h.k,
			td = aKs.ta(),
			aMj = (aMd.ej = Math.max(aMd.ej, ev * td.qt + ba.gap), ev * td.tc - 2 * ba.gap);
		aMd.j = Math.min(aMd.j, aMj), aMd.i = 2 * aMd.j, aMd.ej = ev * td.qt + .5 * (ev * td.tc - aMd.j), aMd.eh = .5 * (h.i - aMd.i), aLr = .25 * aMd.i, aMe = aMd.eh + aLr + ba.gap, aMf = aMd.i - aLr - ba.gap, aMg = (aMd.j - 2 * ba.gap) / 3
	}, this.te = function() {
		var e1, sB, eu;
		aKs.te(), tf.lineWidth = ba.xn, e1 = aMi(0), sB = aMi(1), eu = aMi(2), tf.fillStyle = "rgb(" + e1 + "," + sB + "," + eu + ")", tf.fillRect(aMd.eh, aMd.ej, aLr, aMd.j), tf.strokeStyle = b9.mh, tf.strokeRect(aMd.eh, aMd.ej, aLr, aMd.j), tf
			.fillStyle = e1 + sB + eu < 306 && sB < 150 ? b9.mh : b9.mY, b8.pZ.textBaseline(tf, 1), b8.pZ.textAlign(tf, 1), tf.font = b8.pZ.rN(0, .1 * aMd.j), tf.rotate(-Math.PI / 2), tf.fillText(L(249), -aMd.ej - .5 * aMd.j, aMd.eh + .5 * aLr),
			tf.setTransform(1, 0, 0, 1, 0, 0), aMk(0), aMk(1), aMk(2)
	}, this.go = function(kt, ku) {
		a0n(kt, ku) && (aMh = bJ.p7(Math.floor((ku - aMd.ej) / (aMg + .75 * ba.gap)), 0, 2), colors[aMh] = bJ.p7((kt - aMe) / aMf, 0, 1), bd.de = !0)
	}, this.a0J = function(kt) {
		-1 !== aMh && (colors[aMh] = bJ.p7((kt - aMe) / aMf, 0, 1), bd.de = !0)
	}, this.a0M = function(kt, ku, deltaY) {
		a0n(kt, ku) && (kt = bJ.p7(Math.floor((ku - aMd.ej) / (aMg + .75 * ba.gap)), 0, 2), colors[kt] = bJ.p7(colors[kt] + (1 - 2 * (0 < deltaY)) / 256, 0, 1), bd.de = !0)
	}, this.a0h = function() {
		0 <= aMh && (aMh = -1, bd.de = !0)
	}, this.a0r = function(ev) {
		2 === ev && aKs.tW[0].pr()
	}, aKs = new tP(L(248), [new v("⬅️ " + L(32), function() {
		s.x.aAY()
	})], !1), aMd = new qB([.5, .25], [.5, .5], 1)
}
...
function aKh() {
	...
	function aLg() {
		aLi(), 1 !== aC.data.colorsType && (aC.data.colorsData = null), s.aKr()[19] = null, s.a07()
	}
	...
	function aLi() {
		1 === aC.data.gameMode ? aC.a3H.a3L() : 0 === aC.data.gameMode && 1 === aC.data.colorsType && b8.pi.a1U(aLf.tw(), aC.data.colorsData, 262143)
	}
	this.show = function() {
		aLd.show(), this.resize()
	}, this.qq = function() {
		...
		2 === ev && aLd.tW[0].pr()
	}, q9 = [new v("⬅️ " + L(32), aLg)], 1 === aC.data.gameMode && q9.push(new v(L(253), aMn, 1, 1)), aLd = new tP(L(254), q9), aLe = new pS(aLd.tV, (function(pU) {
		var aLA = new pC;
		aLA.pF(L(230)), 0 === aC.data.gameMode && (aLA.pN(new tK({
			tO: [L(255), L(233)],
			value: aC.data.colorsType
		}, function(e2) {
			aLi(), aC.data.colorsType = e2, 1 !== aC.data.colorsType || aC.data.colorsData && aC.data.colorsData.length === aC.eX || (aC.data.colorsData = new Uint32Array(aC.eX)), s.t(21)
		})), aLA.pQ(new rE));
		aLA.pQ(new qy({
		...
		var aLA = new pC;
		aLA.pF("Data"), (aLf = new tn(0, 1, 0, 1)).tu(b8.zN.a30(aC.data.colorsData, 1)), aLA.pQ(aLf), pU.push(aLA)
	}(q9) : (aC.a3H.a3L(), q9.push(function() {
		var aLA = new pC;
		aLA.pF(L(236));
		for (var aA = 0; aA < be.z8.length; aA++) {
			var hO = (aA + 1) % be.z8.length,
				e = aLA.pL((0 == hO ? "" : "Team ") + be.z8[hO]);
			aA && (e.style.marginTop = "0.5em"), aLA.pQ(new qO({
				e2: -1,
				value: aC.data.teamPlayerCount[hO]
			}, 1, 0, function(e) {
				aLd.tW[1].pu(0);
				var playerCount = bJ.p7(Math.floor(e.target.value), 0, 512);
				e.target.value = playerCount, aC.data.teamPlayerCount[e.target.aMp] = playerCount
			})).e.aMp = hO
		}
		return aLA
	}())), q9))
...
function rn(id, a2f, aMq) {
	var aKs, aMr;

	function aMw() {
		aMr.pV.innerHTML += "<br>" + L(259)
	}

	function aMv() {
		bB.a6(48), bB.a7(24, Math.floor(bJ.pow(24) * Math.random())), bB.a7(24, Math.floor(bJ.pow(24) * Math.random())), bF.dW(bB.aB), bh.r1.r2(110, bD.rp.rq(bD.rp.rr(8))), ay.aLG.aNA()
	}
	this.aMs = !0, this.aMt = id, this.show = function() {
		aKs.show(), this.resize(), 15 === id ? (ay.x.aMu(id) ? aMv : aMw)() : 16 === id ? ay.x.aMu(id) ? ay.aAV.aMx(2) : aMw() : 17 === id ? ay.x.aMu(id) ? ay.aAV.aMx(3) : aMw() : 18 === id ? (ay.x.close(0, 3253), ay.x.aDr(0, id), aMw()) : 21 ===
			id ? ay.x.aMu(id) ? ay.aMy.aMz(a2f.s6, a2f.s7, a2f.s8) : aMw() : 22 === id ? ay.x.aMu(id) ? ay.aMy.aN0(a2f.s6, a2f.aN1, a2f.aN2) : aMw() : 23 === id ? ay.x.aMu(id) ? ay.aMy.aN3(a2f.aM6, a2f.zQ) : aMw() : 24 === id ? ay.x.aMu(id) ? ay
			.aMy.aN4(a2f.aM6, a2f.s7, a2f.s8) : aMw() : 25 === id ? ay.x.aMu(id) ? ay.aLG.aLW(a2f) : aMw() : 28 === id ? ay.x.aMu(id) ? ay.aMy.aN5(a2f.s6, a2f.aN1, a2f.aN2) : aMw() : 29 === id && (ay.x.aMu(id) ? ay.aLG.aN6(a2f) : aMw())
	}, this.aN7 = function() {
		15 === id ? aMv() : 16 === id ? ay.aAV.aMx(2) : 17 === id ? ay.aAV.aMx(3) : 18 === id ? s.t(8, this.aKQ, new rn(16)) : 21 === id ? ay.aMy.aMz(a2f.s6, a2f.s7, a2f.s8) : 22 === id ? ay.aMy.aN0(a2f.s6, a2f.aN1, a2f.aN2) : 23 === id ? ay.aMy
			.aN3(a2f.aM6, a2f.zQ) : 24 === id ? ay.aMy.aN4(a2f.aM6, a2f.s7, a2f.s8) : 25 === id ? ay.aLG.aLW(a2f) : 28 === id ? ay.aMy.aN5(a2f.s6, a2f.aN1, a2f.aN2) : 29 === id ? ay.aLG.aN6(a2f) : 1e3 === id && (this.aMt = id = 25, ay.aLG.aLW(
				a2f))
	}, this.aN8 = function(code, bq, data) {
		!bq && code !== id || (16 === code ? s.t(7, this.aKQ) : 17 === code ? (ay.x.close(0, 3252), bh.x.uU(0), bh.dr.data[117].tO && 0 < bh.dr.data[117].tO.length ? (bq = bh.x.uV(0), bh.r1.r2(105, bq.rk), bh.r1.r2(106, bq.password), s.t(8, this
			.aKQ, new rn(16))) : (bh.r1.r2(105, ""), s.x.aAY())) : 21 === code ? s.t(10, this.aKQ, new aN9(data)) : 23 === code ? s.t(13, 0, new aLo({
			data: data,
			aM6: a2f.aM6
		})) : 25 === code && (s.x.aKb.rk = a2f.rk, s.t(15, this.aKQ)))
	}, this.qq = function() {
		aKs.qq()
	}, this.resize = function() {
		aKs.resize(), aMr.resize()
	}, this.a0r = function(ev) {
		2 === ev && aKs.tW[0].pr()
	}, aKs = new tP(L(257), [new v("⬅️ " + L(32), function() {
		aMq ? s.t(29) : s.x.aAY()
	})]), aMr = new r3(aKs.tV, L(258))
}
...
function aKf() {
	...
	function aLg() {
		1 !== aC.data.gameMode && (aC.data.teamPlayerCount = null), aNF(), aC.data.canvas = null, s.t(5, 5)
	}
	...
	function aNB() {
		aC.data.isReplay = 0, aNF(), aC.a3H.a3i(), aZ.aE3(), aC.a3H.a3f(), aC.data.canvas = 2 === aC.data.mapType ? bQ.vR : null, aC.a3K(), aC.a3J = 1
	}

	function aNT() {
		aND();
		for (var g = [aNI(), aNJ(), aNK()], aA = 3; aA < 6; aA++) aLe.pV.removeChild(aLe.pW[aA].pE), aLe.pW[aA] = g[aA - 3], aLe.pV.appendChild(aLe.pW[aA].pE);
		aLe.resize()
	}

	function aNI() {
		var aNU, aLA = new pC;
		return aLA.pF(L(254)), aNU = 0 === aC.data.gameMode ? [L(255), L(233)][aC.data.colorsType] : aC.data.numberTeams + " Team" + (1 === aC.data.numberTeams ? "" : "s"), aLA.pL(aNU), aLA.pQ(new r4([new v(L(263), function() {
			s.t(21)
		}).button])), aLA
	}
	...
	function aNJ() {
		var aLA = new pC,
			g = (aLA.pF(L(57)), [L(232) + ": " + aD.k1[aC.data.botDifficultyValue], L(234), L(235), L(233)]);
		return aLA.pL(g[aC.data.botDifficultyType]), aLA.pQ(new r4([new v(L(263), function() {
			s.t(25)
		}).button])), aLA
	}
	...
	function aNK() {
		var aLA = new pC,
			g = (aLA.pF("Spawning"), [L(255), L(265), L(233)]);
		return aLA.pL(g[aC.data.spawningType]), aLA.pQ(new r4([new v(L(263), function() {
			s.t(24)
		}).button])), aLA
	}
	this.show = function() {
		aLd.show(), this.resize(), aLd.tV.scrollTop = s.x.aFy[0]
	}, this.qq = function() {
		s.x.aFy[0] = aLd.tV.scrollTop, aLd.qq()
	}, this.resize = function() {
		aLd.resize(), aLe.resize()
	}, this.a0r = function(ev) {
		2 === ev && aLd.tW[0].pr()
	}, aLd = new tP("🔧 " + L(260), [new v("⬅️ " + L(32), aLg), new v(L(261), aNB)]), aND(), aC.data.canvas || (2 === aC.data.mapType ? aC.data.canvas = bQ.vR : 1 === aC.data.mapType ? aC.data.canvas = bQ.aIV(bQ.a3g(aC.data), 0).vR : (aC.data
		.mapType = 0, aC.data.passableWater = aC.data.passableMountains = 1, aC.data.canvas = bQ.aIV(bQ.a3g(aC.data), aC.data.mapSeed).vR)), aLe = new pS(aLd.tV, (function(pU) {
		var aLA = new pC,
			a1e = (aLA.pF(L(262)), aC.data.canvas);
		a1e.style.width = "100%", aLA.pQ({
			e: a1e
		}), aLA.pQ(new r4([new v(L(263), function() {
			s.t(20)
		}).button])), pU.push(aLA)
	}(pU = []), function(pU) {
		var aLA = new pC;
		aLA.pF(L(236)), aLA.pQ(new qO({
			e2: -1,
			value: aC.data.playerCount
		}, 1, 0, function(e) {
			var playerCount = bJ.p7(Math.floor(e.target.value), 1, 512);
			e.target.value = aC.data.playerCount = playerCount, 1 === aC.data.gameMode && (e = b8.pi.a1O(aC.data.teamPlayerCount, 0), aC.a3H.a3L(), b8.pi.a1O(aC.data.teamPlayerCount, 0) !== e) && aNT()
		})), pU.push(aLA)
	}(pU), function(pU) {
		var aLA = new pC;
		aLA.pF(L(264)), aLA.pN(new tK({
			tO: ["Battle Royale", "Teams"],
			value: aC.data.gameMode
		}, function(e2) {
			aC.data.gameMode !== e2 && (aC.data.gameMode = e2, aNT())
		})), pU.push(aLA)
	}(pU), pU.push(aNI()), pU.push(aNJ()), pU.push(aNK()), function(pU) {
		var aLA = new pC,
			g = (aLA.pF(L(266)), [L(267), L(268), L(233)]);
		aLA.pL(g[aC.data.playerNamesType]), aLA.pQ(new r4([new v(L(263), function() {
			s.t(23)
		}).button])), pU.push(aLA)
	}(pU), function(pU) {
		var aLA = new pC,
			g = (aLA.pF(L(229)), [L(231), L(232) + ": " + aC.data.aIncomeValue, L(233)]);
		aLA.pL(g[aC.data.aIncomeType]), aLA.pQ(new r4([new v(L(263), function() {
			s.t(22)
		}).button])), pU.push(aLA)
	}(pU), function(pU) {
		var aLA = new pC,
			g = (aLA.pF(L(269)), [L(231), L(232) + ": " + aC.data.tIncomeValue, L(233)]);
		aLA.pL(g[aC.data.tIncomeType]), aLA.pQ(new r4([new v(L(263), function() {
			s.t(26)
		}).button])), pU.push(aLA)
	}(pU), function(pU) {
		var aLA = new pC,
			g = (aLA.pF(L(270)), [L(231), L(232) + ": " + aC.data.iIncomeValue, L(233)]);
		aLA.pL(g[aC.data.iIncomeType]), aLA.pQ(new r4([new v(L(263), function() {
			s.t(27)
		}).button])), pU.push(aLA)
	}(pU), function(pU) {
		var aLA = new pC,
			g = (aLA.pF(L(271)), [L(231), L(232) + ": " + aC.data.sResourcesValue, L(233)]);
		aLA.pL(g[aC.data.sResourcesType]), aLA.pQ(new r4([new v(L(263), function() {
			s.t(28)
		}).button])), pU.push(aLA)
	}(pU), function(pU) {
		var aLA = new pC;
		aLA.pF(L(272)), aLA.pQ(new r4([new v(L(273), function() {
			s.w(), aC.a3H.a3j(), s.x.aFy[0] = 0, s.t(19)
		}).button])), aLA.pQ(new r4([new v(L(274), function() {
			bl.aFn()
		}).button])), aLA.pQ(new r4([new v(L(275), function() {
			return bl.aFp(), !0
		}).button])), pU.push(aLA)
	}(pU), pU))
}
...
function aKn() {
	...
	function aLg() {
		aLi(), 2 !== aC.data.iIncomeType && (aC.data.iIncomeData = null), s.aKr()[19] = null, s.a07()
	}

	function aLi() {
		2 === aC.data.iIncomeType && b8.pi.a1U(aLf.tw(), aC.data.iIncomeData, 255)
	}
	this.show = function() {
		aLd.show(), this.resize()
	}, this.qq = function() {
		...
		2 === ev && aLd.tW[0].pr()
	}, aLd = new tP(L(270), [new v("⬅️ " + L(32), aLg)]), aLe = new pS(aLd.tV, (function(pU) {
		var aLA = new pC;
		aLA.pF(L(230)), aLA.pN(new tK({
			tO: [L(231), L(232), L(233)],
			value: aC.data.iIncomeType
		}, function(e2) {
			aLi(), 2 !== e2 || aC.data.iIncomeData || (aC.data.iIncomeData = new Uint8Array(aC.eX), aC.data.iIncomeData.fill(32)), aC.data.iIncomeType = e2, s.t(27)
		})), pU.push(aLA)
	}(pU = []), function(pU) {
		var aLA;
		1 === aC.data.iIncomeType && ((aLA = new pC).pF("Value"), aLA.pQ(new qO({
			e2: -1,
		...
		var aLA;
		2 === aC.data.iIncomeType && ((aLA = new pC).pF("Data"), (aLf = new tn(0, 1, 0, 1)).tu(b8.zN.a30(aC.data.iIncomeData, 4)), aLA.pQ(aLf), pU.push(aLA))
	}(pU), pU))
}

function aKV() {
	var aNV, aNW, aMd, qN, aNX;
	this.aEe = new rv, aMd = new qB([.45, .27], [.5, .5], 2 / 3), aNW = [new v("⚔️<br>" + L(276), function() {
			aNY(0)
		}, b9.nA), new v("🗡️<br>" + L(260), function() {
			aNY(1)
		}, b9.nS), new v("🔑<br>" + L(277), function() {
			aNY(2)
		}, b9.ni), new v("☰<br>" + L(278), function() {
			aNY(3)
	...
	for (var aA = 0; aA < aNW.length; aA++) aNW[aA].button.style.position = "absolute";

	function aNY(e2) {
		z.a0.setState(10), aa.sE() || aa.aEV(), 0 === e2 ? s.x.a3a() : 1 === e2 ? (b7.aG8.vC(bh.dr.data[156].value, 1) || aC.a3H.a3j(), s.t(19)) : 2 === e2 ? 0 !== z.id || bh.dr.data[140].value ? s.t(8, s.rm, new rn(16)) : s.x.aNZ(s.rm, 16) : 3 ===
			e2 && s.t(1)
	}
	qN.e.style.position = "absolute", qN.e.style.textAlign = "center", qN.e.placeholder = L(279), this.show = function() {
		aZ.setState(0), z.a0.setState(12), this.aEe.show(), aNW[4].pu(b8.color.a1l(bh.dr.data[121].value)), this.resize(), document.body.appendChild(qN.e);
		for (var aA = 0; aA < aNW.length; aA++) document.body.appendChild(aNW[aA].button);
		1 !== z.id || z.f3 < 5 || (aNX && bd.lx > aNX + 144e5 ? z.uF.setState(14) : aNX = bd.lx)
	}, this.qq = function() {
		this.aEe.qq(), document.body.removeChild(qN.e);
		for (var aA = 0; aA < aNW.length; aA++) document.body.removeChild(aNW[aA].button)
	}, this.resize = function() {
		this.aEe.resize(), this.aEe.resize(), aMd.resize();
		var gap = .5 * ba.gap,
			sj = 10 / 99 * .84 * aMd.i,
			aNc = .16 * aMd.j,
			a7X = .19 * aMd.i,
			...
			sj = aMd.ej + sj + 3 * gap,
			i = .5 * (aMd.i - gap) - a7X,
			a7X = aMd.i - 2 * a7X - aNc - gap,
			a7X = (b8.pZ.sD(qN.e, eh, sj, a7X, aNc), b8.pZ.sD(aNW[4].button, eh + a7X + gap, sj, aNc, aNc), .5 * (aMd.ej + aMd.j - (sj += aNc + gap) - gap));
		b8.pZ.sD(aNW[0].button, eh, sj, i, a7X), b8.pZ.sD(aNW[1].button, eh + i + gap, sj, i, a7X), b8.pZ.sD(aNW[2].button, eh, sj + a7X + gap, i, a7X), b8.pZ.sD(aNW[3].button, eh + i + gap, sj + a7X + gap, i, a7X);
		b8.pZ.sD(aNW[5].button, eh, sj + a7X * 2 + gap * 2, i * 2 + gap, a7X / 3);
		b8.pZ.sD(aNW[6].button, eh, sj + a7X * 2.33 + gap * 3, i * 2 + gap, a7X / 3);
		for (var aA = 0; aA < aNW.length; aA++) aNW[aA].button.style.font = b8.pZ.rN(0, b8.pZ.a22(.065 * aMd.j)), b8.pZ.pk(aNW[aA].button, 5);
		qN.e.style.font = b8.pZ.rN(0, b8.pZ.a22(.08 * aMd.j)), b8.pZ.pk(qN.e, 5)
	}, this.te = function() {
		if (aZ.aE7(), aS.te(), aN.te(), bW.te(), aa.sE()) {
			if (__fx.settings.displayWinCounter) {
				const size = Math.floor(aMd.i * 0.03);
			...
			tf.imageSmoothingEnabled = !1;
			var ev = aa.aEA("territorial.io"),
				mJ = .84 * aMd.i / ev.width;
			tf.setTransform(mJ, 0, 0, mJ, aMd.eh + .08 * aMd.i, aMd.ej), aNV = aNV || b8.a15.a2d(ev, b8.a15.a2j, [0, 0, 0]);
			for (var eh = -1; eh <= 1; eh += 2)
				for (var ej = -1; ej <= 1; ej += 2) tf.drawImage(aNV, eh, ej);
			tf.drawImage(ev, 0, 0), tf.imageSmoothingEnabled = !0;
			var hh = aa.aEA("logo"),
				aNe = .6666 * mJ * ev.height / hh.height,
				mK = .5 * h.i,
				mL = aMd.ej + .5 * mJ * ev.height - .5 * aNe * hh.height;
			tf.setTransform(aNe, 0, 0, aNe, mK - .6 * mJ * ev.width, mL), tf.drawImage(hh, 0, 0), tf.setTransform(aNe, 0, 0, aNe, mK + .6 * mJ * ev.width - aNe * hh.width, mL), tf.drawImage(hh, 0, 0), tf.setTransform(1, 0, 0, 1, 0, 0), tf
...
function aKc() {
	...
	this.show = function() {
		...
		aKs.resize(), aNf.resize()
	}, this.a0r = function(ev) {
		2 === ev && aKs.tW[0].pr()
	}, aNg = [new v(L(280), function() {
		aNh(1)
		...
		s.a07()
	})], aKs = new tP(L(286), tQ), aNf = new q8(aNg, aKs.tV)
}

function aAw(title, pM, aNi) {
	var aKs, aMr;
	this.show = function() {
		aKs.show(), this.resize()
	}, this.qq = function() {
		...
		2 === ev && aKs.tW[0].pr()
	}, aNi = aNi || [new v("⬅️ " + L(32), function() {
		s.a07()
	}, b9.nM)], aKs = new tP(title, aNi), aMr = new r3(aKs.tV, pM), b8.pZ.textAlign(aKs.tV.style, 1)
}
...
function aN9(data) {
	...
	function aNk(hk) {
		...
		if (ea) {
			for (var s7, max = min = parseInt(data.data[0][0]), aA = 1; aA < ea; aA++) var aCf = parseInt(data.data[aA][0]),
				min = Math.min(aCf, min),
				max = Math.max(aCf, max);
			s7 = hk < 0 ? min + hk : max + 1, s.t(8, s.aDC().aKQ, new rn(21, {
				s6: data.s6,
				s7: s7,
				s8: s7 + Math.abs(hk)
			}))
	...
	this.show = function() {
			...
			aNk(-10)
		}, ev, 0, 1), new v(L(288), function() {
			aNk(10)
		}, ev, 0, 1), new v(L(238), function() {
			s.t(11, 10, new aNl({
				s6: data.s6
			}))
		})], rc = [L(289), L(290), L(291), L(292), L(293), L(294), L(295), L(296), L(297), L(298), L(285)], aKs = new tP(rc[data.s6], ev),
		function() {
			var aA, ed = {
					rW: []
				},
				...
				aNn = data.data,
				ea = aNn.length;
			ea && 0 === aNn[0][0] && 0 <= (e2 = [0, 1, 2, 3, -1, -1, -1, -1, -1, 4, 5][data.s6]) && (s.x.s9[e2] = aNn[0][1]);
			var mJ = [.1, .001, .01, 1, 100, 1, 1, .1, 100, .01, .01][data.s6],
			...
			if (ed.rc = e2[data.s6], ed.rh = [
				...
				for (aA = 0; aA < ea; aA++) {
					var aNq = aNn[aA][5];
					4 === data.s6 || 8 === data.s6 ? "100%" === (aNq = (aNq % 64 * 100 / (aNq >> 6)).toFixed(0) + "%") && (4 === data.s6 ? aNq += " (" + L(317) + ")" : aNq += " (" + L(318) + ")") : 5 === data.s6 ? 32768 <= aNq && (aNq = -(aNq -
						32768)) : aNq = (mJ * aNq).toFixed(a2n), rW.push([{
						f2: "" + aNn[aA][0],
						dm: 0
					}, {
						f2: "" + aNn[aA][6],
...
function aNl(a2f) {
	...
	this.show = function() {
		...
		2 === ev && aKs.tW[0].pr()
	}, aKs = new tP(L(319), [new v("⬅️ " + L(32), function() {
		s.aKq(10)
	})]), aKt = new pS(aKs.tV, ((pU = []).push(function() {
		var aLI, aLA = new pC,
			aMb = new qO(bh.dr.data[132], 1, function() {
				aLI.button.click()
			}),
			aMc = new qO(bh.dr.data[131], 1, function() {
				aMb.e.focus()
			});
		aLA.pF(L(243)), aLA.pQ(aMc), aMc.e.style.marginBottom = "0.8em", aLA.pF(L(244)), aLA.pQ(aMb);
		return aLI = new v(L(242), function() {
			s7 = Math.floor(aMc.e.value), s8 = Math.floor(aMb.e.value);
			var s8, s7 = {
				a1M: Math.min(s7, s8),
				aK1: Math.max(s7, s8)
			};
			s.t(8, s.aCC(10).aKQ, new rn(21, {
				s6: a2f.s6,
				s7: s7.a1M,
				s8: s7.aK1
			}))
		}, 0, 0, 1), aLA.pQ(new r4([aLI.button])), aLA
	}()), pU.push(function() {
		var aLI, aLA = new pC,
			aMb = new qO(bh.dr.data[134], 1, function() {
				aLI.button.click()
			}),
			aMc = new qO(bh.dr.data[133], 0, function() {
				aMb.e.focus()
			});
		return aLA.pF(1 === a2f.s6 ? L(320) : L(321)), aLA.pQ(aMc), aMc.e.style.marginBottom = "0.8em", aLA.pF(L(322)), aLA.pQ(aMb), aLI = new v(L(242), function() {
			var aN1 = aMc.e.value.slice(0, 20),
				aN2 = Math.abs(Math.floor(aMb.e.value));
			s.t(8, s.aCC(10).aKQ, new rn(22, {
				s6: a2f.s6,
				aN1: aN1,
				aN2: aN2
			}))
		...
		var aLI, aLA = new pC,
			aMb = new qO(bh.dr.data[152], 1, function() {
				aLI.button.click()
			}),
			aMc = new qO(bh.dr.data[151], 0, function() {
				aMb.e.focus()
			});
		return aLA.pF(L(323)), aLA.pQ(aMc), aMc.e.style.marginBottom = "0.8em", aLA.pF(L(322)), aLA.pQ(aMb), aLI = new v(L(242), function() {
			var aN1 = aMc.e.value.slice(0, 5),
				aN2 = Math.abs(Math.floor(aMb.e.value));
			s.t(8, s.aCC(10).aKQ, new rn(28, {
				s6: a2f.s6,
				aN1: aN1,
				aN2: aN2
			}))
...
function aKp() {
	var aNu, sI, aNx, sH, sK, aNv = [new Array(4), [], new Array(2), new Array(2)],
		aNw = new Array(4),
		aNy = new Array(2),
		aNz = [L(56), L(284), L(324), L(325)];

	function aCQ() {
		var a5Z = aNu.sV.qN.e.value.trim().slice(0, 127);
		a5Z.length < 1 || (aNu.sV.qN.e.value = "", bm.aAz.yq(a5Z))
	}

	function aO2(aO4) {
		bm.x.qc[3] = 1 - bm.x.qc[3], aO3(3, 1, bm.x.qc[3]), aO4 && ay.aCb.aCc(4), bm.x.qc[3] && bh.r1.r2(158, bm.x.qc[0])
	}

	function aO0(et, eu) {
		bm.x.qc[et] !== eu && (0 === et && bm.x.qc[3] && aO2(0), aO3(et, bm.x.qc[et], 0), aO3(et, eu, 1), bm.x.qc[et] = eu, 0 === et ? (ay.aCb.aCc(2, eu), bm.x.qc[2] ? (aNu.sW.lR(), aNu.sV.qZ(1)) : aNu.sV.qZ(0), s.aDC().aCF(), s.aDC().aCE()) : 2 ===
			et && (0 === eu ? (ay.aCb.aCc(0), aNu.sV.lR(), aNu.se()) : (ay.aCb.aCc(1), aNu.sW.lR(), aNu.sf())))
	}

	function aO3(et, eu, color) {
		aNu.sY[et].q9[eu].pu(color ? b9.n6 : b9.np)
	}
	...
	this.aCn = function() {
		...
		aO0(2, 0);
		var pG = aNu.sV.qN.e.value,
			rk = "@" + rk + " ";
		pG.length && !b8.zN.a29(pG, " ") && (rk = " " + rk), aNu.sV.qN.e.value = pG += rk, aNu.sV.qN.e.focus()
	}, this.aCD = function() {
		aNu.sW.lR()
	}, this.aCF = function() {
		var aO6 = bm.x.qc[0],
			aO6 = bm.x.qe[aO6];
		bQ.a6(aO6.eG, aO6.mapSeed), sI.q9[0].button.textContent = L(262) + ": " + bQ.vH.vI[aO6.eG].name, sI.q9[1].button.textContent = L(264, 0, "Mode") + ": " + aO7(aO6.aBW), sI.q9[2].button.textContent = L(329) + ": " + bQ.vH.vI[aO6.aDD].name,
			sI.q9[3].button.textContent = L(330, 0, "Next Mode") + ": " + aO7(aO6.aDE), sI.q9[4].button.textContent = L(331) + ": " + aO8(aO6.aCH), sI.resize()
	}, this.aCE = function() {
		var aO6 = bm.x.qc[0],
			qd = bm.x.qe[aO6];
		aNu.sc(qd.sd);
		for (var aA = 0; aA < bm.ss.st.length; aA++) aNv[0][aA].qY.textContent = "" + bm.ss.st[aA].length;
		var ss = bm.ss.st[aO6],
			aO9 = ss.length,
			aOA = bm.ss.su[aO6];
		aNv[2][1].qY.textContent = "" + aO9, aNv[3][1].qY.textContent = "" + aOA, sI.q9[4].button.textContent = L(331) + ": " + aO8(qd.aCH);
		for (aA = 0; aA < 4; aA++) {
			var aOB = bm.x.qe[aA];
			aNw[aA] ? 0 === aOB.sd && (aNw[aA].qY.textContent = bQ.vH.vI[aOB.eG].name) : aNw[aA] = new qX(bQ.vH.vI[aOB.eG].name, sH.q9[aA].button, 1, 1), b8.zN.startsWith(aNz[aA], "🏆 ") ? aOB.aBc || (aNz[aA] = aNz[aA].substring(3), sH.q9[aA]
				.button.textContent = aNz[aA], sH.q9[aA].button.appendChild(aNv[0][aA].qY), sH.q9[aA].button.appendChild(aNw[aA].qY)) : aOB.aBc && (aNz[aA] = "🏆 " + aNz[aA], sH.q9[aA].button.textContent = aNz[aA], sH.q9[aA].button
				.appendChild(aNv[0][aA].qY), sH.q9[aA].button.appendChild(aNw[aA].qY))
		}
		var qd = "",
			aOD = "";
		0 === aO6 && (qd = bm.qj.aBr(ss, 0, aO9), aOD = bm.qj.aBr(ss, 0, aOA)), aNx[0].qY.textContent = qd, aNx[1].qY.textContent = aOD, aNy[1].qY.textContent = "MP: " + bm.x.aC5[0] + "   SP: " + bm.x.aC5[1] + "   Lobby: " + b8.pi.a1Z(bm.ss.st)
	}, this.aCJ = function() {
		aNu.sV.lR()
	}, this.show = function() {
		aNu.show(), this.resize(), bm.message.show()
	}, this.qq = function() {
		aNu.qq(), bm.tE.qq(), bm.sq.qq(), bm.message.qq()
	}, this.resize = function() {
		aNu.resize(1 - bm.x.qc[2]), bm.message.resize()
	}, this.a0r = function(ev) {
		2 === ev ? bm.x.qc[3] ? aO2(1) : aNu.sY[3].q9[0].pr() : ev < 2 && aO2(1)
	}, sH = new r7([new v(aNz[0], function() {
		return aO0(0, 0), 2
	}), new v(aNz[1], function() {
		return aO0(0, 1), 2
	}), new v(aNz[2], function() {
		return aO0(0, 2), 2
	}), new v(aNz[3], function() {
		return aO0(0, 3), 2
	})], b9.np), sI = new r7([new v("", 0, 2), new v("", 0, 2), new v("", 0, 2), new v("", 0, 2), new v("", 0, 2)], b9.nq, 1);
	var aO1 = new r7([new v(L(326), function() {
		return aO0(2, 0), 2
	}), new v(L(110), function() {
		return aO0(2, 1), 2
	})], b9.np);
	sK = new r7([new v(L(327), (__fx.customLobby.setLeaveFunction(() => {
		...
		return aO2(1), 2
	})], b9.np), aNu = new sG(sH, sI, aO1, sK, aCQ, bm.tE.aCw);
	for (var aA = 0; aA < 4; aA++) aNv[0][aA] = new qX("0", sH.q9[aA].button);
	aNv[2][1] = new qX("0", aO1.q9[1].button), aNv[3][1] = new qX("0", sK.q9[1].button), aNx = [new qX("", aO1.q9[1].button, 1, 1), new qX("", sK.q9[1].button, 1, 1)], aO3(0, bm.x.qc[0], 1), aO3(2, bm.x.qc[2], 1), (aNy = [new qX(L(236), aNu.sg(), 1,
		0), new qX("", aNu.sg(), 1, 1)])[0].qY.style.fontSize = "0.4em", aNy[1].qY.style.fontSize = "0.4em"
}
...
function aKW() {
	...
	this.show = function() {
		...
		2 === ev && aKs.tW[0].pr()
	}, aKs = new tP(L(336), [new v("⬅️ " + L(32), function() {
		s.t(7, s.aCC(7).aKQ)
	}), new v(L(188), function() {
		bh.r1.r2(105, bE.rp.v1(aKt.pW[0].pD[0].e.value, 5)), bh.r1.r2(106, bE.rp.v1(aKt.pW[1].pD[0].e.value, 8)), s.t(8, s.aCC(7).aKQ, new rn(18))
	})]), aKt = new pS(aKs.tV, ((pU = []).push(function() {
		var aLA = new pC;
		return aLA.pF(L(169)), aLA.pQ(new qO({
			value: "",
			e2: -1
		})), aLA
	}()), pU.push(function() {
		var aLA = new pC,
			aLJ = (aLA.pF(L(171)), new qO({
				value: "",
				e2: -1
			}));
		return aLJ.e.type = "password", aLA.pQ(aLJ), aLA.pQ(new r4([new v(L(172), function(e) {
			return e.textContent === L(172) ? (e.textContent = L(173), aLJ.e.type = "text") : (e.textContent = L(172), aLJ.e.type = "password"), !0
		}).button])), aLA
	}()), pU))
}
...
function aKd() {
	...
	this.show = function() {
		...
		s.a07()
	})], aKs = new tP(L(337), tQ), aNf = new q8(aNg, aKs.tV)
}

function aKM() {
	this.dr = {}, this.s9 = new Array(6), this.aKb = null, this.aKY = null, this.rT = 0, this.aFy = [0], this.y = function() {
			s.t(5, 5)
		}, this.a3a = function() {
			s.w(), aY.aDn(0), aY.dW()
		},
		__fx.customLobby.setJoinFunction(() => {
			...
			if (1 === bh.dr.data[130].value) s.t(8, s.aDC().aKQ, new rn(24, {
				aM6: bh.dr.data[125].value,
				...
				1 === g.length && 0 === g[0].length && (g = []), s.t(8, s.aDC().aKQ, new rn(23, {
					aM6: bh.dr.data[125].value,
					zQ: g
				}))
			}
		}, this.aNZ = function(aKQ, target) {
			s.t(4, aKQ, new u("Data Usage Information",
				"Do you want your username and other data to be remembered for the next session?<br>The app might not function correctly if you decline data usage.<br>Please read our privacy policy for more information: <a href='" + bI.aOF +
				"' target='_blank'>" + bI.aOF + "</a>", !1, [new v("⬅️ " + L(32), function() {
					s.t(aKQ)
				}), new v("✅ Accept", function() {
					bh.r1.r2(140, 1), 0 === target ? s.t(2, aKQ) : s.t(8, aKQ, new rn(target))
				})]))
		}, this.aOG = function() {
			for (var aA = 0; aA < 6; aA++) this.s9[aA] = bE.us.uw(bF.oa(5));
			this.s9[1] = "[" + this.s9[1] + "]", 5 === s.rm && (s.aDC().aEe.r2(this.s9), s.aDC().resize())
		}
}
...
function aKg() {
	...
	function aOR() {
		aOH.pE.lastChild && aOH.pE.removeChild(aOH.pE.lastChild)
	}

	function aOP() {
		var aOS = bQ.a3g(aC.data);
		aC.data.canvas = bQ.aIV(aOS, aC.data.mapSeed).vR, aOQ()
	}

	function aOQ() {
		var a1e = aC.data.canvas;
		a1e.style.width = "100%", aOH.pE.appendChild(a1e)
	}
	this.aFi = function(a1e) {
		aC.data.canvas && aOR(), aC.data.canvas = a1e, aOQ()
	}, this.show = function() {
		aLd.show(), this.resize()
	}, this.qq = function() {
		aLd.qq()
		...
		2 === ev && aLd.tW[0].pr()
	}, aLd = new tP(L(262), [new v("⬅️ " + L(32), aLg)]), 2 === aC.data.mapType && b4.dW(), aLe = new pS(aLd.tV, (function(pU) {
		var aLA = new pC;
		aLA.pF(L(230)), aLA.pN(new tK({
		...
		})), 2 <= aC.data.mapType && (aLA.pQ(new rE), aLA.pQ(new qy({
		...
		if (0 === aC.data.mapType) {
			for (var aLA = new pC, tO = (aLA.pF(L(262)), []), aA = 0; aA < bQ.vH.aJN.length; aA++) tO.push(bQ.vH.vI[bQ.vH.aJN[aA]].name);
			aLA.pN(new tK({
				tO: tO,
				value: aC.data.mapProceduralIndex
			}, function(e2) {
				aC.data.mapProceduralIndex = e2, aOO()
			})), pU.push(aLA)
		}
	}(pU), function(pU) {
		if (1 === aC.data.mapType) {
			for (var aLA = new pC, tO = (aLA.pF(L(262)), []), aA = 0; aA < bQ.vH.aJO.length; aA++) tO.push(bQ.vH.vI[bQ.vH.aJO[aA]].name);
			aLA.pN(new tK({
				tO: tO,
				value: aC.data.mapRealisticIndex
			}, function(e2) {
				aC.data.mapRealisticIndex = e2, aOO()
			})), pU.push(aLA)
		}
	}(pU), function(pU) {
		var aLA;
		2 === aC.data.mapType && ((aLA = new pC).pF(L(262)), aLA.pQ(new r4([new v(L(343), function() {
			return b4.aFb(), !0
		}).button])), pU.push(aLA))
	}(pU), function(pU) {
		(aOH = new pC).pF(L(344)), 2 !== aC.data.mapType ? aOP() : aC.data.canvas && aOQ();
		pU.push(aOH)
	}(pU), function(pU) {
		var aLA, qN, aLI;
		0 === aC.data.mapType && ((aLA = new pC).pF("Seed"), qN = new qO({
			e2: -1,
			value: aC.data.mapSeed
		}, 1, 0, function(e) {
			e = Math.abs(Math.floor(e.target.value)) % 16384;
			aC.data.mapSeed !== e && (aC.data.mapSeed = e, aOO())
		}), aLI = new v(L(255), function(e) {
			var aIQ = Math.floor(16384 * Math.random());
			if (aC.data.mapSeed !== aIQ) return qN.e.value = aC.data.mapSeed = aIQ, aOO(), !0
		}), aLA.pQ(qN), aLA.pQ(new r4([aLI.button])), pU.push(aLA))
	}(pU), function(pU) {
		var aLA, qN;
		2 === aC.data.mapType && ((aLA = new pC).pF(L(345)), qN = new qO({
			e2: -1,
			value: aC.data.mapName
		}, 0, 0, function(e) {
			aC.data.mapName = e.target.value = e.target.value.slice(0, 20)
		}), aLA.pQ(qN), pU.push(aLA))
	}(pU), pU))
}

function u(title, pM, aOT, aNi) {
	var aKs, aMr;
	this.show = function() {
		aKs.show(), this.resize()
	}, this.qq = function() {
		...
		s.a07()
	})], aKs = new tP(title, aNi), aMr = new r3(aKs.tV, pM), aOT && b8.pZ.textAlign(aKs.tV.style, 1)
}
...
function aKj() {
	...
	function aLg() {
		aLi(), 2 === aC.data.playerNamesType && 1 === b8.pi.a1I(aC.data.playerNamesData).length && (aC.data.playerNamesType = 0), 2 !== aC.data.playerNamesType && (aC.data.playerNamesData = null), s.aKr()[19] = null, s.a07()
	}

	function aLi() {
		2 === aC.data.playerNamesType && b8.pi.a1W(aLf.tw(), aC.data.playerNamesData, 20)
	}
	this.show = function() {
		aLd.show(), this.resize()
	}, this.qq = function() {
		...
		2 === ev && aLd.tW[0].pr()
	}, aLd = new tP(L(266), [new v("⬅️ " + L(32), aLg)]), aLe = new pS(aLd.tV, (function(pU) {
		var aLA = new pC;
		aLA.pF(L(230)), aLA.pN(new tK({
			tO: [L(267), L(268), L(233)],
			value: aC.data.playerNamesType
		}, function(e2) {
			aLi(), aC.data.playerNamesType = e2, s.t(23)
		})), aLA.pQ(new rE), aLA.pQ(new qy({
		...
		var aLA;
		2 === aC.data.playerNamesType && ((aLA = new pC).pF("Data"), aLf = new tn(0, 1, 0, 1), aC.data.playerNamesData && aC.data.playerNamesData.length === aC.eX || (aC.data.playerNamesData = new Array(aC.eX), aC.data.playerNamesData
			.fill("")), aLf.tu(b8.zN.a30(aC.data.playerNamesData, 1, '"')), aLA.pQ(aLf), pU.push(aLA))
	}(pU), pU))
}
...
function aKU() {
	...
	function aOU() {
		s.w();
		var pG = b7.aOY(ts.tw());
		(aC.ym && 0 < pG.length && pG === b7.op.a3W || b7.aG8.vC(pG)) && b7.aOZ()
	}
	this.show = function(aOV) {
		this.aOW(aOV), aLd.show(), this.resize()
	}, this.aOW = function(aOV) {
		0 === aC.ym ? aOV ? ts.tu(aOV) : b7.op.a3W.length && ts.tu(b7.op.a3W) : (aC.gk || (b7.op.a3W = b7.a3X.yF()), ts.tu(b7.aOX(b7.op.a3W)))
	}, this.qq = function() {
		aLd.qq()
	}, this.resize = function() {
		aLd.resize(), ts.resize()
	}, this.a0r = function(ev) {
		2 === ev ? aLd.tW[0].pr() : aOU()
	}, aLd = new tP(L(347), [new v("⬅️ " + L(32), function() {
		s.aKq(1)
		...
		aOU()
	})]), ts = new tn(L(352)), aLd.tV.appendChild(ts.e)
}

function aKT() {
	var aKs, aKt, pU, aAU, aLA;

	function aOa() {
		var lx;
		aAU !== bh.dr.data[12].value ? (b5.dW(), b5.aAT(), lx = bd.lx, s.t(4, 1, new u(L(355), L(356), !1, [new v("⬅️ " + L(32), function() {
			s.t(1)
		}), new v("🔄 Reload", function() {
	...
	this.show = function() {
			aAU = bh.dr.data[12].value, aKs.show(), this.resize()
		}, this.qq = function() {
			aKs.qq()
		}, this.resize = function() {
			aKs.resize(), aKt.resize()
			...
			2 === ev && aKs.tW[0].pr()
		}, aKs = new tP(L(353), [new v("⬅️ " + L(32), aOa), new v(L(354), function() {
			s.w(), bh.r1.uZ(), s.t(2)
		})]), pU = [], (aLA = new pC).pF(L(357)), aLA.pH(L(358)), pU.push(aLA),
		function(pU) {
			var aLA = new pC,
				g = (aLA.pF(L(376)), b5.data.aAc());
			aLA.pN(new tK({
				tO: g,
				value: b5.data.aAg(g)
			}, function(e2) {
		...
		function(pU) {
			var aLA = new pC,
				aOd = (aLA.pF(L(374)), []);
			aLA.pQ(new r4([new v(L(375), function(e) {
				bV.aOe();
				for (var aA = 0; aA < aOd.length; aA++) aOd[aA].e.value = bV.a9u[aA];
				return b8.pZ.a28(e), !0
			}).button]));
			for (var aA = 0; aA < bV.aOf.length; aA++) {
				aLA.pH(bV.aOf[aA]);
				for (var et = 0; et < 2; et++) {
					...
					qN.e.aOg = e2, aOd.push(qN), qN.e.addEventListener("keydown", function(e) {
						e.preventDefault();
						var code = e.code;
						e.target.value = code, bV.aOh(e.target.aOg, code)
					}), et && (qN.e.style.marginLeft = "4%"), qN.e.style.width = "48%", aLA.pQ(qN)
				}
			}
			pU.push(aLA)
		}(pU), (aLA = new pC).pF(L(359)), bh.dr.data[1].tO = [L(360), L(361), L(362), L(363)], aLA.pN(new tK(bh.dr.data[1])), pU.push(aLA), (aLA = new pC).pF(L(364)), bh.dr.data[9].tO = [L(361), L(365), L(366)], aLA.pN(new tK(bh.dr.data[9])), pU
		.push(aLA), (aLA = new pC).pF(L(367)), bh.dr.data[11].tO = [L(368), L(9), L(369)], aLA.pN(new tK(bh.dr.data[11])), pU.push(aLA), (aLA = new pC).pF(L(370)), aLA.pQ(new qy(bh.dr.data[2])), pU.push(aLA), (aLA = new pC).pF(L(371)), aLA.pQ(new qy(
			bh.dr.data[7])), pU.push(aLA), (aLA = new pC).pF(L(372)), aLA.pQ(new qy(bh.dr.data[8])), pU.push(aLA), (aLA = new pC).pF(L(373)), aLA.pQ(new qO(bh.dr.data[5])), pU.push(aLA), aKt = new pS(aKs.tV, pU)
}
...
function aKk() {
	...
	function aLg() {
		aLi(), 2 !== aC.data.spawningType || b8.pi.a1I(aC.data.spawningData) || (aC.data.spawningType = 0), 2 !== aC.data.spawningType && (aC.data.spawningData = null), s.aKr()[19] = null, s.a07()
	}

	function aLi() {
		2 === aC.data.spawningType && b8.pi.a1U(aLf.tw(), aC.data.spawningData, bQ.aFk - 1)
	}
	this.show = function() {
		aLd.show(), this.resize()
	}, this.qq = function() {
		...
		2 === ev && aLd.tW[0].pr()
	}, aLd = new tP(L(377), [new v("⬅️ " + L(32), aLg)]), aLe = new pS(aLd.tV, (function(pU) {
		var aLA = new pC,
			tO = (aLA.pF(L(230)), [L(255), L(265), L(233)]),
		...
		aLA.pN(new tK({
			...
			aLi(), aC.data.spawningType = e2, 0 === aC.data.gameMode && 1 === e2 && (aC.data.spawningType = 2), 2 !== aC.data.spawningType || aC.data.spawningData || (aC.data.spawningData = new Uint16Array(2 * aC.eX)), s.t(24)
		})), aLA.pQ(new rE), aLA.pQ(new qy({
		...
		var aLA;
		2 === aC.data.spawningType && ((aLA = new pC).pF("Data"), (aLf = new tn(0, 1, 0, 1)).tu(b8.zN.a30(aC.data.spawningData, 2)), aLA.pQ(aLf), pU.push(aLA))
	}(pU), pU))
}
...
function aKS() {
	...
	function aOi(id) {
		0 !== z.id || bh.dr.data[140].value ? 0 === id ? s.t(8, 1, new rn(16)) : s.t(2) : s.x.aNZ(s.rm, 0 === id ? 16 : 0)
	}
	this.show = function() {
		z.a0.setState(12), aKs.show(), this.resize(), this.ik()
	}, this.qq = function() {
		aKs.qq()
	}, this.resize = function() {
		aKs.resize(), aNf.resize()
	}, this.ik = function() {
		8 === aZ.zx() && (2 <= bb.aOn ? aNg[2].ps === b9.mt && aNg[2].pu(0) : aNg[2].ps !== b9.mt && aNg[2].pu(b9.mt), !aC.gk && aL.pA(aC.eK) ? aNg[1].ps === b9.mt && aNg[1].pu(0) : aNg[1].ps !== b9.mt && aNg[1].pu(b9.mt), !aC.gk && au.hL(aC
			.eK) ? aNg[0].ps === b9.mt && aNg[0].pu(0) : aNg[0].ps !== b9.mt && aNg[0].pu(b9.mt))
	}, this.a0r = function(ev) {
		2 === ev && aKs.tW[0].pr()
	}, aNg = [new v(L(379), function() {
		aOi(0)
		...
		s.t(4, 1, new u(L(382), b8.pZ.a23([L(391), L(392), "Discord", L(393), L(280), L(394), L(110), L(395), L(396), L(397)], [bI.aAt, bI.zs, bI.aAu, bI.aOo, bI.aOp, bI.zY, bI.aOq, bI.aOr, bI.aOs, bI.aOF]), !1, [new v("⬅️ " + L(32),
			function() {
				s.t(1)
			})]))
	}), new v(L(383), function() {
		s.t(4, 1, new u(L(383), dj + "<br><a href='" + bI.aOo + "' target='_blank'>" + bI.aOo + "</a>" +
		...
		z.a0.zm(), s.t(4, 1, new u(L(401), L(402) + " <a href='" + bI.aOF + "' target='_blank'>" + bI.aOF + "</a>", !1, [new v("⬅️ " + L(32), function() {
			s.t(1)
		})]))
	})], tQ = [new v("⬅️ " + L(32), function() {
		s.x.aAY()
	})], 8 === aZ.zx() && (aNg.unshift(new v(L(388), function() {
		2 <= bb.aOn && (s.w(), bc.a0u(), bd.de = !0)
	}, 0, 1)), aNg.unshift(new v(L(389), function() {
		!aC.gk && aL.pA(aC.eK) && (b6.gx.oH(), s.w(), aL.gl) && aL.a0u()
	}, 0, 1)), aNg.unshift(new v(L(390), function() {
		!aC.gk && au.hL(aC.eK) && (bT.a42(2), b6.gx.hH(), s.w(), aL.gl) && aL.a0u()
	}, 0, 1))), 1 === z.id && 5 <= z.f3 && aNg.push(new v(L(386), function() {
		z.a0.zn()
	})), aKs = new tP(L(387), tQ), aNf = new q8(aNg, aKs.tV)
}
...
function aKo() {
	...
	function aLg() {
		aLi(), 2 !== aC.data.sResourcesType && (aC.data.sResourcesData = null), s.aKr()[19] = null, s.a07()
	}

	function aLi() {
		2 === aC.data.sResourcesType && b8.pi.a1U(aLf.tw(), aC.data.sResourcesData, 2047)
	}
	this.show = function() {
		aLd.show(), this.resize()
	}, this.qq = function() {
		...
		2 === ev && aLd.tW[0].pr()
	}, aLd = new tP(L(271), [new v("⬅️ " + L(32), aLg)]), aLe = new pS(aLd.tV, (function(pU) {
		var aLA = new pC;
		aLA.pF(L(230)), aLA.pN(new tK({
			tO: [L(231), L(232), L(233)],
			value: aC.data.sResourcesType
		}, function(e2) {
			aLi(), 2 !== e2 || aC.data.sResourcesData || (aC.data.sResourcesData = new Uint16Array(aC.eX)), aC.data.sResourcesType = e2, s.t(28)
		})), pU.push(aLA)
	}(pU = []), function(pU) {
		var aLA;
		1 === aC.data.sResourcesType && ((aLA = new pC).pF("Value"), aLA.pQ(new qO({
			e2: -1,
		...
		var aLA;
		2 === aC.data.sResourcesType && ((aLA = new pC).pF("Data"), (aLf = new tn(0, 1, 0, 1)).tu(b8.zN.a30(aC.data.sResourcesData, 2)), aLA.pQ(aLf), pU.push(aLA))
	}(pU), pU))
}
...
function aKm() {
	...
	function aLg() {
		aLi(), 2 !== aC.data.tIncomeType && (aC.data.tIncomeData = null), s.aKr()[19] = null, s.a07()
	}

	function aLi() {
		2 === aC.data.tIncomeType && b8.pi.a1U(aLf.tw(), aC.data.tIncomeData, 255)
	}
	this.show = function() {
		aLd.show(), this.resize()
	}, this.qq = function() {
		...
		2 === ev && aLd.tW[0].pr()
	}, aLd = new tP(L(269), [new v("⬅️ " + L(32), aLg)]), aLe = new pS(aLd.tV, (function(pU) {
		var aLA = new pC;
		aLA.pF(L(230)), aLA.pN(new tK({
			tO: [L(231), L(232), L(233)],
			value: aC.data.tIncomeType
		}, function(e2) {
			aLi(), 2 !== e2 || aC.data.tIncomeData || (aC.data.tIncomeData = new Uint8Array(aC.eX), aC.data.tIncomeData.fill(32)), aC.data.tIncomeType = e2, s.t(26)
		})), pU.push(aLA)
	}(pU = []), function(pU) {
		var aLA;
		1 === aC.data.tIncomeType && ((aLA = new pC).pF("Value"), aLA.pQ(new qO({
			e2: -1,
		...
		var aLA;
		2 === aC.data.tIncomeType && ((aLA = new pC).pF("Data"), (aLf = new tn(0, 1, 0, 1)).tu(b8.zN.a30(aC.data.tIncomeData, 4)), aLA.pQ(aLf), pU.push(aLA))
	}(pU), pU))
}
...
function aKe() {
	...
	this.show = function() {
		...
		2 === ev && aKs.tW[0].pr()
	}, aKs = new tP(L(381), [new v("⬅️ " + L(32), function() {
		s.a07()
	})]), aKt = new pS(aKs.tV, ((pU = []).push(function() {
		function aLF() {
			aOx.button.textContent = L(166), aOv.e.readOnly = !1, aOw.e.readOnly = !1, aLE.pu(1), aLE.button.style.color = b9.mh
		}
		var aLA = new pC,
			aOu = (aLA.pF(L(403)), new qO({
				value: bh.dr.data[105].value,
				e2: -1
			})),
			aOv = (aOu.e.readOnly = !0, aLA.pQ(aOu), aLA.pF(L(310), "0.8em"), new qO(bh.dr.data[148])),
			aOv = new qO(bh.dr.data[148], 0, void 0, function(e) {
				aLD(bh.dr.data[149].value, e.target.value)
			}),
			aOw = (aLA.pQ(aOv), aLA.pF(L(314), "0.8em"), new qO(bh.dr.data[149], 1, void 0, function(e) {
				aLD(e.target.value, bh.dr.data[148].value)
			})),
			aOx = (aLA.pQ(aOw), new v(L(166), function(e) {
				return e.textContent === L(166) ? (e.textContent = L(167), aOv.e.readOnly = !0, aOw.e.readOnly = !0, aLE.pu(0), aLE.button.style.color = b9.nd, bh.r1.r2(149, aOw.e.value), aLD(bh.dr.data[149].value, bh.dr.data[
					148].value)) : aLF(), !0
			})),
			aLE = (aLA.pQ(new r4([aOx.button])), new v(L(14), function(e) {
				return aOv.e.readOnly && ay.x.aDl(0) && (b8.pZ.a28(e), aLF(), ay.aLG.aLH({
					ro: 0,
					rk: bh.dr.data[148].value,
					value: bh.dr.data[149].value
				})), !0
			}, 1)),
			pI = (aLA.pQ(new r4([aLE.button])), aLA.pH()),
			aLD = function(f2, pG) {
				f2 = b8.fw.a2c(f2, 2, 1e6), pI.textContent = L(168, [f2, bh.dr.data[105].value, pG, f2 - 1])
			};
		return aLD(bh.dr.data[149].value, bh.dr.data[148].value), aLA
	}()), pU))
}
...
function cd() {
	var a7l, aOz, aP0, aP1, aOy = !1;

	function aP2() {
		aOy = !0, a7l = -1, aOz = new Array(4);
		for (var aA = 3; 0 <= aA; aA--) aOz[aA] = !1;
		var wI = Math.floor(1 + .02 * h.min);
		aP0 = new Array(4), (aP1 = new Array(4))[1] = aP1[3] = aP0[0] = aP0[2] = 0, aP1[0] = aP0[3] = -wI, aP0[1] = aP1[2] = wI
	}

	function aP3() {
		if (-1 !== a7l)
			if (0 !== aC.ym && aG.mP()) {
				for (var aP4 = !1, aA = 3; 0 <= aA; aA--) aOz[aA] && (aP4 = !0, iB += aP0[aA], iD += aP1[aA], ae.a0J(aP0[aA], aP1[aA]), aR.a7T());
				aP4 ? bd.de = !0 : ap.mF()
			} else ap.mF()
	}
	this.a0p = function(e2) {
		0 !== aC.ym && aG.mP() && (aOy || aP2(), aOz[e2] = !0, -1 === a7l) && (a7l = setInterval(aP3, 20), aP3())
	}, this.a0s = function(e2) {
		if (0 !== aC.ym && (aOy || aP2(), aOz[e2] = !1, -1 !== a7l)) {
			for (var aP4 = !1, aA = 3; 0 <= aA; aA--) aP4 = aP4 || aOz[aA];
			aP4 || this.mF()
		}
	}, this.mF = function() {
		if (aOy && -1 !== a7l) {
...
function ce() {
	this.x = new aP5, this.lM = new aP6, this.ny = new aP7, this.aCb = new aP8, this.aAV = new aP9, this.aLG = new aPA, this.oZ = new aPB, this.aMy = new aPC, this.a5F = new aPD, this.aPE = new aPF, this.aPG = new aPH, this.aPI = new aPJ, this.aPK =
		new aPL, this.dW = function() {
			this.x.dW()
		}
}
...
function aP5() {
	var aPM, aPO;
	this.aEO = 5, this.aEI = this.aEO - 1, this.aDq = this.aEO + this.aEI, this.aDp = [0, 1, 5, 2, 6, 3, 7, 4, 8], this.aPN = null;

	function aPW(aA) {
		return aPO[aA].aOy && aPM[aA].aPW()
	}

	function aPY(zu) {
		aPO[zu].lx = bd.lx, aPO[zu].aPQ = !1
	}
	this.a03 = 0, this.a02 = 0, this.dW = function() {
		this.aPN = new Array(this.aEO);
		this.aPN[0] = "territorial.io";
		var aA, aIQ = aw.aIl(0);
		for (aw.a3M(0), aA = 1; aA < this.aEO; aA++) this.aPN[aA] = aJ.yL() + ".territorial.io";
		for (aw.a3M(aIQ), aPM = new Array(this.aDq), aPO = new Array(this.aDq), aA = this.aDq - 1; 0 <= aA; aA--) aPO[aA] = {
			aOy: !1,
			lx: 0,
			aPQ: !1
		};
		...
		return this.a02 < this.aEO ? this.a02 : this.a02 - this.aEI
	}, this.ik = function() {
		for (var aA = this.aDq - 1; 0 <= aA; aA--) this.aDl(aA) && bd.lx > aPO[aA].lx + 15e3 && ay.ny.aPT(aA, aPO[aA].aPQ);
		!this.aDl(0) && bd.lx > aPO[0].lx + 8e3 && (aPO[0].lx = bd.lx, this.aDr(0, 0))
	}, this.aMu = function(id) {
		return this.aDr(0, id) && this.aPU(0)
	}, this.aDr = function(zu, aKQ) {
		if (aPO[zu].aOy) {
			if (aPM[zu].aPW()) return aPM[zu].aPX(aKQ), aPM[zu].aDl();
			aPM[zu].qq()
		}
		return this.aPV(zu, aKQ), !1
	}, this.aPV = function(zu, aKQ) {
		aPO[zu].aOy = !0, aPY(zu), aPM[zu] = new aPZ, aPM[zu].dW(zu, aKQ)
	}, this.aPX = function(zu, aKQ) {
		aPW(zu) && aPM[zu].aPX(aKQ)
	}, this.aPa = function(zu, aKQ) {
		ay.aAV.aPb(zu)
	}, this.aPU = function(aA) {
		return this.aDl(aA) && aPM[aA].aPU()
	}, this.aPc = function(aA) {
		aPM[aA].aPc()
	}, this.aDl = function(aA) {
		return aPO[aA].aOy && aPM[aA].aDl()
	}, this.send = function(zu, aB) {
		aPY(zu), aPM[zu].send(aB)
	}, __fx.customLobby.setSendFunction(this.send), this.a0a = function(zu) {
		8 === aZ.zx() && (aPO[zu].aPQ = !0, ay.lM.aPd = !0)
	}, this.close = function(zu, aPe) {
		aPW(zu) && aPM[zu].close(aPe)
	}, this.aPf = function(zu, aPe) {
		q.a08(aPe), aPW(zu) && aPM[zu].close(aPe)
	}, this.a09 = function(aPe) {
		for (var aA = this.aDq - 1; 0 <= aA; aA--) this.close(aA, aPe)
	}, this.aPg = function(zu, aPe) {
		for (var aA = this.aDq - 1; 0 <= aA; aA--) aA !== zu && this.close(aA, aPe)
	}, this.a3Y = function() {
		this.close(this.a03, 3246)
	}, this.aPh = function(zu, e) {
		aPM[zu].qq(), q.zt(zu, e.code)
	}
}

function aP6() {
	this.aPd = !1, this.ik = function() {
		bd.jn() % 250 != 249 || aC.gk || (ay.aAV.aPi(+(this.aPd && af.le[aC.eK]), ak.jr + bL.x.on), this.aPd = !1)
	}
}
...
function aPD() {
	function aQ9(aQA) {
		var ed = aC.data,
			aQA = (ed.selectedPlayer = bF.oa(aQA), ed.spawningSeed = bF.oa(14), bF.oa(4)),
			aQA = (aQA < 7 ? (ed.gameMode = 1, ed.numberTeams = aQA + 2) : 9 === aQA ? (ed.gameMode = ed.isZombieMode = 1, ed.numberTeams = 2) : (ed.gameMode = 0, ed.battleRoyaleMode = 7 === aQA ? 0 : 10 === aQA ? 1 : 2), ed.isContest = bF.oa(1), bF
				.oa(6));
		return ed.mapType = bQ.aBd(aQA) ? 0 : 1, bQ.aBe(ed, aQA), ed.mapSeed = bF.oa(14), aQA
	}
	this.aPk = function(zu, aB) {
		bF.dW(aB), 0 === bF.size ? ay.x.aPf(zu, 3205) : __fx.customLobby.isCustomMessage(aB) || ((0 === bF.oa(1) ? function(zu) {
			var aPo = bF.oa(6);
			0 === aPo ? function(zu) {
					if (0 === zu && 8 !== aZ.zx()) {
						s.x.aOG();
						for (var aQ1 = bF.oa(12), aQ2 = bF.oa(6), g = new Array(aQ1), aA = 0; aA < aQ1; aA++) g[aA] = bF.oa(aQ2);
						aS.a7s(g)
					}
				}(zu) : 2 === aPo ? ay.aPE.aPq(zu) : 3 === aPo || 4 === aPo ? av.dW() : 9 === aPo ? ay.aPG.aPr(zu) : 10 === aPo ? ay.aPI.aPs() : 11 === aPo ? ay.aPG.aPt(zu) : 12 === aPo ? ay.aPI.aPu() : 13 === aPo ? ay.aPK.aPv() :
				14 === aPo ? ay.aPK.aPw() : 15 === aPo ? ay.aPG.aPx() : 16 === aPo ? ay.aPE.aPy(zu) : 17 === aPo ? ay.aPE.aPz(zu) : 19 === aPo && ay.aPE.aQ0(zu)
		} : function(zu) {
			if (8 !== aZ.zx() && !av.aEP()) return;
			if (zu !== ay.x.a03) ay.x.aPf(zu, 3244);
			else if (0 === bF.oa(1)) bd.yv.aQB(bF.aB);
			else {
				var aA, zu = bF.oa(2);
				if (0 === zu) {
					var oC, ny = bF.oa(9);
					...
					var ny = bF.oa(9);
					0 !== af.le[ny] && 0 !== af.le[aC.eK] && b3.aIA(0, [ny], !0) && aM.oS(ny, 1)
				}();
				else if (2 === zu) ! function() {
					var ny = bF.oa(9),
						target = bF.oa(9);
					0 !== af.le[ny] && 0 !== af.le[target] && 0 !== af.le[aC.eK] && b3.aIA(1, [ny], !0) && (ae.p8(ny, 3, 96), ae.p8(target, 4, 96), aM.a5M(ny, target))
				}();
				else if (a8 && !a9) {
					var ea = 540;
					for (bB.a6(17287), bB.a7(1, 0), bB.a7(6, 10), ea = Math.min(b6.nv.oc.length, 540), aA = 0; aA < ea; aA++) bB.aQH(32, b6.nv.oc[aA]);
					ay.x.send(ay.x.a03, bB.aB)
				}
			}
		})(zu), bd.aPn())
	}, this.aQ3 = function(aB) {
		if (bF.dW(aB), bF.e2 = 1, 3 === bF.oa(6)) {
			...
			aZ.aE3(), bQ.a6(aB, ed.mapSeed), aC.a3K()
		} else ! function() {
			bF.e2 += 20;
			var ed = aC.data = new a3G,
				aQ8 = aQ9(1);
			...
			aZ.aE3(), bQ.a6(aQ8, ed.mapSeed), aC.a3K()
		}()
	}, this.aQ6 = function() {
		bF.e2 = 1;
		var aPo = bF.oa(6),
			aQ7 = bF.oa(10);
		return ay.x.a02 > ay.x.aEI && (aQ7 += ay.x.aEI), ay.x.a02 === aQ7 ? (ay.x.a03 = aQ7, !1) : (ay.x.close(ay.x.a02, 3247), ay.x.a03 = aQ7, av.aBa = bF.oa(10), av.aEB = bF.oa(3 === aPo ? 9 : 1), ay.x.aDr(aQ7, 5) && ay.ny.aEJ(), !0)
	}
}
...
function aPJ() {
	this.aPs = function() {
		...
		var aQK, aQL, aQM, aQN, aQJ;
		bF.size < bB.aQI(29) ? ay.x.aPf(0, 3254) : (aQJ = bF.oa(5), aQK = bF.oa(3), aQL = bF.oa(3), aQM = bF.oa(3), aQN = bF.oa(8), bF.aQO(197 + 16 * (aQJ + aQK + aQL + aQM + aQN) + 32 + 32 + 30 + 128 + 32 + 30 + 32 + 2 + 10 + 5 + 30 + 30 + 32) ?
			(aQJ = {
				rl: bF.oa(30),
				ud: bF.oa(16),
				ue: bF.oa(30),
				...
				aLM: bF.oa(30),
				aLN: bF.aQP(32)
			}, 8 === s.rm && (25 === s.aDC().aMt ? (aQJ.aKu = !0, s.x.aKb = aQJ, s.aDC().aN8(25, !1)) : (aQJ.aKu = !1, aQJ.rk = bh.dr.data[105].value, s.x.aKY = aQJ, bh.r1.uc(aQJ), s.aDC().aN8(16, !0)))) : ay.x.aPf(0, 3267))
	}
}
...
function aPL() {
	this.aPv = function() {
		var aA;
		if (bF.size < bB.aQI(39)) ay.x.aPf(0, 3259);
		else {
			var s6 = bF.oa(6),
				ea = bF.oa(10),
				data = [];
			if (9 === s6 || 10 === s6) {
				for (aA = 0; aA < ea; aA++) data.push([bF.oa(30), bE.uu.vC(5), bF.aQP(32), 0, bF.oa(30)]);
				8 === s.rm && s.aDC().aN8(21, !0, {
					s6: s6,
					data: data
				})
			} else {
				var hT = bF.oa(16);
				if (bF.aQO(39 + 16 * hT + ea * (0 === s6 ? 111 : 1 === s6 ? 101 : 2 === s6 || 3 === s6 ? 127 : 212))) {
					if (0 === s6)
						...
						for (aA = 0; aA < ea; aA++) data.push([bF.oa(30), bE.us.uw(bF.oa(5)), bF.aQP(32), bF.oa(30), bF.oa(30)]);
					else
						for (aA = 0; aA < ea; aA++) data.push([bF.oa(20), bF.oa(30), bF.oa(30), bF.oa(30), bF.oa(30), bF.aQP(32), bF.oa(30), bE.us.uw(bF.oa(5)), bE.us.uw(bF.oa(5))]);
					8 === s.rm && s.aDC().aN8(21, !0, {
						s6: s6,
						data: data
					})
				} else ay.x.aPf(0, 3260)
			}
		}
	}, this.aPw = function() {
		if (bF.size < bB.aQI(29)) ay.x.aPf(0, 3265);
		else {
			var aQQ = bF.oa(4),
				aQR = bF.oa(7),
				aQS = bF.oa(11);
			if (bF.aQO(29 + 16 * aQR + 16 * aQS + 11 * aQQ)) {
				for (var data = [], aA = 0; aA < aQQ; aA++) {
					for (var zR = bE.us.uw(bF.oa(3)), aQT = bF.oa(8), aM7 = [], et = 0; et < aQT; et++) aM7.push(bF.oa(16));
					data.push({
						name: "[" + zR + "]",
						aM7: aM7
					})
				}
				8 === s.rm && s.aDC().aN8(23, !0, data)
			} else ay.x.aPf(0, 3266)
		}
	}
}
	...
	this.aPq = function(zu) {
		if (zu !== ay.x.a02) ay.x.close(zu, 3239);
			...
			for (var aA = 0; aA < 4; aA++) {
				var qd = bm.x.qe[aA],
					playerCount = (qd.sd = bF.oa(10), qd.eG = bF.oa(6), qd.mapSeed = bF.oa(14), qd.aBW = bF.oa(4), qd.aDD = bF.oa(6), qd.aDE = bF.oa(4), qd.aBc = bF.oa(1), qd.aCH = bF.oa(12), qd.spawningSeed = bF.oa(14), bF.oa(16));
		...
		if (zu !== ay.x.a02) ay.x.close(zu, 3239);
			...
			bm.x.aC5[0] = bF.oa(20), bm.x.aC5[1] = bF.oa(20);
			for (var aQU = bF.oa(16), et = 0; et < aQU; et++) {
				var id = bF.oa(3);
			...
			for (var aA = 0; aA < 4; aA++) {
				...
				if (qd.sd = bF.oa(10), 0 === qd.sd) {
					...
					qd.eG = bF.oa(6), qd.mapSeed = bF.oa(14), qd.aBW = bF.oa(4), qd.aDD = bF.oa(6), qd.aDE = bF.oa(4), qd.aBc = bF.oa(1), qd.aCH = bF.oa(12), qd.spawningSeed = bF.oa(14)
				}
			}
			bm.x.aC9()
		...
		if (zu !== ay.x.a02) ay.x.close(zu, 3272);
			...
			for (var qb = bF.oa(4), qd = bm.x.qe[qb], qf = qd.qf, t7 = (qd.qg = bF.oa(20), bF.oa(6)), aA = 0; aA < t7; aA++) qf.push(aQV());
			bm.x.aCI(qb)
		} else ay.x.close(zu, 3273)
	}, this.aQ0 = function(zu) {
		zu !== ay.x.a02 ? ay.x.close(zu, 3276) : bm.a01 ? bm.message.aCd(aQV()) : ay.x.close(zu, 3277)
	}
}
...
function aPH() {
	this.aPr = function(zu) {
		var aQD, q6;
		bF.aQO(70) ? (aQD = bF.oa(3), q6 = bg.aQW.ik(bF.oa(30), bF.oa(30)), ay.aAV.aQX(zu, q6, aQD), 0 < aQD || (0 === zu && 0 === bh.dr.data[105].value.length ? ay.aAV.aMx(0) : ay.aLG.aQY(zu), 4 === ay.x.aPR(zu).aQZ() ? 6 === aZ.zx() && ay.aCb
			.aDs(zu) : 5 !== ay.x.aPR(zu).aQZ() || 8 !== aZ.zx() && 10 !== aZ.zx() || ay.ny.aEJ())) : ay.x.aPf(zu, 3269)
	}, this.aPt = function(zu) {
		var id = bF.oa(6);
		0 === id ? (ay.x.aPc(zu), aS.a7o || ay.aAV.aMx(1), b5.aAT(), 8 === s.rm && s.aDC().aN7()) : 21 === id ? 8 === s.rm && s.aDC().aN8(17) : 22 === id && (bh.r1.r2(106, bh.dr.data[110].value), bh.r1.r2(110, ""), 8 === s.rm) && s.aDC().aN8(16)
	}, this.aPx = function() {
		var ea = bF.oa(16),
			aQa = bF.oa(16);
		if (bF.aQO(55 + 10 * ea + 16 * aQa)) {
			for (var g = [], aA = 0; aA < ea; aA++) g.push(bE.us.uw(bF.oa(10)));
			b5.aAX(g)
		} else ay.x.aPf(0, 3270)
	}
}

function aP7() {
	this.aPT = function(zu, aPQ) {
		bB.a6(8), bB.a7(1, 0), bB.a7(6, 4), bB.a7(1, aPQ ? 1 : 0), ay.x.send(zu, bB.aB)
	}, this.aEJ = function() {
		bB.a6(58), bB.a7(1, 0), bB.a7(6, 5), bB.a7(8, ay.x.aPS()), bB.a7(10, av.aBa), bB.a7(9, av.aEB), bB.a7(10, dk), bB.a7(14, l.dl), ay.x.send(ay.x.a03, bB.aB)
	}, this.nz = function(eM) {
	...
	}, this.oQ = function(aQb, aQc) {
		bB.a6(24), bB.a7(1, 1), bB.a7(4, 15), bB.a7(9, aQc), bB.a7(10, aQb), ay.x.send(ay.x.a03, bB.aB)
	}, this.oT = function(a5F) {
		bB.a6(14), bB.a7(1, 1), bB.a7(4, 14), bB.a7(9, a5F), ay.x.send(ay.x.a03, bB.aB)
	}, this.oX = function(aQd, target) {
		var aA, ea = aQd.length;
		for (bB.a6(14 + 9 * ea), bB.a7(1, 1), bB.a7(4, 13), bB.a7(9, target), aA = 0; aA < ea; aA++) bB.a7(9, aQd[aA]);
		ay.x.send(ay.x.a03, bB.aB)
	}
}
...
function aPA() {
	this.aQe = function() {
		bB.a6(39), bB.a7(1, 0), bB.a7(6, 16), ay.aAV.aQf(), ay.x.send(0, bB.aB)
	}, this.aQY = function(zu) {
		...
		bB.a6(75), bB.a7(1, 0), bB.a7(6, 27), bB.a7(6, data.ro), bE.rp.v8(data.rk, 5), bB.aQH(32, data.value), ay.x.send(0, bB.aB)
	}
}
...
function aPC() {
	...
	}, this.aN0 = function(s6, aN1, aN2) {
		bB.a6(18 + 16 * aN1.length + 30), bB.a7(1, 0), bB.a7(6, 22), bB.a7(6, s6), ay.aAV.aQh(aN1), bB.a7(30, aN2), ay.x.send(0, bB.aB)
	}, this.aN5 = function(s6, aN1, aN2) {
		bB.a6(73), bB.a7(1, 0), bB.a7(6, 28), bB.a7(6, s6), bE.rp.v8(aN1, 5), bB.a7(30, aN2), ay.x.send(0, bB.aB)
	}, this.aN3 = function(aM6, zQ) {
		for (var ea = zQ.length, hT = 0, aA = 0; aA < ea; aA++) hT += zQ[aA].length;
		for (bB.a6(21 + 3 * ea + 16 * hT), bB.a7(1, 0), bB.a7(6, 23), bB.a7(3, aM6), bB.a7(4, ea), bB.a7(7, hT), aA = 0; aA < ea; aA++) bB.a7(3, zQ[aA].length), bD.us.v7(zQ[aA]);
		ay.x.send(0, bB.aB)
	}, this.aN4 = function(aM6, s7, s8) {
		bB.a6(52), bB.a7(1, 0), bB.a7(6, 24), bB.a7(3, aM6), bB.a7(1, +(s7 < 0)), bB.a7(1, +(s8 < 0)), bB.a7(20, Math.abs(s7)), bB.a7(20, Math.abs(s8)), ay.x.send(0, bB.aB)
	}
}

function aP8() {
	this.aDs = function(zu) {
		var username = bh.dr.data[122].value.slice(0, 20),
			username = (bB.a6(24 + 16 * username.length + 18 + 18), bB.a7(1, 0), bB.a7(6, 1), bB.a7(10, dk), bB.a7(2, bh.dr.data[158].value), ay.aAV.aQh(username), b8.color.a1j(bh.x.uX())),
	...
	}, this.aCc = function(aQk, a2f) {
		bC.dW(), bC.a7(1, 0), bC.a7(6, 2), bC.a7(3, aQk), 2 === aQk ? bC.a7(2, a2f) : 3 === aQk ? bD.uu.yF(a2f, 7, bC) : 5 === aQk && (bC.a7(3, a2f.id), bC.a7(3, a2f.value), bC.a7(30, a2f.rk)), ay.x.send(ay.x.a02, bC.aQl())
	}
}

function aP9() {
	this.aPb = function(zu) {
	...
	}, this.aQX = function(zu, q6, aQD) {
		bB.a6(70), bB.a7(1, 0), bB.a7(6, 14), bB.a7(3, aQD), bB.a7(30, q6[0]), bB.a7(30, q6[1]), ay.x.send(zu, bB.aB)
	}, this.aMx = function(id) {
	...
	}, this.aQm = function(aQ7, pR) {
		bB.a6(7 + 26 * pR.length), bB.a7(1, 0), bB.a7(6, 9);
		for (var aA = 0; aA < pR.length; aA++) bB.a7(16, pR[aA][0]), bB.a7(10, pR[aA][1]);
		ay.x.send(aQ7, bB.aB)
	}, this.aPi = function(aQn, aQo) {
		bB.a6(20), bB.a7(1, 0), bB.a7(6, 19), bB.a7(1, aQn), bB.a7(12, aQo), ay.x.send(ay.x.a03, bB.aB)
	}, this.aQh = function(username) {
		bB.a7(5, username.length), bD.us.v7(username)
	}
}

function aPZ() {
	var zu, aKQ, aQp, aQq = ["wss://", "/s50/", "/s51/", "/s52/"],
		aQr = 0;
	...
	function aQw(e) {
		ay.a5F.aPk(zu, new Uint8Array(e.data))
	}
	...
	this.dW = function(e2, aQs) {
		zu = e2, aKQ = aQs;
		e2 = aQq[0];
		zu < ay.x.aEO ? e2 += ay.x.aPN[zu] + aQq[1 + di] : e2 += ay.x.aPN[0] + "/i" + (1 + di) + (zu - ay.x.aEI) + "/", (aQp = new WebSocket(__fx.customLobby.isActive() && zu === 1 ? __fx.customLobby.getSocketURL() : e2)).binaryType =
			"arraybuffer", aQp.onopen = aPa, aQp.onmessage = aQw, aQp.onclose = aPh, aQp.onerror = aQx
	}, this.aQu = function() {
		return aQp.readyState === aQp.CONNECTING
	}, this.aDl = function() {
		return aQp.readyState === aQp.OPEN
	}, this.aPU = function() {
		return aQr
	}, this.aPc = function() {
		aQr = 1
	}, this.aPW = function() {
		return this.aQu() || this.aDl()
	}, this.aPX = function(aQs) {
		aKQ = aQs
	}, this.aQZ = function() {
		return aKQ
	}, this.send = function(aB) {
		this.aDl() && aQp.send(aB)
	}, this.close = function(aPe) {
		this.aPW() && (aQp.close(aPe), this.qq())
	}, this.qq = function() {
		aQp.onopen = null, aQp.onmessage = null, aQp.onclose = null, aQp.onerror = null
	}
}
...
function dF() {
	...
	function aR0() {
		for (var aR6, aR4 = 0, ea = 0, ev = Math.floor(i / 2), e1 = Math.floor(rt / 2), aR5 = 1.5 * Math.PI, aA = aC.w7; 0 <= aA; aA--) ea += a1J[aA], 0 === a1J[aA] && aR4++;
		if (aQy = !1, x3.clearRect(0, 0, i, i), x3.fillStyle = b9.me, x3.fillRect(0, 0, i, i), x3.fillStyle = b9.mh, x3.fillRect(0, 0, i, gap), x3.fillRect(0, 0, gap, i), x3.fillRect(i - gap, 0, gap, i), x3.fillRect(0, i - gap, i, gap), 0 < ea)
			if (aR4 === aC.w7) {
				for (aA = aC.w7; 0 <= aA; aA--)
					if (0 < a1J[aA]) {
						! function(aA, ev, e1) {
							x3.fillStyle = be.aRD[be.kC[aA]], x3.beginPath(), x3.arc(ev, ev, e1, 0, 2 * Math.PI), x3.fill()
						}(aA, ev, e1);
						break
					}!
				function(ev) {
				...
				for (aA = 0; aA <= aC.w7; aA++) 0 < a1J[aA] && (! function(aA, ev, e1, aR5, aR6) {
					x3.fillStyle = be.aRD[be.kC[aA]], x3.beginPath(), x3.arc(ev, ev, e1, aR5, aR6), x3.lineTo(ev, ev), x3.fill()
				}(aA, ev, e1, aR5, aR6 = aR5 + 2 * Math.PI * a1J[aA] / ea), function(ev, e1, aR5, aR6) {
					var f2 = (aR6 - aR5) / (2 * Math.PI),
						fontSize = (__fx.settings.detailedTeamPercentage ? 0.75 : 1) * e1 * Math.min(f2, .37);
					fontSize < 8 || (aR5 = (aR5 + aR6) / 2, aR6 = (__fx.settings.detailedTeamPercentage ? (100 * f2).toFixed(2) : Math.floor(100 * f2 + .5)) + "%", e1 *= .525 - Math.max(.6 * (f2 - .7), 0), x3.font = b8.pZ.rN(1, fontSize), x3
						.fillStyle = b9.mh, x3.fillText(aR6, ev + Math.cos(aR5) * e1, ev + Math.cos(aR5 + 1.5 * Math.PI) * e1))
				}(ev, e1, aR5, aR6), 0 !== aA && aRB(ev, e1, aR5), aR5 = aR6);
				aRB(ev, e1, 1.5 * Math.PI)
			}!
		function(ev, e1) {
	...
	function aRB(ev, e1, aRE) {
		x3.beginPath(), x3.moveTo(ev, ev), x3.lineTo(ev + Math.cos(aRE) * e1, ev + Math.cos(aRE + 1.5 * Math.PI) * e1), x3.stroke()
	}
	this.dW = function() {
		if (aC.hQ) {
		...
		aC.hQ && (i = Math.floor(z.a0.qx() && !aC.mA ? .18 * h.min : .13 * h.pb), i = (i *= 1 + (.5 + .2 * z.a0.qx()) * aC.mA) + i % 2, rt = Math.floor(7 * i / 8), (canvas = canvas || document.createElement("canvas")).width = i, canvas.height =
			i, x3 = canvas.getContext("2d", {
				alpha: !0
			}), gap = Math.max(1, .015 * i), x3.lineWidth = gap, x3.strokeStyle = b9.mh, b8.pZ.textAlign(x3, 1), b8.pZ.textBaseline(x3, 1), aR0())
	}, this.a2b = function() {
		var dm, l1 = this.l2();
...
function cy() {
	function aRG(key) {
		var aOV;
		return "undefined" == typeof URLSearchParams || (aOV = window.location.search, "string" != typeof(aOV = new URLSearchParams(aOV).get(key))) || aOV.length < 1 ? null : aOV
	}
	this.df = function() {
		if (0 !== z.id) return !1;
		if (! function() {
				var value = aRG("account");
				if (!value && !(value = aRG("a"))) return void bG.clear();
...
function cf() {
	...
	this.dW = function() {
		...
		return bJ.dn(aRI - 1, 2)
	}, this.a3M = function(aIQ) {
		aRI = 2 * aIQ % 32768 + 1
	}, this.random = function() {
		return aRI = 167 * aRI % 32768
	}, this.j8 = function(lZ) {
...
function cu() {
	this.op = new aRJ, this.a3X = new aRK, this.aG8 = new aRL, this.dW = function() {
		aC.gk || this.op.dW()
	}, this.ik = function() {
		aC.gk || (this.op.ik(), 3 !== s.rm) || bd.jn() % 15 != 5 && 2 !== aC.ym || s.aDC().aOW()
	}, this.aOZ = function() {
		0 === aC.ym && aZ.aE3(), aC.a3H.a3f(), aC.data.canvas = null, ay.x.close(ay.x.a03, 3257), ay.x.a03 = 0, aC.data.isReplay = 1, aC.a3K()
	}, this.aOY = function(pG) {
		var aA = pG.indexOf("=");
...
function aRJ() {
	this.aRN = null, this.aRO = null, this.aRP = null, this.aRQ = null, this.aRR = null, this.aRS = null, this.a3W = "";
	var aRT = 0;
	this.dW = function() {
		this.aRN = [], this.aRO = [], this.aRP = [], this.aRQ = [], this.aRR = [0], this.aRS = [0], aRT = 0, this.a3W = ""
	}, this.oq = function(id, fI, fK, fM) {
		aC.gk || 2 === aC.ym || (0 === this.aRR[aRT] && (this.aRS[aRT] ? (this.aRR.push(1), this.aRS.push(0), aRT++) : this.aRR[aRT] = 1), this.aRN.push(id), this.aRO.push(fI), this.aRP.push(void 0 === fK ? 0 : fK), this.aRQ.push(void 0 === fM ?
			0 : fM), this.aRS[aRT]++)
	}, this.ik = function() {
		0 === this.aRR[aRT] ? this.aRS[aRT]++ : (this.aRR.push(0), this.aRS.push(0), aRT++)
	}
}
...
function aRL() {
	...
	function aRY(pG, id) {
		aRU || (id ? 1 === id ? aM.a4h = L(405) + ": " + pG : s.t(4, 3, new u(L(406), pG, 1)) : s.t(4, 3, new u("⚠️ " + L(404), pG, 1)))
	}
	this.vC = function(pG, aRV) {
		var pR;
		return aRU = aRV, bE.rp.v4(bE.rp.v2(bE.rp.v0(pG))), aM.a4h = "", !(! function() {
			if (bF.size < 10) aRY("File Too Small");
			else {
				var aRa = bF.oa(12),
					aQo = (aRa !== l.rVersion && aRY("Incompatible Version " + aRa + " " + l.rVersion, 1), bF.oa(12)),
					aRb = bF.oa(31);
				if (aRb !== bF.size) aRY("Size Error: " + aRb + " " + bF.size);
				else if (function(j, aRa) {
						for (var g8 = bF.aB, ea = bF.size, aQo = aRa, aA = 3; aA < ea; aA++) aQo = aQo + g8[aA] & 4095;
						return aQo === j || (aRY("Hash Error: " + aQo + " " + j + " " + ea), !1)
					}(aQo, aRa)) return 1
			}
			return
		}() || (aRV = bF, (pR = aC.data = new a3G).mapType = aRV.oa(2), pR.mapProceduralIndex = aRV.oa(8), pR.mapRealisticIndex = aRV.oa(8), pR.mapSeed = aRV.oa(14), pR.mapName = aRV.aRd(5), 2 === pR.mapType && aRV.aRe(), pR
			.passableWater = aRV.oa(1), pR.passableMountains = aRV.oa(1), pR.playerCount = aRV.oa(10), pR.humanCount = aRV.oa(10), pR.selectedPlayer = aRV.oa(9), pR.gameMode = aRV.oa(1), pR.playerMode = aRV.oa(2), pR.battleRoyaleMode =
			aRV.oa(2), pR.numberTeams = aRV.oa(4), pR.isZombieMode = aRV.oa(1), pR.isContest = aRV.oa(1), pR.isReplay = aRV.oa(1), pR.elo = aRV.aRf(2, 14, 2), pR.colorsType = aRV.oa(1), pR.colorsPersonalized = aRV.oa(1), pR.colorsData =
			aRV.aRf(10, 18, 512), pR.selectableColor = aRV.oa(1), pR.teamPlayerCount = aRV.aRf(4, 10, 9), pR.neutralBots = aRV.oa(1), pR.botDifficultyType = aRV.oa(2), pR.botDifficultyValue = aRV.oa(4), pR.botDifficultyTeam = aRV.aRf(4,
				4, 9), pR.botDifficultyData = aRV.aRf(10, 4, 512), pR.spawningType = aRV.oa(2), pR.spawningSeed = aRV.oa(14), pR.spawningData = aRV.aRf(11, 12, 1024), pR.selectableSpawn = aRV.oa(1), pR.playerNamesType = aRV.oa(2), pR
			.playerNamesData = aRV.aRg(10, 5, 512), pR.selectableName = aRV.oa(1), pR.aIncomeType = aRV.oa(2), pR.aIncomeValue = aRV.oa(8), pR.aIncomeData = aRV.aRf(10, 8, 512), pR.tIncomeType = aRV.oa(2), pR.tIncomeValue = aRV.oa(8), pR
			.tIncomeData = aRV.aRf(10, 8, 512), pR.iIncomeType = aRV.oa(2), pR.iIncomeValue = aRV.oa(8), pR.iIncomeData = aRV.aRf(10, 8, 512), pR.sResourcesType = aRV.oa(2), pR.sResourcesValue = aRV.oa(11), pR.sResourcesData = aRV.aRf(10,
				11, 512), ! function() {
				var hv = bF,
					vD = hv.oa(5),
					aRh = hv.oa(30),
					aRi = hv.oa(30);
				if (aRh + aRi > 8 * hv.size) return void aRY("Corrupted File");
				return function(ea) {
						var aRl = new Uint8Array(ea),
							aRm = new Uint16Array(ea),
							aRn = new Uint32Array(ea),
							aRo = new Uint32Array(ea);
						b7.op.aRN = aRl, b7.op.aRO = aRm, b7.op.aRP = aRn, b7.op.aRQ = aRo;
						for (var aA = 0; aA < ea; aA++) {
							var id = bF.oa(4);
							aRl[aA] = id, aRm[aA] = bF.oa(9), 0 === id ? aRn[aA] = bF.oa(22) : 1 === id ? (aRn[aA] = bF.oa(10), aRo[aA] = bF.oa(10)) : 2 === id ? (aRn[aA] = bF.oa(10), aRo[aA] = bF.oa(9)) : 3 === id || 4 === id ? (aRn[
								aA] = bF.oa(10), aRo[aA] = bF.oa(22)) : 5 === id || 6 === id ? aRn[aA] = bF.oa(10) : 7 === id ? aRn[aA] = bF.oa(1) : 10 === id && (aRn[aA] = bF.oa(20), aRo[aA] = bF.oa(22))
						}
					}(aRh),
					function(ea, vD) {
						var aRR = new Uint8Array(ea),
							aRS = new Array(ea);
						aRS.fill(0), b7.op.aRR = aRR, b7.op.aRS = aRS;
						for (var aA = 0; aA < ea; aA++) aRR[aA] = bF.oa(1), aRS[aA] = bF.oa(vD)
					}(aRi, vD), 1
			}()) || (bF.e2 < 8 * bF.size - 13 || bF.e2 > 8 * bF.size ? (aRY("Out Of Bounds Error: " + bF.e2 + " " + 8 * bF.size), 1) : (b7.op.a3W = pG, 2 === aC.data.mapType && (aRY("Load base64 image...", 2), 1))))
	}, this.aG9 = function(aFj, aRZ) {
		var a1e = document.createElement("canvas"),
			hY = a1e.getContext("2d");
		if (a1e.width = aFj.width, a1e.height = aFj.height, hY.drawImage(aFj, 0, 0), aRU || aRZ) return aC.ym ? void 0 : (aC.data.canvas = a1e, aC.data.mapType = 2, s.w(), void s.t(19));
		b7.aOZ()
	}
}
...
function aRK() {
	this.yF = function() {
		var vD = function() {
				for (var aRS = b7.op.aRS, ea = aRS.length, max = 0, aA = 0; aA < ea; aA++) max = Math.max(max, aRS[aA]);
				return vK(Math.max(max, 1))
			}(),
			i = (pR = aC.data, (i = bC).dW(), i.a7(12, l.rVersion), i.e2 += 43, i.a7(2, pR.mapType), i.a7(8, pR.mapProceduralIndex), i.a7(8, pR.mapRealisticIndex), i.a7(14, pR.mapSeed), i.aRv(pR.mapName, 5), 2 === pR.mapType && i.aRw(pR.canvas),
				i.a7(1, pR.passableWater), i.a7(1, pR.passableMountains), i.a7(10, pR.playerCount), i.a7(10, pR.humanCount), i.a7(9, pR.selectedPlayer), i.a7(1, pR.gameMode), i.a7(2, pR.playerMode), i.a7(2, pR.battleRoyaleMode), i.a7(4, pR
					...
					.spawningSeed), i.dd(pR.spawningData, 11, 12), i.a7(1, pR.selectableSpawn), i.a7(2, pR.playerNamesType), i.aRx(pR.playerNamesData, 10, 5), i.a7(1, pR.selectableName), i.a7(2, pR.aIncomeType), i.a7(8, pR.aIncomeValue), i.dd(pR
					...
					var i = bC,
						...
						fM = b7.op.aRQ,
						ea = aRN.length;
					i.a7(5, vD), i.a7(30, ea), i.a7(30, b7.op.aRS.length);
					for (var aA = 0; aA < ea; aA++) {
						var ev = aRN[aA];
					...
					for (var i = bC, aRR = b7.op.aRR, aRS = b7.op.aRS, ea = aRR.length, aA = 0; aA < ea; aA++) i.a7(1, aRR[aA]), i.a7(vD, aRS[aA])
				}(vD), bC.e2),
			pR = bJ.dn(i - 1, 6) + 1,
			vD = (bB.aQI(6 * pR) !== bC.g.length && bC.g.push(0), ! function() {
				var i = bC;
				i.e2 = 24, i.a7(31, i.g.length), i.e2 = 12, i.a7(12, function() {
					for (var g = bC.g, ea = g.length, aQo = l.rVersion, aA = 3; aA < ea; aA++) aQo = aQo + g[aA] & 4095;
					return aQo
				}())
...
function ck() {
	...
	function resize(aS6) {
		ev = 0, aa.sE() && (aS4(aS6) || bq) && (bq = !1, ba.resize(), bU.aA6.resize(), aX.dW(), bW.dW(), aY.resize(), aS.resize(), aN.resize(), s.resize(), 1 <= aC.ym ? (aU.resize(!1), aT.resize(), aV.resize(), aR.resize(), aQ.resize(), aM.resize(),
			aL.resize(), bA.resize(), au.resize(), aO.resize(), aP.resize(), aK.resize(), bc.resize(), ae.resize(), aW.resize(), bf.resize(), aR.a7T()) : (aZ.aE5(), aZ.aE6()), bd.de = !0)
	}
	...
	function aS4(aS6) {
		var i, j, aS8, rt, a6s;
		if (!(0 < h.rU)) return rt = aS3(document.documentElement.clientWidth), a6s = aS3(window.visualViewport && 2 !== z.id ? window.visualViewport.height : document.documentElement.clientHeight), i = rt, j = a6s, aS8 = 0 !== z.id || i < j ? 700 :
			1200, aS8 = Math.min(aS8 / ((i + j) / 2), 1), aS8 = 0 === bh.dr.data[1].value ? 2 * aS8 / 3 : Math.min(aS8 + (bh.dr.data[1].value - 1) * (1 - aS8) / 2, 1), h.k = (window.devicePixelRatio || 1) * aS8, __fx.hoveringTooltip
			.canvasPixelScale = h.k, aS6 && !aRz ? (aRz = !0, document.body.removeChild(a0I)) : aRz && (aRz = !1, document.body.appendChild(a0I)), i = Math.floor(.5 + rt * h.k), j = Math.floor(.5 + a6s * h.k), i !== h.i || j !== h.j ? (h.i = i, h
				.j = j, h.min = a9i(i, j), h.max = a4w(i, j), h.pb = bJ.dn(i + j, 2), h.tb = i / j, a0I.width = i, a0I.height = j, a0I.style.width = rt + "px", a0I.style.height = a6s + "px", aS1 = bd.lx + 1e3, 1) : void 0
	}
	this.i = 0, this.j = 0, this.min = 0, this.max = 0, this.pb = 0, this.tb = 1, this.k = 1, this.rU = 0, this.dX = function() {
		this.i = aS3(document.documentElement.clientWidth) + 2, this.j = aS3(document.documentElement.clientHeight) + 2
	}, this.dW = function() {
		ev = 1, a0I = document.getElementById("canvasA"), (tf = a0I.getContext("2d", {
			alpha: __fx.makeMainMenuTransparent
		})).imageSmoothingEnabled = !1, aS4(0)
	}, this.ik = function() {
		50 <= ++ev && resize(0), -1 === aS1 || bd.lx < aS1 || (aS1 = -1, 2e3 * ++aS2 >= bd.lx + 8e3 ? console.log("error 3748") : z.a0.setState(15))
	}, this.dh = function(hk) {
		bq = !0, resize(hk)
	}, this.a0y = function() {
		aS0 + 1e3 > bd.lx || (aS0 = bd.lx, resize(0))
	}
}

function dC() {
	this.aQW = new aSA, this.zb = new aSB
}

function aSB() {
	this.zc = function() {
		for (var g8, ea = ak.jr, ya = ak.js, zK = af.zK, a6h = this.aFS(), aA = 0; aA < ea; aA++) g8 = ya[aA], b8.fw.jE(g8) || (zK[g8] = a6h);
		var ov = af.ov,
			it = af.it,
			iu = af.iu,
			zJ = af.zJ,
...
function aSA() {
	function aSF(g, f2, hO) {
		for (var aA = 0; aA < 256; aA++) g[aA] = (g[aA] + (f2 >> (aA + hO) % 30 & 1)) % 256
	}
	this.ik = function(aSC, aSD) {
		var g = new Uint8Array(256);
		return function(g, aSC, aSD) {
				var aA, aSH = 3 + (4 + aSC) % 32768,
					aSI = 12 + aSD % 32768,
					aSJ = 17 + ((aSC & aSD) + (aSC | aSD) + aSC) % 32768;
				for (aA = 0; aA < 256; aA++) aSH = 1 + aSH * aSI % aSJ, g[aA] = aSH % 256
			}(g, aSC, aSD), aSF(g, aSC, 2), aSF(g, aSD, 7),
			function(g) {
				var aA, f2, e2 = 0;
...
function ch() {
	var aSK, aSL, h3, aSM;
	this.dW = function() {
		var aA, eh, ej, aQi, aSN, i, j, x3, hV, vU, f2, g8, eq, et, a46;
		if (function() {
				if (h3 = !0, aSM = "rgb(" + bQ.vS[0] + "," + bQ.vS[1] + "," + bQ.vS[2] + ")", bQ.aIY(bQ.eG)) return 1;
				return h3 = !1, 0
			}()) aSL = null;
		else {
			for (aSK = bJ.dn(96, 4), aSN = 1 === bQ.eG ? (aQi = 0, 160) : (aQi = 128, 32), aSM = "rgb(" + aQi + "," + aQi + "," + aQi + ")", aSL = new Array(4), aA = 3; 0 <= aA; aA--) {
				if (aSL[aA] = document.createElement("canvas"), i = aA % 2 == 0 ? bQ.el : aSK, j = aA % 2 == 0 ? aSK : bQ.em + 2 * aSK, aSL[aA].width = i, aSL[aA].height = j, vU = (hV = (x3 = aSL[aA].getContext("2d", {
						alpha: !1
					})).getImageData(0, 0, i, j)).data, aA % 2 == 0)
					for (ej = aSK - 1; 0 <= ej; ej--)
						for (f2 = aSN + Math.floor((ej + 1) * (aQi - aSN) / (aSK + 1)), eh = i - 1; 0 <= eh; eh--) vU[g8 = 4 * ((0 === aA ? aSK - ej - 1 : ej) * i + eh)] = f2, vU[g8 + 1] = f2, vU[g8 + 2] = f2, vU[g8 + 3] = 255;
				else {
					for (eh = aSK - 1; 0 <= eh; eh--)
						for (f2 = aSN + Math.floor((eh + 1) * (aQi - aSN) / (aSK + 1)), ej = j - 1 - aSK; aSK <= ej; ej--) vU[g8 = 4 * (ej * i + (3 === aA ? aSK - eh - 1 : eh))] = f2, vU[g8 + 1] = f2, vU[g8 + 2] = f2, vU[g8 + 3] = 255;
					for (et = 1; 0 <= et; et--)
						for (eh = aSK - 1; 0 <= eh; eh--)
							for (ej = aSK - 1; 0 <= ej; ej--) eq = (Math.pow(eh * eh + ej * ej, .5) + 1) / (aSK + 1), f2 = aSN + Math.floor((1 < eq ? 1 : eq) * (aQi - aSN)), vU[g8 = 4 * ((0 === et ? aSK - ej - 1 : ej + et * (j - aSK)) * i + (
								1 === aA ? eh : aSK - eh - 1))] = f2, vU[g8 + 1] = f2, vU[g8 + 2] = f2, vU[g8 + 3] = 255
				}
				x3.putImageData(hV, 0, 0)
			}
			a46 = aSN, bQ.vN.fillStyle = "rgb(" + a46 + "," + a46 + "," + a46 + ")", bQ.vN.fillRect(0, 0, bQ.el, 1), bQ.vN.fillRect(0, bQ.em - 1, bQ.el, 1), bQ.vN.fillRect(0, 0, 1, bQ.em), bQ.vN.fillRect(bQ.el - 1, 0, 1, bQ.em)
		}
	}, this.wx = function() {
		var et = h3 ? 0 : -aSK;
		aK9(et, et, bQ.el - 2 * et, bQ.em - 2 * et, bY.aSQ, bY.aSR, bY.aSS, bY.aST) || (tf.fillStyle = aSM, tf.fillRect(0, 0, h.i, h.j))
	}, this.te = function() {
		h3 || (aK8(0, -aSK, bQ.el, aSK, bY.aSQ, bY.aSR, bY.aSS, bY.aST) && tf.drawImage(aSL[0], bY.aSU, bY.aSV - aSK), aK8(bQ.el, -aSK, aSK, bQ.em + 2 * aSK, bY.aSQ, bY.aSR, bY.aSS, bY.aST) && tf.drawImage(aSL[1], bY.aSU + bQ.el, bY.aSV - aSK),
			aK8(0, bQ.em, bQ.el, aSK, bY.aSQ, bY.aSR, bY.aSS, bY.aST) && tf.drawImage(aSL[2], bY.aSU, bY.aSV + bQ.em), aK8(-aSK, -aSK, aSK, bQ.em + 2 * aSK, bY.aSQ, bY.aSR, bY.aSS, bY.aST) && tf.drawImage(aSL[3], bY.aSU - aSK, bY.aSV - aSK))
	}
}

function d1() {
	this.h4 = new aSW, this.aFQ = new aSX, this.x0 = new aSY, this.x = new aSZ, this.iK = new aSa, this.a46 = new aSb, this.aSc = new aSd, this.je = new aSe, this.kS = new aSf, this.aSg = new aSh, this.dW = function() {
		this.x0.dW(), this.x.dW(), this.iK.dW(), this.a46.dW(), this.aSg.dW()
	}, this.te = function() {
		this.aSg.te(), this.x0.te()
	}
}
	...
	this.ik = function(player) {
		...
		return !!aC.data.passableWater && 0 !== af.gH[player].length && bL.x.on !== bL.x.k4 && !((om = bL.x.om[player]) >= Math.max(3 * am.performance.ks, aD.k4[aD.hF[player]]) || om === bL.x.oz || !b8.fw.ot(player, aD.k2[aD.hF[player]], 32,
			0) || !am.iX.ik(player) && !am.iZ.ik(player) || ! function(a2G) {
				var aSk = bM.fC[1] + bK.ha[bM.fC[2] - 1] << 2;
				if (ab.eR(aSk)) return 1;
				return aSk = ab.eS(aSk), a2G !== aSk && !!eT(a2G, aSk)
...
function aSW() {
	function aSs(aA, kt, ku) {
		var aSu, aSt;
		if (!(aA < 0)) return aSt = bL.x.m6[aA], aSu = bK.hy(aSt), aSt = bK.i1(aSt), aA = 20 * (.9 + .1 * Math.log10(bL.x.a5E[aA])), aA = Math.max(aA, bK.iE(b8.pZ.sC(.02, 1.7))), bJ.aKG(bK.hx(kt), bK.i0(ku), aSu, aSt, aA)
	}

	function aSm(aSl) {
		var aSx = 4 + .03 * (1 + 1.5 * z.a0.qx()) * h.pb / iC;
		return bK.i2(aSl, bM.fC[1]) < aSx
	}
	this.h5 = function(player, aSl) {
		return !!(aC.data.passableWater && bK.iF(aSl) && bL.x.on !== bL.x.k4 && bL.x.om[player] !== bL.x.oz && 0 !== af.gH[player].length && bL.kS.kT(player, aSl) && aSm(aSl))
	}, this.o7 = function(player, m3, aSl) {
		return !!(bK.iF(aSl) && this.p3(player, m3) && bL.kS.p4(aSl) && aSm(aSl))
	}, this.p3 = function(player, id) {
		for (var aSn, s7 = player << 3, s8 = s7 + bL.x.om[player], aSo = bL.x.aSo, aSp = bL.x.aSp, aA = s7; aA < s8; aA++)
			if (id === aSp[aSn = aSo[aA]]) return bM.fC[3] = aSn, !0;
		return !1
	}, this.o6 = function(eM) {
		var a47 = bL.a46.a47;
		...
		var player = aC.eK,
			ea = bL.x.om[player];
		if (0 === ea) return !1;
		for (var aSo = bL.x.aSo, m6 = bL.x.m6, s7 = player << 3, aSq = 80, aMN = -1, aA = s7 + ea - 1; s7 <= aA; aA--) {
			var aSr = aSo[aA],
				eq = bK.hs(kt, ku, m6[aSr]);
			eq < aSq && (aSq = eq, aMN = aSr)
		}
		return !!aSs(aMN, kt, ku) && (bL.a46.a47 = bL.x.aSp[aMN], bk.p1.a49(), !0)
	}, this.a4G = function(kt, ku) {
		var ea = bL.x.on;
		if (ea < 1) return -1;
		for (var m6 = bL.x.m6, aSq = 80, aMN = -1, aA = 0; aA < ea; aA++) {
			var eq = bK.hs(kt, ku, m6[aA]);
			eq < aSq && (aSq = eq, aMN = aA)
		}
		return aSs(aMN, kt, ku) ? aMN : -1
	}, this.m5 = function(player, id) {
		for (var s7 = player << 3, s8 = s7 + bL.x.om[player], aSp = bL.x.aSp, aSo = bL.x.aSo, aA = s7; aA < s8; aA++) {
			var aSr = aSo[aA];
			if (aSp[aSr] === id) return aSr
		}
		return -1
	}, this.aFN = function(player) {
		for (var s7 = player << 3, s8 = s7 + bL.x.om[player], aSo = bL.x.aSo, a5E = bL.x.a5E, hF = 0, aA = s7; aA < s8; aA++) hF += a5E[aSo[aA]];
		return hF
	}, this.mB = function(player) {
		return 0 === bL.x.om[player] ? -1 : bL.x.aSo[player << 3]
	}
}

function aSX() {
	this.aFR = function(player) {
		for (var aSo = bL.x.aSo, s7 = player << 3, aA = s7 + bL.x.om[player] - 1; s7 <= aA; aA--) this.aSy(aSo[aA])
	}, this.aSy = function(aSz) {
		var x = bL.x,
			aT0 = x.on - 1,
			aT1 = x.a5D[aSz],
			aT2 = x.aT3[aSz],
			aT4 = x.m6[aSz];
		x.on = aT0, x.a5D[aSz] = x.a5D[aT0], x.aT5[aSz] = x.aT5[aT0], x.aT6[aSz] = x.aT6[aT0], x.m6[aSz] = x.m6[aT0], x.aT7[aSz] = x.aT7[aT0], x.a5E[aSz] = x.a5E[aT0], x.aT3[aSz] = x.aT3[aT0], x.aSp[aSz] = x.aSp[aT0], x.aT8[aSz] = x.aT8[aT0], x
			.aT9[aSz] = x.aT9[aT0], x.aSo[x.a5D[aSz]] = aSz,
			function(aRE) {
				var player = aRE >> 3,
					x = bL.x,
					ea = x.om[player] - 1,
					aTC = (player << 3) + ea;
				x.om[player] = ea, aTC !== aRE && (x.aSo[aRE] = x.aSo[aTC], x.a5D[x.aSo[aRE]] = aRE)
			}(aT1), bL.iK.iK[bK.iJ(x.m6[aSz])][x.aT3[aSz]] = aSz, aT0 = bK.iJ(aT4), aT1 = aT2, aT0 = bL.iK.iK[aT0], x = aT0.pop(), aT1 !== aT0.length && (aT0[aT1] = x, bL.x.aT3[x] = aT1)
	}
}
...
function aSY() {
	...
	function aTG(e2) {
		var hS = xP + 4,
			...
			vU = hV.data;
		return aTH(vU, hS + 1, e2), aTH(vU, hS + 2, e2), aTH(vU, 2 * hS + 1, e2), aTH(vU, 2 * hS - 3, e2), aTH(vU, 2 * hS - 2, e2), aTH(vU, 3 * hS - 2, e2), aTH(vU, hS * (hS - 3) + 1, e2), aTH(vU, hS * (hS - 2) + 1, e2), aTH(vU, hS * (hS - 2) + 2,
			e2), aTH(vU, hS * (hS - 2) - 2, e2), aTH(vU, hS * (hS - 1) - 3, e2), aTH(vU, hS * (hS - 1) - 2, e2), hY.putImageData(hV, 0, 0), a1e
	}

	function aTH(vU, eM, e2) {
		eM *= 4;
	...
	function vJ(player) {
		...
		return function(hY, player) {
			var eh, ej, hw, eM, aTJ, aTK, hS = xP,
				hV = b8.pZ.getImageData(hY, hS, hS),
				vU = hV.data,
				kY = (hS >> 1) - .5,
				aSM = ab.a5o(player),
				aTM = b8.pi.a1C(aSM, .5);
			b8.pi.a1E(aSM, aTM, 300) || b8.pi.a1G(aSM, 100);
			for (ej = 0; ej < hS; ej++)
				for (eh = 0; eh < hS; eh++) aTK = (hS - 1.5) * (hS - 1.5) / 4, aTJ = (hw = (hw = eh - kY) * hw + (hw = ej - kY) * hw) <= (hS - 4.5) * (hS - 4.5) / 4 ? aTM : aSM, vU[eM = 4 * (ej * hS + eh)] = aTJ[0], vU[1 + eM] = aTJ[1], vU[2 +
					eM] = aTJ[2], vU[3 + eM] = aTK < hw ? 0 : 255;
			hY.putImageData(hV, 0, 0)
		}(b8.pZ.getContext(a1e, !0), player), a1e
	}
	this.dW = function() {
		aTE = new Array(aC.eX), aTF[0] = aTG(255), aTF[1] = aTG(0)
	}, this.te = function() {
		var aA, player, aTN, aKH, hF, hv, aTP, aTR, aTS, m6 = bL.x.m6,
			a5D = bL.x.a5D,
			a5E = bL.x.a5E,
			aT9 = bL.x.aT9,
			aTT = aTE,
			...
			hz = (aTX + iD) / eP - m8,
			hY = tf;
		for (bL.h4.p3(aC.eK, bL.a46.a47) && (aTV = bM.fC[3]), hY.imageSmoothingEnabled = eP < 9, b8.pZ.textAlign(hY, 1), b8.pZ.textBaseline(hY, 1), aA = 0; aA < ea; aA++) player = a5D[aA] >> 3, hF = a5E[aA], aTN = .9 + .1 * Math.log10(hF), aKH =
			(hv = m6[aA]) % aTY / 16 - aTN, hv = aTX * (Math.floor(hv / aTY) / 16 - aTN - m8) / hz, aTP = -2 * (aTS = eP * aTN) * (1 + (aTR = +(player === aTU)) / 8), aTR = aTR * aTS / 4, (aTS = aTW * (aKH - m7) / hw) < aTP || hv < aTP || aTW +
			aTR < aTS || aTX + aTR < hv || (aKH = 2 * aTN * eE, aTP = aTN * eP, void 0 === (aTR = aTT[player]) && (aTT[player] = aTR = vJ(player)), player === aTU && (hY.setTransform(aKH, 0, 0, aKH, aTS - 2 * aKH, hv - 2 * aKH), hY.drawImage(aTF[
				+(aA === aTV)], 0, 0)), hY.setTransform(aKH, 0, 0, aKH, aTS, hv), hY.drawImage(aTR, 0, 0), (aTN = Math.floor(function(hF) {
				if (hF < 1e3) return .42;
				if (hF < 1e4) return .34;
				if (hF < 1e6) return .26;
				if (hF < 1e8) return .19;
				return .15
			}(hF) * aTP)) < 6) || (hY.setTransform(1, 0, 0, 1, 0, 0), hY.fillStyle = aT9[aA] ? b9.nF : b9.mh, hY.font = b8.pZ.rN(1, aTN), hY.fillText(b8.zN.y4(hF), aTS + aTP, hv + aTP + .1 * aTN));
		hY.imageSmoothingEnabled = !1, hY.setTransform(1, 0, 0, 1, 0, 0)
	}
}
...
function aSh() {
	...
	this.dW = function() {
		...
		if (!(5 <= mR)) {
			...
			for (var aA = 0; aA < ea; aA++) {
				var hv = m6[aA],
					eh = aTW * (hv % aTY / 16 - m7) / (mK - m7) + aTd,
					hv = aTX * (Math.floor(hv / aTY) / 16 - m8) / (mL - m8) + aTd;
				aTW < eh || aTX < hv || eh < g9 || hv < g9 || (hY.setTransform(mR, 0, 0, mR, eh, hv), hY.drawImage(aTe, 0, 0))
			}
...
function aSd() {
	this.ik = function() {
		for (var aSt, aSc, aT8 = bL.x.aT8, m6 = bL.x.m6, aT6 = bL.x.aT6, aA = bL.x.on - 1; 0 <= aA; aA--) aSt = m6[aA], 0 !== (aSc = aT8[aA]) && aSt === aT6[aA] && (! function(aA, aTi, hN) {
			var j1, player = bL.x.a5D[aA] >> 3,
				hN = aTi + bK.ha[hN] << 2,
				aA = bL.x.a5E[aA];
			if (bb.aTj(player), ab.eR(hN)) j1 = aC.eX;
			else {
				if ((j1 = ab.eS(hN)) === player) return hN = b8.fw.fz(player, aA), bb.g0(player, aA - hN, 12);
				if (!eT(player, j1)) return b6.jt.oL(player, j1, aA)
			}
			ac.jC(player, j1) || ac.jU(player) ? (af.g2[player].push(aTi << 2), ac.iy(player, aA, j1), aE.iz(player, !0)) : bb.g0(player, aA, 12)
		}(aA, bK.iI(aSt), aSc - 1), bL.aFQ.aSy(aA))
	}, this.aTk = function(player, eM, hN, m3) {
		if (0 !== hN) {
			var aTU = aC.eK;
			if (b8.fw.gn(aTU) && eT(player, aTU) && player !== aTU && 0 !== af.gH[aTU].length) {
				var aSk = eM + bK.ha[--hN] << 2;
				if (ab.eR(aSk) || eT(player, ab.eS(aSk))) {
					for (var eo = !1, aA = 0; aA < 4; aA++)
						if (aSk = eM + bK.ha[aA] << 2, ab.eV(aSk) && !ab.eR(aSk) && ab.eS(aSk) === aTU) {
							eo = !0;
							break
						} eo && (aM.a48(719, 0), aM.zA(180, L(407, [af.zL[player]]), 719, player, b9.nE, b9.me, -1, !0, void 0, {
						eu: 1,
						m3: m3
					}))
				}
...
function aSZ() {
	this.aTl = null, this.k4 = 512, this.oz = 8, this.on = 0, this.aTm = 0, this.a5D = new Uint16Array(this.k4), this.aT5 = new Uint32Array(this.k4), this.aT6 = new Uint32Array(this.k4), this.m6 = new Uint32Array(this.k4), this.aT7 = new Uint16Array(
			this.k4), this.a5E = new Uint32Array(this.k4), this.aT3 = new Uint16Array(this.k4), this.aSp = new Uint16Array(this.k4), this.aT8 = new Uint8Array(this.k4), this.aT9 = new Uint8Array(this.k4), this.om = new Uint8Array(aC.eX), this.aSo =
		new Uint16Array(this.oz * aC.eX), this.dW = function() {
			this.aTm = 0, this.on = 0, this.aTl = new Uint8Array(bQ.el + bQ.em), this.om.fill(0)
		}, this.p2 = function(player) {
			var ea = this.on,
				aTn = bK.iH(bM.fC[0]),
				aTo = this.om[player],
				aTp = (player << 3) + aTo,
				hF = (this.a5D[ea] = aTp, this.aT5[ea] = aTn, this.m6[ea] = aTn, this.aT6[ea] = bK.iH(bM.fC[1]), this.aT7[ea] = 0, bM.f8[0]);
			hF < 60 ? (b8.fw.fx(player, 60 - hF), this.a5E[ea] = 60) : this.a5E[ea] = hF, this.aT3[ea] = bL.iK.p2(ea, bK.iJ(aTn)), this.aSp[ea] = this.aTm, this.aT8[ea] = bM.fC[2], this.aT9[ea] = 0, this.aTm = this.aTm + 1 & 1023, this.aSo[aTp] = ea,
				this.om[player] = aTo + 1, this.on++, bL.aSc.aTk(player, bM.fC[1], bM.fC[2], this.aSp[ea])
		}, this.o6 = function() {
			var aSn = bM.fC[3];
			this.aT5[aSn] = this.m6[aSn], this.aT6[aSn] = bK.iH(bM.fC[1]), this.aT7[aSn] = 0, this.aT8[aSn] = bM.fC[2], bL.aSc.aTk(this.a5D[aSn] >> 3, bM.fC[1], bM.fC[2], this.aSp[aSn])
		}, this.ik = function() {
			bL.aSc.ik();
			var aA, g8 = aC.eK,
				dm = bL.h4.aFN(g8),
				rB = (! function(rB) {
					var aA, aTu, aTv, aTw, aTx, aTn, aU1, aU2, ed, g9, aT5 = rB.aT5,
						aT6 = rB.aT6,
						m6 = rB.m6,
						a5E = rB.a5E,
						aT9 = rB.aT9,
						...
						rB = rB.on,
						aTY = bQ.el << 4;
					for (aA = rB - 1; 0 <= aA; aA--) aTv = m6[aA], aTu = aT6[aA], aTv !== aTu && (aTn = aT5[aA], aU1 = aTu % aTY - (aTx = aTn % aTY), aU2 = ~~((aTu + .5) / aTY) - (aTn = ~~((aTn + .5) / aTY)), ed = ~~Math.sqrt(aU1 * aU1 + aU2 *
						aU2 + .5), g9 = 15e4 + 25e3 * bJ.log10(a5E[aA]), aT9[aA] && (g9 = bJ.dn(g9, 5)), 65535 <= (g9 = aT7[aA] + Math.max(~~((g9 + .5) / ed), 1)) ? m6[aA] = aTw = aTu : (aT7[aA] = g9, m6[aA] = aTw = aTx + bJ.dn(g9 * aU1,
						65536) + aTY * (aTn + bJ.dn(g9 * aU2, 65536))), aT3[aA] = bL.iK.aU4(aT3[aA], aTv, aTw))
				}(this), ! function(rB) {
					if (bd.jn() % 2 == 1) {
						var aA, hO, kY, eu, ev, aU5, xk, aU6, h0, m7, m8, aTn, aU7, he, aU9, vc, ea = rB.on,
							m6 = rB.m6,
							a5D = rB.a5D,
							a5E = rB.a5E,
							aT9 = rB.aT9,
						...
						for (aA = 0; aA < ea; aA++)
							for (hO = Math.abs(aA - g9), aTn = m6[hO], kY = bK.iJ(aTn), h0 = a5D[hO] >> 3, m7 = aTn % aTY, m8 = ~~((aTn + .5) / aTY), aU9 = a5E[hO], eu = 0; eu < 9; eu++)
								if (!((aU5 = kY + aUC[eu]) < 0 || aUB <= aU5))
									for (aU6 = iK[aU5], xk = aU6.length, ev = 0; ev < xk; ev++) aU7 = aU6[ev], vc = a5D[aU7] >> 3, h0 == vc || aUD && aR2[h0] === aR2[vc] && aR2[h0] || (vc = m6[aU7], (he = m7 - vc % aTY) * he + (he = m8 - ~~((vc +
										.5) / aTY)) * he < 14400 && (vc = a5E[aU7], he = vc <= aU9 ? Math.max(1, bJ.dn(vc + bJ.dn(aU9 - vc, 10), 10)) : Math.max(1, bJ.dn(aU9, 10)), a5E[aU7] = Math.max(vc - he, 0), aT9[aU7] = 4))
					}
				}(this), ! function(rB) {
					if (bd.jn() % 5 == 3) {
				...
				a5E = rB.a5E,
				aT9 = rB.aT9;
			for (aA = rB.on - 1; 0 <= aA; aA--) aT9[aA] = aT9[aA] >> 1, 0 === a5E[aA] && bL.aFQ.aSy(aA);
			bb.g0(g8, dm - bL.h4.aFN(g8), 15)
		}
}

function aSa() {
	this.aUE = 32, this.eh = 0, this.ej = 0, this.iL = 0, this.aUF = 0, this.aUG = 4, this.iK = null, this.aUC = new Int16Array(9), this.dW = function() {
		this.iL = 1 + bJ.dn(bQ.el - 1, this.aUE), this.aUF = 1 + bJ.dn(bQ.em - 1, this.aUE), this.iK = new Array(this.iL * this.aUF), b8.pi.a1B(this.iK);
		var eh, ej, aUC = this.aUC,
			i = this.iL;
		for (eh = -1; eh <= 1; eh++)
			for (ej = -1; ej <= 1; ej++) aUC[3 * (1 + ej) + 1 + eh] = ej * i + eh
	}, this.p2 = function(aUI, aA) {
		return this.iK[aA].push(aUI), this.iK[aA].length - 1
	}, this.aU4 = function(aUJ, aTn, aTu) {
		var aUK, aUL, aTn = bK.iJ(aTn),
			aTu = bK.iJ(aTu);
		return aTn === aTu ? aUJ : (aUK = this.iK[aTn].pop(), this.iK[aTn].length === aUJ ? this.p2(aUK, aTu) : (aUL = this.iK[aTn][aUJ], this.iK[aTn][aUJ] = aUK, bL.x.aT3[aUK] = aUJ, this.p2(aUL, aTu)))
	}
}

function aSf() {
	function a06(aTu, aUM) {
		if (! function(aTu, aSl) {
				var hd = bK.iI(aTu),
					aUQ = Math.abs(bK.ei(aSl) - bK.ei(hd)),
					hd = Math.abs(bK.ek(aSl) - bK.ek(hd));
				return 0 !== Math.max(aUQ, hd) && (function(aTn, aTu, aUQ, aUR) {
					var aUT = bK.hy(aTn),
						aTn = bK.i1(aTn),
						aUV = bK.hy(aTu),
						aTu = bK.i1(aTu),
						...
						aUV = 0 < aUV ? 1 : 3,
						aTu = 0 < aTu ? 2 : 0;
					aUa < aUZ ? aUd(aUT, aTn, aUT + aUZ, aTn + aUa, aUV, aTu, aUQ) : aUd(aTn, aUT, aTn + aUa, aUT + aUZ, aTu, aUV, aUR)
				}(aTu, bK.iH(aSl), aUQ, hd), !0)
			}(aTu, aUM)) return !1;
		if (0 === bM.f5[0]) return !!ab.h3(aUM << 2);
		if (! function(aSl) {
				if (ab.h3(aSl << 2)) return 1;
				return function(aSl) {
					var aA, hN, aTl = bL.x.aTl,
						aUh = bK,
						ea = bM.f5[0],
						aUi = 4 * aSl;
					for (aA = ea - 1; 0 <= aA; aA--) {
						hN = aTl[aA];
						var aUj = aUi;
						if (aUi = aUh.iN(aUi, hN + 2 & 3), ab.h3(aUi)) return bM.f5[0] = aA, bM.fC[1] = aUi >> 2, bM.fC[2] = 1 + hN, bM.fC[4] = aUj, 1
					}
					return
				}(aSl)
			}(aUM)) return !1;
		if (bM.fC[2] && ab.ef(bM.fC[4])) return !1;
		var aA, aUM = bK.iI(aTu),
			vU = aAE,
			aTl = bL.x.aTl,
			ea = bM.f5[0] - 1,
			aUi = 4 * aUM,
			hb = bK.hb;
		for (aA = 0; aA < ea; aA++)
			if (aUi += hb[aTl[aA]], 0 !== vU[aUi + 3] || 2 !== vU[aUi + 2]) return !!void 0;
		return !!1
	}

	function aUd(aUT, aUU, aUV, aUW, aUb, aUc, aUQ) {
		for (var ej, aTl = bL.x.aTl, g9 = 0, aUe = 0, j = aUW - aUU, i = aUV - aUT, aUf = aUT % 16, aA = 1; aA <= aUQ; aA++) aTl[g9++] = aUb, aTl[g9] = aUc, g9 += (ej = (j * (aUf + (aA << 4)) + .5) / i >> 4) - aUe, aUe = ej;
		bM.fH(bM.f5, g9)
	}
	this.kT = function(player, aUM) {
		var hN, hd, gz = bK.hl(player, aUM);
		return gz !== aUM && (hN = bK.hc(gz, aUM), hd = bK.iM(gz, hN), !(!ab.h3(hd << 2) && (hN = bK.hj(gz, aUM, hN), hd = bK.iM(gz, hN), !ab.h3(hd << 2)) || (bM.fC[0] = hd, bM.fC[1] = aUM, bM.fC[2] = 0, hd !== aUM && (!a06(bK.iH(hd), aUM) ||
			0 !== bM.fC[2] && bK.hr(player, bM.fC[1] + bK.ha[bM.fC[2] - 1] << 2)))))
	}, this.p4 = function(aUM) {
		var aTn = bL.x.m6[bM.fC[3]];
		return bM.fC[1] = aUM, bM.fC[2] = 0, a06(aTn, aUM)
	}
}
...
function aSb() {
	...
	}, this.aUl = function(hY, eE, eh, ej, e1, aA) {
		b8.fw.gn(aC.eK) && (hY.setTransform(eE *= 4 / 3 * .625, 0, 0, eE, eh - (e1 *= 4 / 3), ej - e1), hY.drawImage(xO[+(bL.x.aSp[aA] === this.a47)], 0, 0))
	}
}

function dZ() {
	this.aOf = [L(408), L(409), L(410), L(411), L(412), L(413), L(414), L(415), L(416), L(417), L(418), L(419), L(420), L(421), L(422)];
	var aUm = ["Space", "", "KeyB", "", "KeyW", "", "KeyS", "", "KeyD", "", "KeyA", "", "KeyH", "", "NumpadAdd", "", "NumpadSubtract", "", "ArrowLeft", "", "ArrowRight", "", "ArrowUp", "", "ArrowDown", "", "KeyM", "", "KeyP", ""];
	this.a9u = new Array(aUm.length), this.dW = function() {
		var g = bh.dr.data[155].value.split(";"),
			kY = g.length;
		if (function() {
				for (var ea = aUm.length, aA = 0; aA < ea; aA++) bV.a9u[aA] = aUm[aA]
			}(), !(kY > aUm.length))
			for (var aA = 0; aA < kY; aA++) g[aA].length && (this.a9u[aA] = g[aA])
	}, this.aOh = function(e2, code) {
		for (var a9u = this.a9u, aUo = aUm, pG = (a9u[e2] = code, ""), ea = a9u.length, aUp = [], aA = 0; aA < ea; aA++) aUp.push(a9u[aA] === aUo[aA] ? "" : a9u[aA]);
		ea--;
		for (aA = 0; aA < ea; aA++) pG += aUp[aA] + ";";
		bh.r1.r2(155, pG += aUp[ea])
	}, this.aOe = function() {
	...
	this.dW = function() {
		if (!window.document.documentMode) {
			for (var aA = 0; 0 <= aA; aA--) ! function(aA, src) {
				aUs[aA] = 0, aUr[aA] = document.createElement("audio"), aUr[aA].src = src, aUr[aA].setAttribute("preload", "auto"), aUr[aA].setAttribute("controls", "none"), aUr[aA].style.display = "none", aUr[aA].onpause = function() {
					aUs[aA] = 1
				}, aUr[aA].oncanplaythrough = function() {
					aUs[aA] = 0 === aUs[aA] ? 1 : aUs[aA]
				}, document.body.appendChild(aUr[aA])
			}(aA,
		...
		if (aUv) {
			aUv = !1;
			for (var aA = 0; 0 <= aA; aA--) aUr[aA].onpause = null, aUr[aA].oncanplaythrough = null, document.body.removeChild(aUr[aA]), aUr[aA] = null
		}
	}, this.play = function() {
		if (aUv) {
			var dm = performance.now();
			if (aUu + 66 < dm)
				for (var aA = 0; 0 <= aA; aA--)
					if (1 === aUs[aA]) return aUu = dm, aUs[aA] = 2, void aUr[aA].play();
			0 < aUt && (aUt--, setTimeout(aUx, 66))
		}
	}
}
...
function cV() {
	this.a6f = function() {
		var aV0;
		return !(ak.jr < 3 || af.gO[l5[0]] >= aC.ja >> 1) && (aC.hQ ? (aV0 = ad.aGT(), !(2 * ad.aGU(bf.l2()) >= aV0)) : function() {
			var aV0 = ad.aGT();
			if (2 * af.gc[l5[0]] >= aV0) return !1;
			return !0
		}())
	}
}
...
function c6() {
	this.dW = function() {
		if (0 === aC.data.sResourcesType) {
			for (var aTo = aC.jq, gc = af.gc, aA = 0; aA < aTo; aA++) gc[aA] = 512;
			var aTp = aC.w0,
				k3 = aD.k3,
				hF = aD.hF;
			for (aA = aTo; aA < aTp; aA++) gc[aA] = k3[hF[aA]]
...
function dK() {
	var aV5 = 501,
		aV7 = (this.aV6 = new Uint32Array(aV5), this.a2K = new Uint32Array(aV5), this.a9Z = new Uint16Array(aV5), this.aOn = 0, 1),
		aV8 = 0;
	...
	this.max = [0, 0, 0], this.aV9 = 0, this.la = new Array(21), this.aVA = null, this.dX = function() {
		...
		this.aOn = 0, aV7 = 1, this.aV9 = 0, aV8 = 0, aVB(this), this.la.fill(0)
	...
	}, this.aTj = function(player) {
		b8.fw.a2F(player) && this.la[20]++
	}, this.g0 = function(player, a2y, e2) {
		b8.fw.a2F(player) && (this.la[e2] += a2y)
	}, this.ik = function() {
		var self;
		this.aV9 || 0 < aV8-- || ((self = this).aV6[self.aOn] = af.gO[aC.eK], self.a2K[self.aOn] = af.gc[aC.eK], self.a9Z[self.aOn] = ad.a9a(aC.eK), aVD(self, self.aOn), self.aOn++, self.aOn === aV5 && function(self) {
			aVB(self), aVD(self, 0), self.aOn = 1 + bJ.dn(aV5, 2);
			for (var aA = 1; aA < self.aOn; aA++) self.aV6[aA] = self.aV6[2 * aA], self.a2K[aA] = self.a2K[2 * aA], self.a9Z[aA] = self.a9Z[2 * aA], aVD(self, aA);
			aV7 *= 2
		}(self), aV8 = aV7 - 1, bc.lR(), 0 === af.le[aC.eK] && (self.aV9 = bd.jn()))
	}
}
...
function dL() {
	...
	var aVI = this.aVH = 0;
	this.aVJ = 0, this.aVK = 0, this.aVL = 0, this.a6E = 0, this.e2 = 0, this.a9C = null, this.hI = !1, this.aVM = -1, this.aVN = !1, this.aVO = [0, 0], this.dX = function() {
		this.a9C = [L(440), L(116, 0, "Balance"), L(115, 0, "Interest"), L(441)]
	}, this.dW = function() {
		this.hI = !1, this.aVM = -1, this.aVN = !1, this.resize()
	}, this.resize = function() {
		...
		this.i = Math.floor(ed * this.i), this.i -= z.a0.qx() && h.i < h.j ? 2 * ba.gap + 2 : 0, this.j = Math.floor(this.i / 1.369), this.a6E = Math.floor(this.j / 150), this.a6E = Math.max(this.a6E, 1.5), this.rt = Math.floor(1 + .02 * this.i),
			this.ru = Math.floor(1 + .04 * this.i), this.a6s = this.ru, aVI = Math.floor(.75 * this.a6s), this.sb = Math.floor(1 + .075 * this.i), this.aVJ = Math.floor(1 + .1125 * this.i), this.aVK = Math.floor(this.i * (z.a0.qx() ? .03 :
			.029)), this.aVK = Math.max(this.aVK, 4), this.aVL = Math.floor(.035 * this.i), this.aVL = Math.max(this.aVL, 4), this.aVH = this.j - 2 * this.a6s - this.sb - this.aVJ, this.hI && this.aVP()
	}, this.go = function(kt, ku) {
		var w3, w2;
		return !!this.hI && (w2 = kt, w3 = ku, kt -= bJ.dn(h.i - this.i, 2), ku -= bJ.dn(h.j - this.j, 2), kt < 0 || ku < 0 || kt >= this.i || ku >= this.j || kt >= this.i - this.aVJ && ku < this.aVJ ? -1 !== aL.go(w2, w3) || bA.go(w2, w3) ||
			this.qq() : ku < this.aVJ || (ku < this.j - this.sb ? (this.aVN = !0, this.aVM = (kt - 2 * this.rt - this.aVF) / this.aVG, 3 !== this.e2 && (bd.de = !0)) : (w2 = (w2 = Math.floor(kt / (this.i / this.a9C.length))) < 0 ? 0 : w2 >=
				this.a9C.length ? this.a9C.length - 1 : w2) !== this.e2 && (this.e2 = w2, this.aVP(), bd.de = !0)), !0)
	}, this.a0J = function(kt, ku) {
		return this.aVO[0] = kt, this.aVO[1] = ku, !(!this.hI || !this.aVN || (kt -= bJ.dn(h.i - this.i, 2), ku = this.aVM, this.aVM = (kt - 2 * this.rt - this.aVF) / this.aVG, (0 <= this.aVM && this.aVM <= 1 || 0 <= ku && ku <= 1) && (bd.de = !
			0), 0))
	}, this.a0i = function() {
		this.aVN && (this.aVN = !1)
	}, this.a0u = function() {
		...
		bb.aOn < 2 || (this.hI = !0, this.aVP())
	}, this.qq = function() {
		this.hI = !1, this.aVM = -1, bd.de = !0
	}, this.aVP = function() {
		this.e2 < 2 ? this.aVF = aP.measureText(b8.zN.y4(bb.max[this.e2]), b8.pZ.rN(0, this.aVK)) : 2 === this.e2 && (this.aVF = aP.measureText(b8.zN.a2r(6, 2), b8.pZ.rN(0, this.aVK))), this.aVG = this.i - 2 * this.rt - this.aVF - this.ru
	}, this.lR = function() {
		this.hI && this.aVP()
	}, this.te = function() {
		this.hI && this.a79()
		...
		tf.setTransform(1, 0, 0, 1, eh, ej), tf.fillStyle = b9.me, tf.fillRect(0, this.aVJ, this.i, this.j - this.aVJ), this.aVQ(), this.aNd(), tf.strokeRect(0, 0, this.i, this.j), b8.pZ.textAlign(tf, 2), tf.font = b8.pZ.rN(0, this.aVK), 0 ===
			this.e2 ? this.aVR(bb.aV6, eh, ej) : 1 === this.e2 ? this.aVR(bb.a2K, eh, ej) : 2 === this.e2 ? this.aVS(eh, ej) : 3 === this.e2 && (this.aVT(eh, ej), this.aVU(eh, ej)), aL.a4X(Math.floor(eh + this.i - .725 * this.aVJ), Math.floor(
				ej + .275 * this.aVJ), Math.floor(.45 * this.aVJ)), tf.setTransform(1, 0, 0, 1, 0, 0)
	}, this.aVQ = function() {
		var aA, dm;
		for (tf.lineWidth = this.a6E, b8.pZ.textBaseline(tf, 1), b8.pZ.textAlign(tf, 1), tf.strokeStyle = b9.mh, tf.font = b8.pZ.rN(1, this.aVL), dm = this.i / this.a9C.length, tf.fillStyle = b9.n3, tf.fillRect(this.e2 * dm, this.j - this.sb, dm,
		...
		tf.fillStyle = b9.nT, tf.fillRect(0, 0, this.i, this.aVJ), tf.fillStyle = b9.mh, tf.fillRect(0, this.aVJ - .5 * this.a6E, this.i, this.a6E), tf.font = b8.pZ.rN(1, .39 * this.aVJ), tf.fillText(b8.x3.a1q(L(442), 0, .8 * this.i), Math.floor(
			this.i / 2), Math.floor(.55 * this.aVJ))
	}, this.aVR = function(g, eh, ej) {
		var kY = bb.max[this.e2],
			a1D = (tf.setTransform(1, 0, 0, 1, eh + 2 * this.rt + this.aVF, ej + this.a6s + this.aVJ), tf.lineWidth = 2, this.aVH / Math.sqrt(kY));
		tf.beginPath(), tf.moveTo(this.aVG, this.aVH - a1D * Math.sqrt(g[bb.aOn - 1]));
		for (var aA = bb.aOn - 2; 0 <= aA; aA--) tf.lineTo(aA * this.aVG / (bb.aOn - 1), this.aVH - a1D * Math.sqrt(g[aA]));
		tf.stroke();
		eh = this.a4X(g, a1D, .5);
		eh < .95 && tf.fillText(b8.zN.y4(kY), -this.rt, 0), .05 < Math.abs(eh - .5) && tf.fillText(b8.zN.y4(Math.floor(kY / 4)), -this.rt, Math.floor(this.aVH / 2)), .05 < eh && tf.fillText("0", -this.rt, this.aVH)
	}, this.aVS = function(eh, ej) {
		tf.setTransform(1, 0, 0, 1, eh + 2 * this.rt + this.aVF, ej + this.a6s + this.aVJ), tf.lineWidth = 2;
		var a1D = this.aVH / Math.max(bb.max[this.e2], 1);
		tf.beginPath(), tf.moveTo(this.aVG, this.aVH - a1D * bb.a9Z[bb.aOn - 1]);
		for (var aA = bb.aOn - 2; 0 <= aA; aA--) tf.lineTo(aA * this.aVG / (bb.aOn - 1), this.aVH - a1D * bb.a9Z[aA]);
		tf.stroke();
		eh = this.a4X(bb.a9Z, a1D, 1), ej = bb.max[this.e2] / 100;
		eh < .95 && tf.fillText(b8.zN.a2r(ej, 2), -this.rt, 0), .05 < Math.abs(eh - .5) && tf.fillText(b8.zN.a2r(ej / 2, 2), -this.rt, Math.floor(this.aVH / 2)), .05 < eh && tf.fillText(b8.zN.a2r(0, 2), -this.rt, this.aVH)
	}, this.aVT = function(eh, ej) {
		tf.setTransform(1, 0, 0, 1, eh + .34 * this.i, ej + 2 * aVI + this.aVJ), b8.pZ.textAlign(tf, 2);
		for (var a8x = this.j - 4 * aVI - this.sb - this.aVJ, g = [0, 1, 19, 2, 20, 3, 4, 5, 6, 7], aA = 9; 0 <= aA; aA--) tf.fillText(b8.x3.a1q(bb.aVA[g[aA]], 0, .31 * this.i), 0, aA * a8x / 9);
		var f2 = bb.la;
		for (tf.setTransform(1, 0, 0, 1, eh + .39 * this.i, ej + 2 * aVI + this.aVJ), b8.pZ.textAlign(tf, 0), tf.fillText(b8.zN.a2r(100 * f2[0] / (1024 * Math.max(f2[1], 1)), 1), 0, 0), aA = 8; 1 <= aA; aA--) tf.fillText(f2[g[aA]].toString(), 0,
			aA * a8x / 9);
		tf.fillText(b8.zN.a2r(100 * (1 - af.gO[aC.eK] / f2[7]), 0), 0, a8x)
	}, this.aVU = function(eh, ej) {
		tf.setTransform(1, 0, 0, 1, eh + .79 * this.i, ej + 2 * aVI + this.aVJ), b8.pZ.textAlign(tf, 2);
		var aA, a8x = this.j - 4 * aVI - this.sb - this.aVJ;
		for (tf.fillStyle = b9.my, aA = 2; 0 <= aA; aA--) tf.fillText(b8.x3.a1q(bb.aVA[aA + 8], 0, .31 * this.i), 0, aA * a8x / 9);
		tf.fillText(b8.x3.a1q(bb.aVA[18], 0, .31 * this.i), 0, 3 * a8x / 9), tf.fillStyle = b9.mx, tf.fillText(b8.x3.a1q(bb.aVA[11], 0, .31 * this.i), 0, 4 * a8x / 9), tf.fillStyle = b9.nG, tf.fillText(b8.x3.a1q(bb.aVA[13], 0, .31 * this.i), 0,
				5 * a8x / 9), tf.fillText(b8.x3.a1q(bb.aVA[15], 0, .31 * this.i), 0, 6 * a8x / 9), tf.fillText(b8.x3.a1q(bb.aVA[16], 0, .31 * this.i), 0, 7 * a8x / 9), tf.fillText(b8.x3.a1q(bb.aVA[12], 0, .31 * this.i), 0, 8 * a8x / 9), tf
			.fillStyle = b9.nF, tf.fillText(b8.x3.a1q(bb.aVA[17], 0, .31 * this.i), 0, a8x), tf.fillStyle = b9.my;
		var f2 = bb.la,
			aCf = f2[8] + f2[9] + f2[10] + f2[18],
			aCf = b8.zN.y4(aCf),
			aMS = tf.measureText(aCf).width,
			eh = (tf.setTransform(1, 0, 0, 1, eh + .83 * this.i + aMS, ej + 2 * aVI + this.aVJ), tf.fillText(b8.zN.y4(f2[8]), 0, 0), tf.fillText(b8.zN.y4(f2[9]), 0, a8x / 9), tf.fillText(b8.zN.y4(f2[10]), 0, 2 * a8x / 9), tf.fillText(b8.zN.y4(f2[
				18]), 0, 3 * a8x / 9), tf.fillStyle = b9.mx, tf.fillText(aCf, 0, 4 * a8x / 9), tf.fillStyle = b9.nG, tf.fillText(b8.zN.y4(f2[13]), 0, 5 * a8x / 9), tf.fillText(b8.zN.y4(f2[15]), 0, 6 * a8x / 9), tf.fillText(b8.zN.y4(f2[16]),
		...
		var aA, e, fI;
		return this.aVM < 0 || 1 < this.aVM ? .25 : (aA = this.aVM * (bb.aOn - 1), fI = g[e = Math.floor(aA)], fI += (aA - e) * (g[e < bb.aOn - 1 ? e + 1 : e] - fI), tf.strokeStyle = b9.mk, .04 < this.aVM && this.aVW(0, this.aVH - a1D * Math.pow(
				fI, a7k), aA * this.aVG / (bb.aOn - 1), this.aVH - a1D * Math.pow(fI, a7k)), .04 < fI / bb.max[this.e2] && this.aVW(aA * this.aVG / (bb.aOn - 1), this.aVH, aA * this.aVG / (bb.aOn - 1), this.aVH - a1D * Math.pow(fI, a7k)), tf
			.fillStyle = b9.nI, tf.beginPath(), tf.arc(aA * this.aVG / (bb.aOn - 1), this.aVH - a1D * Math.pow(fI, a7k), Math.max(2, .014 * this.j), 0, 2 * Math.PI), tf.fill(), g = this.aVM * bd.a9b, g = 0 === af.le[aC.eK] ? Math.floor(g * bb
				.aV9) : Math.floor(g * bd.jn()), tf.fillStyle = b9.mh, tf.fillText(1 === a7k ? b8.zN.a2r(fI / 100, 2) : b8.zN.y4(Math.floor(fI)), -this.rt, this.aVH - a1D * Math.pow(fI, a7k)), b8.pZ.textAlign(tf, 1), tf.fillText(aV.a9Q(g),
				aA * this.aVG / (bb.aOn - 1), this.aVH + this.aVK - (z.a0.qx() ? 2 : 0) - this.a6E), b8.pZ.textAlign(tf, 2), a1D * Math.pow(fI, a7k) / this.aVH)
	}, this.aVW = function(m7, m8, mK, mL) {
		tf.beginPath(), tf.moveTo(m7, m8), tf.lineTo(mK, mL), tf.stroke()
	}
}

function bu() {
	this.aVX = "https://", this.aVY = this.aVX + "territorial.io/", this.aOo = this.aVY + "changelog", this.aOs = this.aVY + "terms", this.aVZ = this.aVY + "cookie_policy", this.aOF = this.aVY + "privacy", this.aOr = this.aVY + "tutorial", this.aOq =
		this.aVY + "players", this.aOp = this.aVY + "clans", this.zY = this.aVY + "clan-results", this.aAt = this.aVX + "play.google.com/store/apps/details?id=territorial.io", this.zs = this.aVX + "apps.apple.com/app/id1581110913", this.aVa = this
		.aVX + "www.youtube.com/watch?v=toZTQ8aRdFc", this.aAu = this.aVX + "discord.gg/pthqvpTXmh", this.aAv = this.aVX + "www.instagram.com/davidtschacher/", this.xe =
		"🇦🇫🇦🇽🇦🇱🇩🇿🇦🇸🇦🇩🇦🇴🇦🇮🇦🇶🇦🇬🇦🇷🇦🇲🇦🇼🇦🇺🇦🇹🇦🇿🇧🇸🇧🇭🇧🇩🇧🇧🇧🇾🇧🇪🇧🇿🇧🇯🇧🇲🇧🇹🇧🇴🇧🇦🇧🇼🇧🇷🇮🇴🇻🇬🇧🇳🇧🇬🇧🇫🇧🇮🇨🇻🇰🇭🇨🇲🇨🇦🇮🇨🇰🇾🇨🇫🇹🇩🇨🇱🇨🇳🇨🇽🇨🇨🇨🇴🇰🇲🇨🇬🇨🇩🇨🇷🇭🇷🇨🇺🇨🇼🇨🇾🇨🇿🇩🇰🇩🇯🇩🇲🇩🇴🇪🇨🇪🇬🇸🇻🇬🇶🇪🇷🇪🇪🇸🇿🇪🇹🇪🇺🇫🇰🇫🇴🇫🇯🇫🇮🇫🇷🇬🇫🇵🇫🇹🇫🇬🇦🇬🇲🇬🇪🇩🇪🇬🇭🇬🇮🇬🇷🇬🇱🇬🇩🇬🇵🇬🇺🇬🇹🇬🇬🇬🇳🇬🇼🇬🇾🇭🇹🇭🇳🇭🇰🇭🇺🇮🇸🇮🇳🇮🇩🇮🇷🇮🇶🇮🇪🇮🇲🇮🇱🇮🇹🇨🇮🇯🇲🇯🇵🇯🇪🇯🇴🇰🇿🇰🇪🇰🇮🇽🇰🇰🇼🇰🇬🇱🇦🇱🇻🇱🇧🇱🇸🇱🇷🇱🇾🇱🇮🇱🇹🇱🇺🇲🇴🇲🇰🇲🇬🇲🇼🇲🇾🇲🇻🇲🇱🇲🇹🇲🇭🇲🇶🇲🇷🇲🇺🇾🇹🇲🇽🇫🇲🇲🇩🇲🇨🇲🇳🇲🇪🇲🇸🇲🇦🇲🇿🇲🇲🇳🇦🇳🇷🇳🇵🇳🇱🇳🇨🇳🇿🇳🇮🇳🇪🇳🇬🇳🇺🇳🇫🇰🇵🇲🇵🇳🇴🇴🇲🇵🇰🇵🇼🇵🇸🇵🇦🇵🇬🇵🇾🇵🇪🇵🇭🇵🇱🇵🇹🇵🇷🇶🇦🇷🇴🇷🇺🇷🇼🇼🇸🇸🇲🇸🇹🇸🇦🇸🇳🇷🇸🇸🇨🇸🇱🇸🇬🇸🇽🇸🇰🇸🇮🇸🇧🇸🇴🇿🇦🇬🇸🇰🇷🇸🇸🇪🇸🇱🇰🇧🇱🇸🇭🇰🇳🇱🇨🇲🇫🇵🇲🇻🇨🇸🇩🇸🇷🇸🇪🇸🇾🇨🇭🇹🇼🇹🇯🇹🇿🇹🇭🇹🇱🇹🇬🇹🇰🇹🇴🇹🇹🇹🇳🇹🇷🇹🇲🇹🇨🇹🇻🇺🇬🇺🇦🇦🇪🇬🇧🇺🇳🇺🇸🇻🇮🇺🇾🇺🇿🇻🇺🇻🇦🇻🇪🇻🇳🇼🇫🇪🇭🇾🇪🇿🇲🇿🇼"
}

function d3() {
	this.x = new aVb, this.x0 = new aVc, this.dW = function() {
		this.x.dW()
	}, this.ik = function() {
...
function aVc() {
	this.te = function() {
		if (0 !== bN.x.a5a && (tf.globalAlpha = Math.min(bN.x.a5a / 580, 1), tf.drawImage(bN.x.aVf, 1 + aR.wy(), 1 + aR.wz()), tf.globalAlpha = 1, aC.gw)) {
			for (var m7 = iB / iC, m8 = iD / iC, mK = (h.i + iB) / iC, mL = (h.j + iD) / iC, g9 = bN.x.aVg * iC, aVh = bN.x.aVh, aA = aC.jq - 1; 0 <= aA; aA--) ! function(aA, g9, m7, m8, mK, mL, aVh) {
				...
				0 === af.le[aA] || 0 === af.gO[aA] || (mK = h.i * ((af.iP[aA] + af.iQ[aA] + 1) / 2 - m7) / (mK - m7) - .5 * g9, m7 = h.j * ((af.iR[aA] + af.iS[aA] + 1) / 2 - m8) / (mL - m8) - .5 * g9, mK > h.i) || m7 > h.j || mK < -g9 || m7 <
					-g9 || (tf.setTransform(highlight ? iC * 2 : iC, 0, 0, highlight ? iC * 2 : iC, mK, m7), tf.drawImage(aVh[aC.hQ ? be.eY[aA] : 1], 0, 0))
			}(aA, g9, m7, m8, mK, mL, aVh);
...
function aVb() {
	...
	function aVm(hS, aVn) {
		var eh, ej, eM, hw, a1e = b8.pZ.vJ(hS, hS),
			...
			kY = (hS >> 1) - .5,
			aVo = .5 + kY;
		for (aVo *= aVo, ej = 0; ej < hS; ej++)
			for (eh = 0; eh < hS; eh++) hw = (hw = eh - kY) * hw + (hw = ej - kY) * hw, vU[eM = 4 * (ej * hS + eh)] = aVn[0], vU[1 + eM] = aVn[1], vU[2 + eM] = aVn[2], vU[3 + eM] = (aVo - hw) * aVn[3] / aVo;
		return hY.putImageData(hV, 0, 0), a1e
	}

	function aUl(aA, hY, a1e, hS) {
	...
	this.dW = function() {
		...
		this.a5a = 700,
			function(rB) {
				var hS = rB.aVg;
				if (rB.aVh = [], aVj = [], aC.hQ)
					for (var aA = 0; aA <= aC.w7; aA++) rB.aVh.push(aVm(hS, be.aTc[be.kC[aA]])), aVj.push(aVm(hS >> 1, be.aTc[be.kC[aA]]));
				else rB.aVh.push(aVm(hS, be.aTc[7])), rB.aVh.push(aVm(hS, be.aTc[4])), aVj.push(aVm(hS >> 1, be.aTc[7]))
			}(this),
			function(rB, aVp) {
				var aA, aVf = rB.aVf,
					hY = b8.pZ.getContext(aVf, !0),
					ea = aC.eX,
					hS = rB.aVg >> 1;
				hY.imageSmoothingEnabled = !1, hY.setTransform(1, 0, 0, 1, 0, 0), aVp && hY.clearRect(0, 0, aVf.width, aVf.height);
				for (aA = aC.jq; aA < ea; aA++) aUl(aA, hY, aVj, hS)
			}(this, null !== (rB = this).aVf && rB.aVf.width === bQ.el - 2 && rB.aVf.height === bQ.em - 2 || (rB.aVf = b8.pZ.vJ(bQ.el - 2, bQ.em - 2), !1)), aC.gw || this.a39()
	}, this.aTb = aVm, this.a39 = function() {
		for (var ea = aC.jq, hS = this.aVg, aVh = this.aVh, hY = b8.pZ.getContext(this.aVf, !0), aA = 0; aA < ea; aA++) aUl(aA, hY, aVh, hS)
	}
}
...
function d4() {
	...
	function aVq(player) {
		aC.gw ? (aj.aFH(player), ak.aIE(), aC.k9 && aC.or.ik()) : b1.aBA(player)
	}
	this.oH = function(player) {
		aM.yy(player, player === aC.eK ? 21 : 22), aVq(player), aVr()
	}, this.oo = function(player) {
		1 === aC.ym && 0 !== af.le[player] && 2 !== af.a2B[player] && aVq(player), aC.yp--, aC.yo--, aM.yy(player, 4), b8.fw.gm(2) && aV.lQ(!0), aVr()
	}
}

function dE() {
	this.aRD = ["rgba(90,90,90,0.88)", "rgba(130,12,12,0.88)", "rgba(12,130,12,0.88)", "rgba(12,12,130,0.88)", "rgba(130,130,12,0.88)", "rgba(130,12,130,0.88)", "rgba(12,130,130,0.88)", "rgba(130,130,130,0.88)", "rgba(0,0,0,0.88)"], this.a8v = [
	...
	], this.aVs = [b9.mh, "rgb(255,0,0)", "rgb(0,255,0)", "rgb(0,0,255)", "rgb(255,255,0)", "rgb(255,0,255)", "rgb(0,255,255)", b9.mh, b9.mY], this.aVt = [b9.mY, b9.mh, b9.mh, b9.mh, b9.mY, b9.mY, b9.mY, b9.mY, b9.mh];
	var aVu = ["255,255,255", "0,0,0", "255,4,4", "200,4,4", "4,255,4", "4,180,4", "255,195,195", "90,3,3", "200,255,200", "3,84,3"],
		aVv = (this.aHi = ["rgba(" + aVu[0] + ",", "rgba(" + aVu[1] + ",", "rgba(" + aVu[2] + ",", "rgba(" + aVu[3] + ",", "rgba(" + aVu[4] + ",", "rgba(" + aVu[5] + ",", "rgba(" + aVu[6] + ",", "rgba(" + aVu[7] + ",", "rgba(" + aVu[8] + ",",
			"rgba(" + aVu[9] + ","
		], this.aHj = ["rgb(" + aVu[0] + ")", "rgb(" + aVu[1] + ")", "rgb(" + aVu[2] + ")", "rgb(" + aVu[3] + ")", "rgb(" + aVu[4] + ")", "rgb(" + aVu[5] + ")", "rgb(" + aVu[6] + ")", "rgb(" + aVu[7] + ")", "rgb(" + aVu[8] + ")", "rgb(" + aVu[
			9] + ")"
		], this.z8 = null, this.aTc = [
			[128, 128, 128, 180],
			[255, 0, 0, 180],
			[0, 255, 0, 180],
			[50, 50, 255, 180],
	...
	this.kC = [0, 1, 2, 3, 4, 5, 6, 7, 8], this.eY = new Uint8Array(aC.eX), this.wD = new Uint16Array(aC.eX), this.wE = new Uint16Array(this.kC.length + 1), this.wF = new Uint16Array(this.kC.length), this.dX = function() {
		this.z8 = [L(443), L(444), L(445), L(446), L(447), L(448), L(449), L(450), L(451)]
	}, this.dW = function() {
		if (this.eY.fill(0), this.aVw(), aC.hQ) {
			9 === aC.k7 ? this.aVx() : aC.k9 ? function() {
				var colorsData = aC.data.colorsData;
				if (!aC.data.selectableColor)
					for (var aA = aC.jq - 1; 0 <= aA; aA--) colorsData[aA] = aw.j8(262144);
				var aW6 = 0,
					eq = 768,
					aQi = [4 * (colorsData[0] >> 12), 4 * (colorsData[0] >> 6 & 63), 4 * (63 & colorsData[0])],
					teamPlayerCount = aC.data.teamPlayerCount;
				for (aA = 0; aA < 9; aA++)
					if (teamPlayerCount[aA]) {
						for (var ed = 0, eu = 0; eu < 3; eu++) ed += Math.abs(aVv[aA][eu] - aQi[eu]);
						ed < eq && (aW6 = aA, eq = ed)
				...
				var kC = be.kC,
					...
					g3 = (kC[0] = 0, 1);
				for (aA = 1; aA < 9; aA++) aW7[aA] && (aW8[aA] = g3, kC[g3++] = aA);
				var j7 = aC.jq,
					eY = be.eY;
				aW7[aW6] ? (aW7[aW6]--, eY[0] = aW8[aW6]) : j7 = 0;
				var ev = 0;
				for (aA = j7; aA < aC.w0; aA++) {
					var hO = kC[ev];
					if (aW7[hO]) aW7[hO]--, eY[aA] = aW8[hO];
		...
		var hg = new Uint8Array(aC.jq),
			...
			aW1 = new Uint16Array(this.kC.length);
		this.aW2(hg, hh, aW0, 1), this.aEu(aW0), this.aW3(aW1, hg, hh), this.aW4(hg, hh, aW1), this.aW5()
	}, this.aW2 = function(hg, hh, aW7, aW9) {
		for (var eu, e, aWA, ea = this.kC.length - aW9, g = new Uint16Array(ea), colorsData = aC.data.colorsData, aA = aC.jq - 1; 0 <= aA; aA--) {
			for (eu = ea; aW9 <= eu; eu--) g[eu - 1] = Math.abs(4 * (colorsData[aA] >> 12) - aVv[eu][0]) + Math.abs(4 * (colorsData[aA] >> 6 & 63) - aVv[eu][1]) + Math.abs(4 * (63 & colorsData[aA]) - aVv[eu][2]);
			for (aWA = 768, eu = ea - 1; 0 <= eu; eu--) g[e = (eu + aA) % ea] < aWA && (aWA = g[e], hg[aA] = e);
			for (aW7[hg[aA]] += 4, aWA = 768, eu = ea - 1; 0 <= eu; eu--) g[e = (eu + aA) % ea] < aWA && e !== hg[aA] && (aWA = g[e], hh[aA] = e);
			aW7[hh[aA]]++
		}
	}, this.aEu = function(aW7) {
		for (var eu, ka, ea = this.kC.length - 1, aA = ea; 0 <= aA; aA--) this.kC[aA] = aA;
		for (aA = ea - 1; 0 <= aA; aA--) aW7[aA]++;
		for (aA = 1; aA <= ea; aA++) {
			for (ka = 0, eu = 1; eu < ea; eu++) aW7[eu] > aW7[ka] && (ka = eu);
			aW7[ka] = 0, this.kC[aA] = ka + 1
		}
	}, this.aW3 = function(aW1, hg, hh) {
		var eu, zR, ev, ed, e, mJ, sB, aWB = this.kC.length - 1,
			q3 = new Uint16Array(aWB),
			aWC = [],
			aWD = 0,
			zQ = [],
			aWE = [];
		loop: for (var aA = 0; aA < aC.jq; aA++)
			if (null !== (zR = b8.zN.zS(af.zP[aA]))) {
				for (eu = zQ.length - 1; 0 <= eu; eu--)
					if (zR === zQ[eu]) {
						aWE[eu].push(aA), aWD = Math.max(aWD, aWE[eu].length);
						continue loop
					} zQ.push(zR), aWC.push(!1), aWE.push([aA]), aWD = Math.max(aWD, 1)
			}
		for (; 2 < aC.w7 && aWD > bJ.dn(aC.jq, aC.w7);) aC.w7--, aC.k7--;
		for (eu = zQ.length - 1; 0 <= eu; eu--) {
			for (ed = -1, ev = zQ.length - 1; 0 <= ev; ev--) !aWC[ev] && (-1 === ed || aWE[ev].length > aWE[ed].length) && (ed = ev);
			for (ev = aWB - 1; 0 <= ev; ev--) q3[ev] = 1;
			for (ev = aWE[ed].length - 1; 0 <= ev; ev--) q3[hg[aWE[ed][ev]]] += 3, q3[hh[aWE[ed][ev]]]++;
			for (aA = aWB - 1; 0 <= aA; aA--) {
				for (e = ed % aWB, ev = aWB - 1; 0 <= ev; ev--) q3[ev] > q3[e] && (e = ev);
				for (mJ = -1, ev = aC.w7; 0 < ev; ev--)
					if (this.kC[ev] === e + 1) {
						mJ = ev;
						break
					} if (q3[e] = 0, -1 !== mJ) {
					for (sB = 0, ev = aC.w7; 0 < ev; ev--) aW1[mJ] > aW1[ev] && sB++;
					if (sB !== aC.w7 - 1) {
						for (ev = aWE[ed].length - 1; 0 <= ev; ev--) aW1[mJ]++, this.eY[aWE[ed][ev]] = mJ;
						break
					}
				}
			}
	...
	}, this.aW4 = function(hg, hh, aW1) {
		for (var aA, hv, ea = this.kC.length - 1, border = bJ.dn(aC.jq, aC.w7), aWF = (0 < aC.jq % aC.w7 && border++, new Uint8Array(1 + ea)), eu = ea; 1 <= eu; eu--) aWF[this.kC[eu]] = eu;
		for (aA = 0; aA < aC.jq; aA++) hv = aWF[hg[aA] + 1], 0 === this.eY[aA] && hv <= aC.w7 && aW1[hv] < border && (aW1[hv]++, this.eY[aA] = hv);
		for (aA = 0; aA < aC.jq; aA++) hv = aWF[hh[aA] + 1], 0 === this.eY[aA] && hv <= aC.w7 && aW1[hv] < border && (aW1[hv]++, this.eY[aA] = hv);
		for (eu = aC.w7; 1 <= eu; eu--)
			for (aA = aC.jq - 1; 0 <= aA && !(aW1[eu] >= border); aA--) 0 === this.eY[aA] && (aW1[eu]++, this.eY[aA] = eu)
	}, this.aW5 = function() {
...
function fl() {
	var player = fQ,
		...
		ec = ab.ec;
	loop: for (var aA = ea - 1; 0 <= aA; aA--) {
		for (var aWG = !1, aWH = !1, ed = 3; 0 <= ed; ed--) {
			var g8 = gG[player][aA] + ec[ed];
			if (ab.aF4(g8, player)) continue loop;
			aWG = aWG || ab.h3(g8), aWH = aWH || ab.aF3(g8)
		}
		aWG ? gH[player].push(gG[player][aA]) : aWH ? f0[player].push(gG[player][aA]) : ab.wZ(gG[player][aA], player), gG[player][aA] = gG[player][ea - 1], gG[player].pop(), ea--
	}
}
...
function gJ(border) {
	for (var ed, g8, ea = border.length, ec = ab.ec, aA = ea - 1; 0 <= aA; aA--)
		for (ed = 3; 0 <= ed; ed--)
			if (g8 = border[aA] + ec[ed], ab.aF4(g8, fU)) {
...
function gK() {
	for (var ed, g8, ec = ab.ec, aA = fV - 1; 0 <= aA; aA--)
		for (ed = 3; 0 <= ed; ed--) g8 = fX[aA] + ec[ed], ab.aF5(fU, g8) && ab.aF6(g8) && (af.gG[fU].push(g8), ab.g5(g8, fU))
}
...
function h9(player, j1) {
	for (var e, aWI = ac.fg(player), aA = 0; aA < aWI; aA++)
...
function hB(a2G, a2H) {
	for (var aA, dm, g9, g8, aTo = af.gG[a2G].length, aTp = af.gG[a2H].length, ec = (aTp < aTo && (dm = a2G, a2G = a2H, a2H = dm, dm = aTo, aTo = aTp, 0), ab.ec), ed = 3; 0 <= ed; ed--)
		for (g9 = ec[ed], aA = 0; aA < aTo; aA++)
			if (g8 = af.gG[a2G][aA] + g9, ab.gA(g8) && ab.eS(g8) === a2H) return !0;
	return !1
}

function aFE(a2G, a2H) {
	for (var aA, g9, g8, aTo = af.gG[a2G].length, ec = ab.ec, ed = 3; 0 <= ed; ed--)
		for (g9 = ec[ed], aA = 0; aA < aTo; aA++)
...
function aWJ() {
	this.h6 = function(player) {
		b8.fw.a2C(player) && aM.zA(80, L(452), 637, 0, b9.nW, b9.me, -1, !1)
	}, this.a49 = function() {
		aM.zA(80, L(453), 637, 0, b9.nW, b9.me, -1, !1)
	}, this.o6 = function(player) {
		b8.fw.a2C(player) && aM.zA(80, L(454), 637, 0, b9.nW, b9.me, -1, !1)
	}
}

function aWK() {
	this.aWL = 0, this.ik = function() {
		aN.ik(), aY.ik(), h.ik(), ay.x.ik(), av.aEQ(), bd.de && (bd.de = !1, aZ.te())
	}
}

function aWM() {
	this.lx = bd.lx, this.e2 = 0, this.aWL = 0, this.aEN = 0, this.aWN = null, this.aWO = 7, this.a5b = 0, this.dW = function() {
		this.aEN = 0, this.aWN = [], this.e2 = 0, this.aWL = 0
	}, this.aQB = function(aB) {
		if (aC.gw) this.a9c(aB);
		else if (this.aWN.push(aB), 2 === aC.ym) {
			for (var aA = 0; aA < this.aWN.length; aA++) b6.nv.ik(this.aWN[aA]);
			this.aWN = []
		}
	}, this.a9c = function(aB) {
		2 !== aC.ym && (b6.nv.ik(aB), b7.ik(), aV.a9c(this.aEN), this.aEN === aC.a3F ? (aC.or.ik(), this.aEN = 0, this.e2 = 0, this.aWL = 0, this.lx = bd.lx) : (this.aEN++, ae.a38(), ae.lQ(!0), bZ.aAC()))
	}, this.ik = function() {
		h.ik(), aC.gw ? (bd.de = aV.a9c(-1) || bd.de, lS()) : (0 !== this.e2 || bd.lx >= this.lx && (this.lx += bd.a9b * Math.floor(1 + (bd.lx - this.lx) / bd.a9b), 2 === aC.ym ? lH() : this.aWP(), this.e2++, 27 < bd.lx - this.a5b)) && this
		.aWQ(), lN(), bd.de && (bd.de = !1, ww()), this.a5b = bd.lx
	}, this.aWQ = function() {
		bd.de = !0, lP(), this.e2 = 0
	}, this.aWP = function() {
		var uL, aA;
		if (this.aWL !== 7 * this.aEN) lJ(), bZ.aAC();
		else {
			uL = !1;
			loop: for (; this.aWR() && (uL = !0, lJ(), 2 !== aC.ym) && 0 < this.aWN.length;)
				for (aA = this.aWO - 2; 0 <= aA; aA--)
					if (lJ(), 2 === aC.ym) break loop;
			uL ? bZ.aAC() : (lH(), bZ.a3B())
		}
	}, this.aWR = function() {
		return 0 < this.aWN.length && (this.aEN++, b6.nv.ik(this.aWN[0]), this.aWN.shift(), !0)
	}
}

function aWS() {
	var aWT, aWU, aWV, aEN, aWW, e2 = 0,
		lx = bd.lx;
	...
	function aWa() {
		e2 = 0, (aC.gw ? (bd.de = aV.a9c(aEN - (aWW % 7 == 0 ? 0 : 1) + aWW % 7 / 7) || bd.de, lS) : aL.gl || !bA.a3c ? lS : (bd.de = !0, lP))()
	}

	function aWc() {
		var aA, ea, aWd = b7.op.aRN,
			fI = b7.op.aRO,
			fK = b7.op.aRP,
			fM = b7.op.aRQ,
			aWe = b7.op.aRR,
		...
		if (!(aWT >= aWf.length)) {
			if (aWf = aWf[aWT], aWe[aWT]) {
				for (ea = aWU + aWf, aA = aWU; aA < ea; aA++) b6.nv.ob(aWd[aA], fI[aA], fK[aA], fM[aA]);
				aWU += aWf, aWT++
	...
	this.aWL = 0, this.dW = function() {
		aWW = aEN = aWV = aWU = aWT = 0
	}, this.ik = function() {
		var aUB;
		h.ik(), bA.a74() < 1.7 ? 0 === e2 ? bd.lx >= lx && (aUB = bd.a9b / bA.a74(), lx += aUB * Math.floor(1 + (bd.lx - lx) / aUB), 2 === aC.ym || aL.gl || !bA.a3c ? lH() : (aWZ(), bZ.aAC()), e2++) : aWa() : function() {
			var aUB;
			if (bd.lx >= lx)
				if (2 === aC.ym || aL.gl || !bA.a3c) lH(), lx = bd.lx;
				else {
					for (aUB = bd.a9b / bA.a74(), 16 < (bd.lx - lx) / aUB && (lx = bd.lx - 16 * aUB); bd.lx >= lx && 2 !== aC.ym;) lx += aUB, aWZ();
					bZ.aAC()
				} aWa()
		}(), lN(), bd.de && (bd.de = !1, ww())
	}, this.yw = function() {
		b7.op.aRS.length - aWT <= 2 || aM.a04("Replay file larger than expected.")
	}
}
...
function dM() {
	...
	function aWi() {
		bd.lx = aWh = performance.now(), bd.yv.ik(), window.requestAnimationFrame(aWi)
	}
	this.dW = function() {
		this.a3Z(), window.requestAnimationFrame(aWi), this.lx = performance.now()
	}, this.a3Q = function() {
		aC.gk ? (this.yv = new aWS, this.yv.dW()) : aC.k9 ? this.yv = new aWg : (this.yv = new aWM, this.yv.dW())
	}, this.a3Z = function() {
		this.yv = new aWK, this.de = !0
	}, this.ik = function() {
		this.yv.aWL++
	}, this.jn = function() {
		return this.yv.aWL
		...
		var dm = performance.now();
		dm < aWh + 1e3 || (this.lx = dm, this.yv.ik())
	}
}
...
function co() {
	...
	this.ik = function() {
		var dm, a5d;
		bd.lx < aWj || (aWj = bd.lx + 5e3, aC.gk) || aC.k9 || b8.fw.gn(aC.eK) || (dm = new Date, a5d = dm.getUTCSeconds(), aWk ? a5d < 50 && (aWk = !1) : a5d < 50 || (aWk = !0, (a5d = (dm.getUTCMinutes() + 1) % 60) % 5 == 0 && (0 == a5d || 20 ==
			a5d || 40 == a5d ? aC.k7 < 7 && aWl(0) : 10 == a5d || 30 == a5d || 50 == a5d ? 7 !== aC.k7 && 10 !== aC.k7 || aWl(1) : 5 == a5d || 25 == a5d || 45 == a5d ? 8 === aC.k7 && aWl(2) : 35 == a5d && 9 === aC.k7 && aWl(3))))
	}
}

function ci() {
	var m7, m8, mK, mL, aWm = 0,
		aWn = 0;
	...
	this.a0N = function(e) {
		return 1 < e.touches.length ? (aWn = bd.lx, aWm = 3, aWo(e), aK.qq(), !0) : (aWm = 0, !1)
	}, this.a0O = function(e) {
		var aJ1, ht, hu;
		return 0 !== aC.ym && 1 < e.touches.length && (aWm = Math.max(aWm - 1, 0), aG.mP() && (aJ1 = aWp(), aWo(e), e = aWp(), ht = Math.floor((m7 + mK) / 2), hu = Math.floor((m8 + mL) / 2), aR.a7U(ht, hu, Math.max(.125, e) / Math.max(.125,
			aJ1)), bd.de = !0), !0)
	}, this.a0l = function() {
		var eh, ej;
		return !!(aWm && (aWm = 0, bd.lx < aWn + 500)) && (eh = (m7 + mK) / 2, ej = (m8 + mL) / 2, aK.a0f(eh, ej), aK.click(eh, ej, !0) && (bd.de = !0), !0)
	}
}
...
function cx() {
	this.size = 0, this.e2 = 0, this.aB = null, this.dW = function(aB) {
	...
	}, this.aQP = function(size) {
		var eu = size >> 1;
		return (1 << eu) * this.oa(size - eu) + this.oa(eu)
	}, this.aQO = function(aWq) {
		return this.size === bB.aQI(aWq)
	}, this.aRf = function(vm, aWr, aWs) {
		var g3 = this.oa(vm);
		if (!g3) return null;
		for (var vm = Math.max(g3, aWs), g = new(aWr <= 8 ? Uint8Array : aWr <= 16 ? Uint16Array : Uint32Array)(vm), aA = 0; aA < g3; aA++) g[aA] = this.oa(aWr);
		aWs = g[g3 - 1];
		return aWs && g.fill(aWs, g3), g
	}, this.aRg = function(vm, aWt, aWs) {
		var g3 = this.oa(vm);
		if (!g3) return null;
		for (var vm = Math.max(g3, aWs), g = new Array(vm), aA = 0; aA < g3; aA++) g[aA] = this.aRd(aWt);
		return g.fill(g[g3 - 1], g3), g
	}, this.aRd = function(vm) {
		...
		pG = b8.zN.a33(pG, "-", "+");
		for (var aWu = "";
			(pG.length + aWu.length) % 4;) aWu += "=";
		pG = "data:image/png;base64," + pG + aWu;
		var aFj = new Image;
		aFj.onload = function() {
			b7.aG8.aG9(aFj), aFj.onload = null, aFj = null
		}, aFj.src = pG
	}
}

function dG() {
	this.aSU = 0, this.aSV = 0, this.aSQ = 0, this.aSR = 0, this.aSS = 0, this.aST = 0, this.aAD = [0, 0, 0, 0], this.mO = function() {
		this.aSU = aR.wy(), this.aSV = aR.wz(), this.aSQ = -this.aSU, this.aSR = -this.aSV, this.aSS = h.i / iC, this.aST = h.j / iC, this.aAD[0] = Math.floor(this.aSQ), this.aAD[1] = Math.floor(this.aSR), this.aAD[2] = Math.floor(this.aAD[0] +
			this.aSS + 1), this.aAD[3] = Math.floor(this.aAD[1] + this.aST + 1), bZ.aAA = !0
	}
}
...
function a5() {
	this.size = 0, this.e2 = 0, this.aB = null, this.dW = function(aB) {
		...
		return this.dW(new Uint8Array(this.aQI(aWq))), this.aB
	}, this.t8 = function() {
		this.aB = null
	...
	}, this.aQI = function(aWq) {
		return aWq + 7 >> 3
	}, this.aWy = function(g, j7, mP, aWz) {
		for (var aA = j7; aA < mP; aA++) this.a7(aWz, g[aA])
	}
}
...
function cw() {
	this.dW = function() {
		...
		for (var g = this.g, mP = this.e2 + aX0 - 1, aX1 = 1 + (mP >> 3); g.length < aX1;) g.push(0);
		for (var aA = this.e2; aA <= mP; aA++) g[aA >> 3] |= (value >> mP - aA & 1) << 7 - (7 & aA);
		this.e2 += aX0
	}, this.dd = function(g, vm, aWr) {
		var aX2 = b8.pi.a1Y(g);
		this.a7(vm, aX2);
		for (var aA = 0; aA < aX2; aA++) this.a7(aWr, g[aA])
	}, this.aRx = function(g, vm, aWt) {
		var aX2 = b8.pi.a1Y(g);
		this.a7(vm, aX2);
		for (var aA = 0; aA < aX2; aA++) this.aRv(g[aA], aWt)
	}, this.aRv = function(pG, vm) {
		var ea = pG.length;
		this.a7(vm, ea);
		for (var aA = 0; aA < ea; aA++) this.a7(16, pG.charCodeAt(aA))
	}, this.aRw = function(a1e) {
		var aX3 = (a1e = a1e.toDataURL()).split(",");
		if (aX3.length < 2) console.log("error 266");
		else {
			a1e = b8.zN.a33(a1e = aX3[aX3.length - 1], "/", "_"), a1e = b8.zN.a33(a1e, "\\+", "-");
