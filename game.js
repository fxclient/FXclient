const fx_version = '0.5.4'; // FX Client Version
...
var settingsManager = new (function() {
    ...
    var checkboxFields = {
        ...
        funnyNames: document.getElementById("funnynames")
    };
    this.save = function() {
    ...
    function kI() {
        ...
        this.bp = function () {
            ...
            if (settings.funnyNames) {
                ...
                var _test2 = ["ENG","Duckmania","Salazar","Arabe","italy","Islamska Bosna","Lithuania Empire","osmanlı imparatonlu","[Drew] Jungle empire","[VOID] -_-","Nazí German","Austria-hungary","( bot ) germany","Fae","hack a boliochee","Android User 473","Germany","Karaboga","nAP","Morocco","Deez","||*|| Aynulatac","Europe :)","Bacalhau empire","France >>>","Serbia","Deutschland","BillyBob","good friend","ctrl+W=chat","Испания","Ottoman impre","Giga god","E 2.0","Germany","Dee Dutch","Eddertopia","Ellinaras","Soviet Onion","Rusya,,","Rainbow Republic","Baza","Marakand","newbie","Lick Puszy","Lazarus","[NOVAT] Eges","Jay swizzle","Turkey","Android User 691","[NIG] Ger Man","Egamer","You stupid full send","Ottoman Empire","+______+","SEEB110l","Siuuuuu","Eesti","NEE","Osmanlı imp.","yfl","House Rogare","Точно не лис","Ossmans emperium","Fr13nd","Belgium","Player 542","Adolf Hit!er","Sovjet union","Full power","ohio","LUK826","Faruk","no betray","İslam Devleti","Mimi empire","Revenge for Albania","[Bot]Cody","German Alliagence","Brasil","Player 42069","Player 318","[RU] full master","[DREW] San Escobar","PAPyousheoneveremath","Player 696","Player 734","Nazkar","Android User 233","rasputin","Elboña","ewdwdw","Советский Саюз","The mighty boro","Dutch ovenmitts","iOS User 712","Ballsweezer","Russie","Player 898","[ING]world","naeger","Player 57","corpo","WuseligerUser04","Spanish emire","iOS User 152","Türkish","Abdou country","Akkuyunlular","Told boy","Israël","Ohioan the fourth","KOREAN 1945815","Erbakan","Soviet Kamrat","Ottoman Empire","Player 208","Tod","Zombies","[OG] ufuk","Sebastian Corleone.","Викинги","Mafaratuile","Osmanlı","Android User 712","IND-PAK  friendship"];
                k = _test;
                x = k;
            }
